...
{	
	...
	public:
		...
		ArrayElementType& At(int32 Index) const
		{
			if (!IsValidIndex(Index) || !Data)
				throw std::out_of_range("Index out of bounds or Data is null");

			return *(ArrayElementType*)(reinterpret_cast<uint8*>(Data) + (sizeof(ArrayElementType) * Index));
		}
