...
public:
	...
	uint8                                         Pad_85B3[0x4];                                     // 0x0044(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_85B4[0x4];                                     // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_85B5[0x8];                                     // 0x00A0(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_85B6[0x2];                                     // 0x004E(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_85B7[0x1];                                     // 0x002F(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_85B8[0x10];                                    // 0x00A0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_85B9[0x6];                                     // 0x0032(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_85BA[0x6];                                     // 0x005A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	class FString                                 Name_UIStateConfiguration;                         // 0x0028(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_85BB[0x4];                                     // 0x005C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_85BC[0x3];                                     // 0x0095(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_85BD[0x6];                                     // 0x00AA(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_85BE[0x4];                                     // 0x0074(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_85BF[0x4];                                     // 0x008C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSet<struct FGameplayTag>                     ContinualAutomationContextKeys;                    // 0x0090(0x0050)(Transient, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_85C0[0x8];                                     // 0x00E0(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_85C1[0x18];                                    // 0x0078(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void BP_ClearCommonValue(struct FGameplayTag& Key);
	void BP_ClearEntry(struct FGameplayTag& Key);
	void BP_ClearPlayerValue(class ULocalPlayer* LocalPlayer, struct FGameplayTag& Key);
	void BP_SetCommonBoolValue(struct FGameplayTag& Key, bool Value);
	void BP_SetCommonFloatValue(struct FGameplayTag& Key, float Value);
	void BP_SetCommonIntValue(struct FGameplayTag& Key, int32 Value);
	void BP_SetCommonStringValue(struct FGameplayTag& Key, class FString& Value);
	void BP_SetPlayerBoolValue(class ULocalPlayer* LocalPlayer, struct FGameplayTag& Key, bool Value);
	void BP_SetPlayerFloatValue(class ULocalPlayer* LocalPlayer, struct FGameplayTag& Key, float Value);
	void BP_SetPlayerStringValue(class ULocalPlayer* LocalPlayer, struct FGameplayTag& Key, class FString& Value);
	void BP_SetPlayerValue(class ULocalPlayer* LocalPlayer, struct FGameplayTag& Key, int32 Value);

	class UUIStateChartContextEntry* BP_FindEntry(struct FGameplayTag& Key) const;
...
public:
	...
	uint8                                         Pad_85C8[0x20];                                    // 0x0088(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool GetPlayerValueAsBool(class ULocalPlayer* InLocalPlayer) const;
	float GetPlayerValueAsFloat(class ULocalPlayer* InLocalPlayer) const;
	int32 GetPlayerValueAsInt(class ULocalPlayer* InLocalPlayer) const;
	class FString GetPlayerValueAsString(class ULocalPlayer* InLocalPlayer) const;
...
{
public:
	uint8                                         Pad_85CD[0x8];                                     // 0x0030(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_85CE[0x50];                                    // 0x00A8(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	int32 BP_AddStateChart(class UUIStateChart* StateChartAsset, class ULocalPlayer* OwningLocalPlayer, struct FGameplayTagContainer& AnimationHints, struct FGameplayTag& InitialStateTag, EUIStateTransitionUrgency Urgency);
	bool BP_DeactivateStateChart(int32 Key, struct FGameplayTagContainer& AnimationHints, struct FUIStateChartContextChangeSet& ContextChanges, EUIStateTransitionUrgency Urgency);
	bool BP_DispatchTransitionEvent(struct FGameplayTag& TransitionTag, class ULocalPlayer* StateChartOwner, struct FGameplayTagContainer& AnimationHints, struct FUIStateChartContextChangeSet& ContextChanges, EUIStateTransitionUrgency Urgency, bool bBacktrack);
	void BP_ReactivateStateChart(int32 Key, struct FGameplayTagContainer& AnimationHints, struct FGameplayTag& StateTag, EUIStateTransitionUrgency Urgency);
	bool BP_RemoveStateChart(int32 Key, struct FGameplayTagContainer& AnimationHints, struct FUIStateChartContextChangeSet& ContextChanges, EUIStateTransitionUrgency Urgency);
...
public:
	...
	uint8                                         Pad_85D9[0x10];                                    // 0x00D8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_85DA[0x4];                                     // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_85DB[0x8];                                     // 0x00E0(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_85DC[0x8];                                     // 0x0038(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_85DD[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_85DE[0x8];                                     // 0x0050(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_85DF[0x8];                                     // 0x00A8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_85E0[0x8];                                     // 0x00B8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_85E1[0x4];                                     // 0x01A4(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
