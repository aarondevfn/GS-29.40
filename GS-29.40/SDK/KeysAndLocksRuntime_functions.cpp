...
void AFortKeysAndLocksDisplayCase::NativeCalculateLockInteractStrings(TArray<struct FFortItemEntry>& Loot, TArray<class FText>& RarityTexts, class UFortWorldItemDefinition* ItemDefinition, bool bShowCount, class FText* HaveKey, class FText* NeedKey, class UFortWeaponModSetData* WeaponModSetData)
{
	static class UFunction* Func = nullptr;
	...
	if (HaveKey != nullptr)
		*HaveKey = Parms.HaveKey;

	if (NeedKey != nullptr)
		*NeedKey = Parms.NeedKey;
}
...
bool AFortKeysAndLocksDisplayCase::NativeLockChildActorsPassAllRequirements(TArray<class UChildActorComponent*>& LockChildActors, class UFortWorldItemDefinition* ItemDefinition)
{
	static class UFunction* Func = nullptr;
