...
public:
	...
	uint8                                         Pad_2B3D[0x18];                                    // 0x0070(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2B3E[0x8];                                     // 0x00A0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2B3F[0x70];                                    // 0x0468(0x0070)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2B40[0x10];                                    // 0x0028(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2B41[0x6];                                     // 0x006A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2B42[0x8];                                     // 0x00A8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2B43[0x18];                                    // 0x00C8(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void SetDesiredSize(const struct FVector2f& Param_DesiredSize);
...
public:
	...
	uint8                                         Pad_2B44[0x1F];                                    // 0x0109(0x001F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2B46[0x7];                                     // 0x00C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2B47[0x6];                                     // 0x011A(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void SetOverflowPolicy(ETextOverflowPolicy Param_OverflowPolicy);
	void SetTextColor(const struct FLinearColor& Param_TextColor);
...
public:
	...
	void SetShadowColor(const struct FLinearColor& Param_ShadowColor);
	void SetShadowOffset(const struct FVector2f& Param_ShadowOffset);
...
public:
	...
	struct FUIFrameworkUserWidgetViewmodelList    ReplicatedViewmodelList;                           // 0x01E8(0x0120)(Net, NativeAccessSpecifierPrivate)

public:
	void SetNamedSlot(class FName SlotName, class UUIFrameworkWidget* Widget);
	void SetViewModel(class FName ViewModelName, TScriptInterface<class INotifyFieldValueChanged> ViewModel);
