...
public:
	...
	uint8                                         Pad_9BD7[0x4];                                     // 0x0034(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	static void AddPartInstance(struct FAtomModelPartsCollection* PartCollection, struct FAtomModelPartInstanceInfo& PartInstance);
	static class FString Conv_ModelPartGuidToString(struct FAtomModelPartGuid& InModelPartGuid);
	...
	static struct FAtomModelPartsCollection FilterGroup(class UAtomModel* Model, struct FAtomModelPartsCollection& PartsCollectionToFilter, const class FString& GroupName, const class FString& NewPartsCollectionName);
	static struct FAtomModelPartsCollection FilterNonTransparent(struct FAtomModelPartsCollection& PartsCollectionToFilter, const class FString& NewPartsCollectionName);
	static struct FAtomModelPartsCollection FilterSelectionSet(struct FAtomModelPartsCollection& PartsCollectionToFilter, const class FString& SelectionSetName, const class FString& NewPartsCollectionName);
	static struct FAtomModelPartsCollection FilterTransparent(struct FAtomModelPartsCollection& PartsCollectionToFilter, const class FString& NewPartsCollectionName);
	static int32 GetModelPartGuidHash(struct FAtomModelPartGuid& InModelPartGuid);
	static class FString GetName(struct FAtomModelPartsCollection& PartsCollection);
	static const TArray<struct FAtomModelPartInstanceInfo> GetParts(struct FAtomModelPartsCollection& PartsCollection);
	static TArray<struct FAtomCommonPartAndTransform> GetPrimitiveCommonParts(class UAtomPrimitive* Primitive, double Scale);
	static struct FAtomModelPartsCollection InitializeCommonParts(struct FAtomModelPartsCollection& PartsCollection, class UAtomModel* Model, float Scale, bool bRemoveConnectedParts, bool bRemoveAllKnobs, bool bRemoveAllTubes, bool bRemoveAllPins);
	static void RemovePartInstance(struct FAtomModelPartsCollection* PartCollection, struct FAtomModelPartGuid& PartInstanceId);
	static void ReplacePartInstance(struct FAtomModelPartsCollection* PartCollection, struct FAtomModelPartInstanceInfo& SourcePartInstance, struct FAtomModelPartGuid& TargetPartInstanceId);
	static void SetName(struct FAtomModelPartsCollection* PartsCollection, const class FString& Param_Name);
...
{
public:
	uint8                                         Pad_9BDD[0x2C0];                                   // 0x0028(0x02C0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	class UAtomPrimitiveGeometry* Append(class UAtomPrimitiveGeometry* GeometryToAppend, struct FTransform3f& Transform);
	class UAtomPrimitiveGeometry* AppendAndWeld(class UAtomPrimitiveGeometry* GeometryToAppend, struct FTransform3f& Transform);
	...
	class UAtomPrimitiveGeometry* BakeTransform(struct FTransform3f& Transform);
	class UAtomPrimitiveGeometry* BakeTransforms(TArray<struct FTransform3f>& Transforms);
	class UAtomPrimitiveGeometry* SetMaterialName(const class FString& Param_Name, int32 PolygonGroupIndex);
	class UAtomPrimitiveGeometry* SetTiledUVs(float TileSize);
	class UAtomPrimitiveGeometry* SetVertexColor(struct FColor& Color);
	...
	class UStaticMesh* ToSimplifiedStaticMesh(float Scale, class UObject* Param_Outer, const class FString& Param_Name, bool bFastBuild) const;
...
public:
	...
	uint8                                         Pad_9BED[0x4];                                     // 0x005C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class FString, int32>                    GeometryCount;                                     // 0x0060(0x0050)(Edit, Transient, EditConst, NativeAccessSpecifierPrivate)
	uint8                                         Pad_9BEE[0x50];                                    // 0x00B0(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	static int32 GetBitPackForColor(struct FColor& Color);
...
public:
	...
	uint8                                         Pad_9BFB[0x4];                                     // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9BFC[0x6];                                     // 0x005A(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_9BFD[0x150];                                   // 0x0030(0x0150)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	struct FPlanarFieldInfo GetClosestFieldToPoint(const struct FWorldConnectivityHandle& Handle, struct FVector& WorldLocation, EConnectionFieldGender Type, bool* bSuccess);
	...
	struct FVector GetPlanarFieldCenter(struct FPlanarFieldInfo& Field);
	TArray<struct FPlanarFieldInfo> GetPlanarFields(const struct FWorldConnectivityHandle& Handle, EConnectionFieldGender Type);
	bool RegisterAtomActor(class AActor* Actor);
	bool RegisterConnectivityActor(class AActor* Actor, class UAtomModel* Model);
	void RegisterCustomConnectivityActor(class AActor* Actor, struct FSerializedConnectivityObjects& ConnectivityObject);
	void RegisterModelActor(class AActor* Actor, struct FSerializedConnectivityObjects& Connections);
	TArray<struct FConnectivityQueryResult> RunPlanarConnectivityQuery(class AActor* AtomActorToPlace, class AActor* AtomActorToConnect, struct FVector& QueryStartLocation, struct FVector& QueryEndLocation, ECollisionChannel QueryCollisionChannel, int32 QueryRadius, bool bSaveConnectionOnSuccess);
	bool TryConnectObjectAtLocation(const struct FWorldConnectivityHandle& ObjectToConnect, struct FTransform& DesiredObjectTransform, TArray<struct FWorldConnectivityHandle>& ConnectionCandidates, bool PerformConnection);
	void UnregisterConnectivityActor(class AActor* Actor);

	class AActor* GetActor(const struct FWorldConnectivityHandle& Handle) const;
	const class UAtomModel* GetAtomModel(class AActor* Actor) const;
	class UAtomModelAssetUserData* GetAtomModelAssetUserData(class UObject* Object) const;
	struct FWorldConnectivityHandle GetConnectivityHandle(class AActor* Actor) const;
	TArray<struct FWorldConnectivityHandle> GetConnectivityHandles(class AActor* Actor) const;
...
{
public:
	static class AActor* GetActor(class UObject* WorldContext, struct FWorldConnectivityHandle& Handle);
	static struct FVector GetFieldCenter(class UObject* WorldContext, struct FPlanarFieldInfo& Field);
	static struct FTransform GetTransform(class UObject* WorldContext, struct FWorldConnectivityHandle& Handle);
	static bool IsValid(struct FWorldConnectivityHandle& Handle);
...
{
public:
	uint8                                         Pad_9C12[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9C13[0xB8];                                    // 0x0038(0x00B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_9C14[0x7];                                     // 0x00E1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9C15[0x50];                                    // 0x0158(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_9C18[0x7];                                     // 0x0229(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9C19[0x1];                                     // 0x0257(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9C1A[0x3];                                     // 0x025D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool                                          bUseRenderStyle;                                   // 0x05E9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseFallbackRenderStyle;                           // 0x05EA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9C1B[0x5];                                     // 0x05EB(0x0005)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_9C1C[0x3];                                     // 0x0029(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9C1D[0x4];                                     // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9C1E[0x10];                                    // 0x0048(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void IncrementProgress(int32 NumSteps, const class FString& Message);
	class FString OnGetProcessModelTargetAssetPath(class UAtomModel* Model, struct FAtomModelPartsCollection& AtomModelPartsCollection);
	class FString OnGetProcessPrimitiveTargetAssetPath(class UAtomModel* Model, class UAtomPrimitive* Primitive, struct FAtomModelPartsCollection& AtomModelPartsCollection, struct FAtomOnProcessPrimitiveSettings& Settings);
	class FString OnGetTargetAssetPath(class UAtomModel* Model, class UAtomPrimitive* Primitive, struct FAtomModelPartsCollection& AtomModelPartsCollection);
	struct FAtomProcessorResult OnProcessModel(class UAtomModel* Model, struct FAtomModelPartsCollection& AtomModelPartsCollection, TArray<TSoftObjectPtr<class UObject>>& ExistingObjects);
	struct FAtomProcessorResult OnProcessPrimitive(class UAtomModel* DummyModel, class UAtomPrimitive* Primitive, struct FAtomModelPartsCollection& AtomModelPartsCollection, struct FAtomOnProcessPrimitiveSettings& Settings);
...
{
public:
	static struct FAtomProcessorResult AppendAtomProcessorResult(struct FAtomProcessorResult& Result, struct FAtomProcessorResult& ResultToAppend);
	static const class UAtomModelProcessor* GetModelProcessor(struct FAtomModelProcessorInstance& ProcessorInstance);
	static const class UClass* GetProcessorClass(struct FAtomModelProcessorInstance& ProcessorInstance);
	static bool IsValid(struct FAtomModelProcessorInstance& ProcessorInstance);
...
public:
	...
	uint8                                         Pad_9C26[0x4];                                     // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9C27[0x2];                                     // 0x0046(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9C28[0x3];                                     // 0x005D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9C29[0x7];                                     // 0x0109(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	class UAtomPrimitiveGeometryContainer* GetGeometryContainerForBestExportStyle(TArray<class FString>& GeometryStylePriorityList, int32 LODIndex) const;
