...
void UFortCameraMode_Flying::BP_ProcessViewRotation(struct FRotator& InViewRotation, struct FRotator& InDeltaRot, float DeltaTime, bool* bOutShouldOverride, struct FRotator* OutViewRotation, struct FRotator* OutDeltaRot) const
{
