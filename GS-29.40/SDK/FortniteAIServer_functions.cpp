...
void UFortAthenaAIBotEvaluator_Harvest::HandleUnconverted(class AFortPawn* UnconvertedPawn, EUnconvertReason UnconvertReason)
{
	static class UFunction* Func = nullptr;
...
void UFortAthenaAIBotEvaluator_CharacterLaunched::OnCharacterLaunchChanged(class UFortMovementComp_Character* MovementComponent, struct FVector& LaunchVelocity)
{
	static class UFunction* Func = nullptr;
...
void UFortAthenaAIBotEvaluator_Converted::OnUnconvertedEvent(class AFortPawn* UnconvertedPawn, EUnconvertReason UnconvertReason)
{
	static class UFunction* Func = nullptr;
...
void UFortAthenaAIBotEvaluator_RangeAttack::FindShootingPosition_Async(int32 RequestID, float DistanceFromTarget, float WeaponIdealAttackRange, struct FVector& TargetPosition)
{
	static class UFunction* Func = nullptr;
...
void UFortAthenaAIBotEvaluator_ReactToVerb::HandlePawnStartedEmote(class UFortItemDefinition* MontageItemDef, class AFortPawn* PawnEmoting)
{
	static class UFunction* Func = nullptr;
...
void UFortAthenaAIBotEvaluator_ReactToVerb::HandlePawnStoppedEmote(class UFortItemDefinition* MontageItemDef, class AFortPawn* PawnEmoting)
{
	static class UFunction* Func = nullptr;
...
void UFortAthenaAIBotEvaluator_SelectNextDynamicPOI::ReachingPositionFail_Async(int32 RequestID)
{
	static class UFunction* Func = nullptr;
...
void UFortAthenaAIBotEvaluator_Storm::OnSafeZoneStateChanged(EFortSafeZoneState NewState)
{
	static class UFunction* Func = nullptr;
