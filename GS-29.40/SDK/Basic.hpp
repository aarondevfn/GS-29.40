...
namespace Offsets
{
	constexpr int32 GObjects          = 0x1277CEB0;
	constexpr int32 AppendString      = 0x013E7EB0;
	constexpr int32 GNames            = 0x00000000;
	constexpr int32 GWorld            = 0x127A4BD8;
	constexpr int32 ProcessEvent      = 0x014A8774;
...
public:
	...
	inline class FUObjectItem* GetItemByIndex(int32 Index)
	{
		const int32 ChunkIndex = Index / ElementsPerChunk;
		const int32 WithinChunkIndex = Index % ElementsPerChunk;
...
namespace FMemory
{
	...
	inline void* (*Realloc)(void* Original, SIZE_T Count, uint32_t Alignment);
}
...
public:
	...
	inline       T& operator[](int32 Index) { VerifyIndex(Index); return Data[Index]; }
	inline const T& operator[](int32 Index) const { VerifyIndex(Index); return Data[Index]; }
	...
	{
		Data = (T*)FMemory::Realloc(Data, sizeof(T) * (NumElements + 1), 0);
...
public:
	...
	/*  1. Change "thread_local FString TempString(1024);" to "FString TempString;"            */;   // 0x0000(0x0000)()
	/*  2. Add a "Free" function to FString that calls FMemory::Free(Data);                    */;   // 0x0000(0x0000)()
	/*  3. Replace "TempString.ResetNum();" with "TempString.Free();"                          */;   // 0x0000(0x0000)()
...
public:
	...
	uint8                                         Pad_4[0x8];                                        // 0x0008(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_6[0x4];                                        // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_7[0x4];                                        // 0x0038(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Offset;                                            // 0x003C(0x0004)(NOT AUTO-GENERATED PROPERTY)
	uint8                                         Pad_8[0x28];                                       // 0x0040(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_9[0x8];                                        // 0x0068(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
