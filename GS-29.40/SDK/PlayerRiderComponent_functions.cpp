...
// TDelegate<void(struct FHitResult& Hit)> K2Node_CreateDelegate_OutputDelegate_2                 (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// TScriptInterface<class IRidingGeneric_Interafce_C>K2Node_DynamicCast_AsRiding_Generic_Interafce          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// TDelegate<void(class ACharacter* Character, EMovementMode PrevMovementMode, uint8 PreviousCustomMode)>K2Node_CreateDelegate_OutputDelegate_5                 (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UPlayerRiderComponent_C::RiderUIEnd__DelegateSignature(class AActor* RidableActor)
{
	...
	Params::PlayerRiderComponent_C_RiderUIEnd__DelegateSignature Parms{};
...
void UPlayerRiderComponent_C::RiderUINewStats__DelegateSignature(class FText Param_Name, const struct FSlateBrush& Icon, class AActor* RidableActor)
{
	static class UFunction* Func = nullptr;
	...
	Params::PlayerRiderComponent_C_RiderUINewStats__DelegateSignature Parms{};
...
void UPlayerRiderComponent_C::RiderUIStartClient(class FText Param_Name, const struct FSlateBrush& Icon, class AActor* Ridable)
{
	static class UFunction* Func = nullptr;
...
void UPlayerRiderComponent_C::RiderUIUpdateEnergy__DelegateSignature(double Energy)
{
	...
	Params::PlayerRiderComponent_C_RiderUIUpdateEnergy__DelegateSignature Parms{};
...
void UPlayerRiderComponent_C::RiderUIUpdateHealth__DelegateSignature(double Health)
{
	...
	Params::PlayerRiderComponent_C_RiderUIUpdateHealth__DelegateSignature Parms{};
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// double                                  Param_TargetHealth                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UPlayerRiderComponent_C::SetTargetHealth(double Param_TargetHealth)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_TargetHealth = Param_TargetHealth;
