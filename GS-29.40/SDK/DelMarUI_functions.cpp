...
void ADelMarCreativeUIDirector::OnVehicleAnyWheelsOnGroundChanged(TScriptInterface<class IDelMarVehicleInterface>& VehicleRef, bool bAnyWheelsOnGround)
{
	static class UFunction* Func = nullptr;
...
void UDelMarPlayerIndicatorsContainer::HandleRacePlayersChanged(TMap<int32, class UDelMarPlayerViewModel*>& RacePlayers)
{
	static class UFunction* Func = nullptr;
...
void UDelMarRichTextInputSwitcher::SetInputText(class FText InTextKBM, class FText InTextGamepad, class FText InTextTouch)
{
	static class UFunction* Func = nullptr;
	...
	Parms.InTextKBM = InTextKBM;
	Parms.InTextGamepad = InTextGamepad;
	Parms.InTextTouch = InTextTouch;
...
void UDelMarTouchWidgetBase::OnInputInjectionEnded(struct FPointerEvent& InGestureEvent, EDelMarInputInjectionState InInjectedState)
{
	static class UFunction* Func = nullptr;
...
void UDelMarTouchWidgetBase::OnInputInjectionStarted(struct FPointerEvent& InGestureEvent, EDelMarInputInjectionState InInjectedState)
{
	static class UFunction* Func = nullptr;
...
void UDelMarTouchWidgetBase::OnTrackedInputEnded(struct FPointerEvent& InGestureEvent, bool bCancelled)
{
	static class UFunction* Func = nullptr;
...
void UDelMarTouchWidgetBase::OnTrackedInputStarted(struct FPointerEvent& InGestureEvent)
{
	static class UFunction* Func = nullptr;
...
void UDelMarTouchWidgetBase::OnTrackedInputUpdated(struct FPointerEvent& InGestureEvent)
{
	static class UFunction* Func = nullptr;
...
bool UDelMarTouchWidgetBase::IsGestureInsideHitbox(struct FPointerEvent& InGestureEvent) const
{
	static class UFunction* Func = nullptr;
...
void UDelMarTouchActionButton::SetBackgroundBrush(struct FSlateBrush& Brush)
{
	static class UFunction* Func = nullptr;
...
void UDelMarTouchActionButton::SetIconBrush(struct FSlateBrush& Brush)
{
	static class UFunction* Func = nullptr;
...
void UDelMarUICheatManager::DelMarSetHint(class FText HintText, float RemoveAfterDelay)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class UUserWidget*                      Param_WidgetTarget                                     (Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UWidgetAnimation*                 Param_Animation                                        (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UUITimelineAnimationController* UUITimelineAnimationController::CreateInstance(class UUserWidget* Param_WidgetTarget, class UWidgetAnimation* Param_Animation)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_WidgetTarget = Param_WidgetTarget;
...
// (Final, Native, Static, Public, BlueprintCallable, BlueprintPure)
// Parameters:
// class UWidget*                          Param_TargetWidget                                     (Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// ESlateVisibility                        Param_HiddenVisibility                                 (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// ESlateVisibility                        Param_ShownVisibility                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UWidgetTransitioner* UWidgetTransitioner::CreateInstance(class UWidget* Param_TargetWidget, EWidgetTransitionerInitialStatus InitialStatus, ESlateVisibility Param_HiddenVisibility, ESlateVisibility Param_ShownVisibility, bool AlwaysReverseInterruptedAnimations)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_TargetWidget = Param_TargetWidget;
	Parms.InitialStatus = InitialStatus;
	Parms.Param_HiddenVisibility = Param_HiddenVisibility;
	Parms.Param_ShownVisibility = Param_ShownVisibility;
...
void UWidgetTransitioner::AddHintedTransitionIn(struct FGameplayTag& InAnimationHint, class UUIAnimationController* InAnimationIn, bool bInvert)
{
	static class UFunction* Func = nullptr;
...
void UWidgetTransitioner::AddHintedTransitionOut(struct FGameplayTag& InAnimationHint, class UUIAnimationController* InAnimationOut, bool bInvert)
{
	static class UFunction* Func = nullptr;
...
void UWidgetTransitioner::AddHintedTransitionPair(struct FGameplayTag& InAnimationHint, class UUIAnimationController* InAnimation, bool bIsTransitionIn)
{
	static class UFunction* Func = nullptr;
...
void UWidgetTransitioner::BP_Hide(bool bSkipAnimation, struct FGameplayTagContainer& AnimationHints)
{
	static class UFunction* Func = nullptr;
...
class UWidgetTransitioner* UWidgetTransitioner::BP_Initialize(class UWidget* Param_TargetWidget, EWidgetTransitionerInitialStatus InitialStatus, ESlateVisibility Param_HiddenVisibility, ESlateVisibility Param_ShownVisibility, bool AlwaysReverseInterruptedAnimations)
{
	static class UFunction* Func = nullptr;
...
void UWidgetTransitioner::BP_Show(bool bSkipAnimation, struct FGameplayTagContainer& AnimationHints)
{
	static class UFunction* Func = nullptr;
...
void UWidgetTransitioner::SetNormalTransitionIn(class UUIAnimationController* InAnimationIn, bool bInvert)
{
	static class UFunction* Func = nullptr;
...
void UWidgetTransitioner::SetNormalTransitionOut(class UUIAnimationController* InAnimationOut, bool bInvert)
{
	static class UFunction* Func = nullptr;
...
void UWidgetTransitioner::SetNormalTransitionPair(class UUIAnimationController* InAnimation, bool bIsTransitionIn)
{
	static class UFunction* Func = nullptr;
...
void UDelMarCheckpointTrackerEntryWidget::BP_OnDisplayedCheckpointChanged(struct FDelMarSectionData& InSectionData, bool bNewEntry)
{
	static class UFunction* Func = nullptr;
...
void UDelMarReadyUpWidget::BP_ReadyUp(bool bReady)
{
	static class UFunction* Func = nullptr;
...
void UDelMarBoundActionButton::BP_OnActionProgress(float HoldPercentage)
{
	static class UFunction* Func = nullptr;
...
void UDelMarBoundActionButton::BP_SetText(class FText& ButtonText)
{
	static class UFunction* Func = nullptr;
...
void UDelMarRaceViewModel::HandleFinalRacePositionsChanged(TArray<struct FDelMarFinalRacePositionEntry>& FinalRacePositions, struct FDelMarEvent_RunRecorded& RecordedRun)
{
	static class UFunction* Func = nullptr;
...
void UDelMarVehicleViewModel::HandleAnyWheelsOnGroundChanged(TScriptInterface<class IDelMarVehicleInterface>& VehicleRef, bool bValue)
{
	static class UFunction* Func = nullptr;
...
void UDelMarVehicleViewModel::HandleMissedCheckpointCountdownInitiated(struct FDelMarEvent_MissedCheckpointDemoCountdown& Event)
{
	static class UFunction* Func = nullptr;
...
void UDelMarVehicleViewModel::HandleReturnToTrackCountdownInitiated(struct FDelMarEvent_ReturnToTrackDemoCountdown& Event)
{
	static class UFunction* Func = nullptr;
...
void UDelMarVehicleViewModel::HandleWrongwayIndication(struct FDelMarEvent_VehicleWrongwayStatus& Event)
{
	static class UFunction* Func = nullptr;
