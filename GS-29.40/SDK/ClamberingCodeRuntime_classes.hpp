...
public:
	...
	uint8                                         Pad_8662[0x4];                                     // 0x01AC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	void BP_GetAnimationMontageInformation(struct FClamberMontageInput& Context, class UAnimMontage** AnimMontage, class FName* StartSectionName, class FName* MontageMiddleSectionName);
...
public:
	...
	uint8                                         Pad_8663[0x50];                                    // 0x02A0(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void BP_OnAddInstance(struct FTransform& LedgeTransform, int32 InstanceIndex);
	void BP_OnRemoveInstance(struct FTransform& LedgeTransform, int32 InstanceIndex);
...
public:
	...
	uint8                                         Pad_8666[0x80];                                    // 0x00D0(0x0080)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void OnWallDied(float Damage, struct FGameplayTagContainer& DamageTags, const struct FVector& Momentum, struct FHitResult& HitInfo, class AFortPawn* InstigatedBy, class AActor* DamageCauser, const struct FGameplayEffectContextHandle& EffectContext);
...
{
public:
	uint8                                         Pad_8668[0x8];                                     // 0x00A8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8669[0x6];                                     // 0x00B2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_866A[0x8];                                     // 0x01D0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_866B[0x8];                                     // 0x0228(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_866C[0x6];                                     // 0x025A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_866D[0x4];                                     // 0x0BB4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_866E[0x7];                                     // 0x0C99(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_866F[0x3];                                     // 0x0E69(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8670[0x50];                                    // 0x0E70(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8671[0x4];                                     // 0x0EC4(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void BP_HandleClamberingStateChanged(EClamberingState OldClamberingState, EClamberingState NewClamberingState);
	...
	void ServerStartClambering(struct FReplicatedClamberingTargetingData& InReplicatedTargetingData, double ClientLastTeleportTime);
	...
	void BP_IsValidTargetActor(class AActor* TargetActor, bool* bIsValidTargetActor) const;
...
{
public:
	static bool PerformClamberingTargeting(class ACharacter* Character, struct FClamberingTargetingData* OutTargetingData);
...
{
public:
	uint8                                         Pad_8675[0x1A8];                                   // 0x0338(0x01A8)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8676[0xF];                                     // 0x04F1(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
