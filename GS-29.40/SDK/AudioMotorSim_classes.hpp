...
public:
	...
	uint8                                         Pad_83C8[0x40];                                    // 0x00C0(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void AddMotorAudioComponent(TScriptInterface<class IAudioMotorSimOutput> InComponent);
	void AddMotorSimComponent(TScriptInterface<class IAudioMotorSim> InComponent, int32 SortOrder);
	...
	void StartOutput();
	void StopOutput();
	void Update(struct FAudioMotorSimInputContext& Input);
...
{
public:
	uint8                                         Pad_83CA[0x8];                                     // 0x00A0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_83CB[0x7];                                     // 0x00A9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
