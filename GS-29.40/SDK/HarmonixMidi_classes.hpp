...
{
public:
	uint8                                         Pad_8AE2[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMidiFileData                          TheMidiData;                                       // 0x0030(0x00E8)(Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_8AE3[0x10];                                    // 0x0118(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	static uint8 MidiNoteToByte(struct FMidiNote& InMidiNote);
	static int32 MidiNoteToInt(struct FMidiNote& InMidiNote);
