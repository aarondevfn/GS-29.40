...
bool UAnimSequenceSideloaded::SideloadData(TArray<uint8>& Memory)
{
	static class UFunction* Func = nullptr;
...
bool UAnimSequenceSideloaded::LoadDataFromFile(class FString& Location, TArray<uint8>& Memory) const
{
	static class UFunction* Func = nullptr;
