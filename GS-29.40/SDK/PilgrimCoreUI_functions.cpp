...
void UPilgrimPresetSwitcher::InitializeForLanes(int32 NewNumLanes, TArray<class UFortInputMappingContext*>& InputMappingContexts)
{
	static class UFunction* Func = nullptr;
...
void UPilgrimSongFilterVM::Initialize(class APlayerController* InOwningController, struct FGameplayTagContainer& InSortTags, struct FGameplayTagContainer& InFilterTags)
{
	static class UFunction* Func = nullptr;
