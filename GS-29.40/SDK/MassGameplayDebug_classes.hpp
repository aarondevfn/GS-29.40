...
{
public:
	uint8                                         Pad_1459[0x2A8];                                   // 0x00D8(0x02A8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_145A[0x2A0];                                   // 0x00C0(0x02A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_145B[0x2A0];                                   // 0x00C0(0x02A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_145C[0x80];                                    // 0x0038(0x0080)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_145D[0x8];                                     // 0x00C8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
