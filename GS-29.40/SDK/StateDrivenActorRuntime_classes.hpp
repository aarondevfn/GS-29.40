...
public:
	...
	uint8                                         Pad_98DD[0x4];                                     // 0x00BC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_98DE[0xF8];                                    // 0x00F8(0x00F8)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_98DF[0x8];                                     // 0x0398(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void HandleBeginOverlap(class UPrimitiveComponent* OverlappedComp, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult);
	...
	void OnHandleStateTreeEvent(struct FGameplayTag& TransitionTag, struct FGameplayCueTag& BurstGameplayCueTag);
	void OnMulticastStateTreeEvent(struct FGameplayTag& TransitionTag, struct FGameplayCueTag& BurstGameplayCueTag);
	...
	class FText GetFailedInteractionString(class AFortPawn* InteractingPawn, EInteractionBeingAttempted InteractionBeingAttempted) const;
	class FText GetInteractionString(class AFortPawn* InteractingPawn, EInteractionBeingAttempted InteractionBeingAttempted) const;
	class FText GetSlottedItemDisplayName() const;
	const struct FFortItemEntry GetSlottedItemEntry() const;
	void PlayBurstGameplayCue(struct FGameplayTag& GameplayCueTag) const;
