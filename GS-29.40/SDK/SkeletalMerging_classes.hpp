...
{
public:
	static class USkeletalMesh* MergeMeshes(struct FSkeletalMeshMergeParams& Params_0);
	static class USkeleton* MergeSkeletons(struct FSkeletonMergeParams& Params_0);
