...
public:
	...
	uint8                                         Pad_8B2B[0x5];                                     // 0x01CB(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagQuery                      SkipActorsWithTag;                                 // 0x01D0(0x0048)(Edit, BlueprintReadOnly, NativeAccessSpecifierPublic)
	uint8                                         Pad_8B2C[0x8];                                     // 0x0218(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_8B2F[0x8];                                     // 0x0580(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8B30[0x3];                                     // 0x0589(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_8B32[0x4];                                     // 0x05B4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8B33[0x4];                                     // 0x05DC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8B34[0x4];                                     // 0x0604(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_8B35[0x7];                                     // 0x00A1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8B36[0x50];                                    // 0x0148(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class USparksCosmeticCatalog* GetSparksCosmeticCatalog(class UObject* WorldContextObject);

	class USparksAccountItemDefinition* GetItemDefFromAssetID(struct FPrimaryAssetId& AssetId);
...
public:
	...
	uint8                                         Pad_8B3A[0x57];                                    // 0x00D1(0x0057)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSparksCosmeticLoadoutData             CurrentLoadout;                                    // 0x0128(0x00F0)(Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_8B3B[0x8];                                     // 0x0218(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8B3C[0x80];                                    // 0x02D8(0x0080)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8B3D[0x50];                                    // 0x03F8(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8B3E[0x7];                                     // 0x0459(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	class FName GetEquippedJamSongShortnameForIndex(int32 Param_Index);
	class FString GetEquippedJamSongUIDForIndex(int32 Param_Index);
	class FName GetOwnedJamSongShortnameForIndex(int32 Param_Index);
...
{
public:
	uint8                                         Pad_8B4D[0x8];                                     // 0x0030(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	class UFXSystemAsset* GetAuxFXSystem(struct FSparksVariantChoices& Choices) const;
	class UMaterialInstance* GetAuxiliaryMaterial(struct FSparksVariantChoices& Choices) const;
	class UMaterialInstance* GetAuxiliaryMaterial2(struct FSparksVariantChoices& Choices) const;
	class USkeletalMesh* GetAuxiliaryMesh(struct FSparksVariantChoices& Choices) const;
	class UMaterialInstance* GetLeftHandMaterial(struct FSparksVariantChoices& Choices) const;
	class USkeletalMesh* GetLeftHandMesh(struct FSparksVariantChoices& Choices) const;
	class UFXSystemAsset* GetLHFXSystem(struct FSparksVariantChoices& Choices) const;
	class UFXSystemAsset* GetMainFXSystem(struct FSparksVariantChoices& Choices) const;
	class UMaterialInstance* GetMaterial(struct FSparksVariantChoices& Choices) const;
	class USkeletalMesh* GetMesh(struct FSparksVariantChoices& Choices) const;
...
{
public:
	uint8                                         Pad_8B4E[0x10];                                    // 0x0448(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8B4F[0x4];                                     // 0x0484(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_8B50[0x8];                                     // 0x0718(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_8B51[0x7];                                     // 0x07A1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	EFMJamLoopType GetJamLoopType() const;
	const class UCatalogData* GetJamSongMetaData(class UObject* WorldContextObject) const;
	class FName GetJamSongShortName(class UObject* WorldContextObject) const;
	class USparksSongItemDefinition* GetSongItemDef() const;
	bool IsJamLoopEnabled(class AFortPlayerController* PlayerController) const;
...
public:
	...
	uint8                                         Pad_8B54[0x7];                                     // 0x00A1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_8B55[0x10];                                    // 0x0290(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8B56[0x10];                                    // 0x02A8(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_8B57[0x7];                                     // 0x05B1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
