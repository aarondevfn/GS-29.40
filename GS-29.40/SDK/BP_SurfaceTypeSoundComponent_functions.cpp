...
// EPhysicalSurface                        Temp_byte_Variable_5                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// EFortResourceType                       Temp_byte_Variable_6                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// EPhysicalSurface                        Temp_byte_Variable_7                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// EPhysicalSurface                        K2Node_Select_Default                                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_SurfaceTypeSoundComponent_C::SetSurfaceType(EPhysicalSurface Param_SurfaceType, class AActor* Actor, EPhysicalSurface Temp_byte_Variable, bool CallFunc_IsValid_ReturnValue, class ABuildingSMActor* K2Node_DynamicCast_AsBuilding_Static_Mesh, bool K2Node_DynamicCast_bSuccess, EPhysicalSurface Temp_byte_Variable_1, EPhysicalSurface Temp_byte_Variable_2, EPhysicalSurface Temp_byte_Variable_3, EPhysicalSurface Temp_byte_Variable_4, EPhysicalSurface Temp_byte_Variable_5, EFortResourceType Temp_byte_Variable_6, EPhysicalSurface Temp_byte_Variable_7, EPhysicalSurface K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
