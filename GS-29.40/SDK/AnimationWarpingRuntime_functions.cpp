...
bool UAnimationWarpingLibrary::GetCurveValueFromAnimation(class UAnimSequenceBase* Animation, class FName CurveName, float Time, float* OutValue)
{
...
struct FTransform UAnimationWarpingLibrary::GetOffsetRootTransform(struct FAnimNodeReference& Node)
{
	static class UFunction* Func = nullptr;
