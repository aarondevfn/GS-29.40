...
public:
	...
	class UCommonRichTextBlock*                   Name_StoreMain_OfferDetailsAttribute_C;            // 0x0300(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
