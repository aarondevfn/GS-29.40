...
public:
	...
	uint8                                         Pad_933B[0x68];                                    // 0x0448(0x0068)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	class UWidget* HandleBoundaryNavigation(EUINavigation InNavigation);
	void OnVariantChangedEvent__DelegateSignature(struct FMcpVariantChannelInfo& InChannelInfo);
...
public:
	...
	uint8                                         Pad_933D[0x3];                                     // 0x14B1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_933E[0x44];                                    // 0x14BC(0x0044)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_933F[0x4];                                     // 0x07DC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9340[0x98];                                    // 0x07F0(0x0098)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_9341[0x34];                                    // 0x02D4(0x0034)(Fixing Struct Size After Last Property [ Dumper-7 ])
