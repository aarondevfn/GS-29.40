...
{
public:
	static struct FProposedMove ComputeControlledFreeMove(struct FFreeMoveParams& InParams);
	static bool IsValidLandingSpot(class USceneComponent* UpdatedComponent, class UPrimitiveComponent* UpdatedPrimitive, struct FVector& Location, struct FHitResult& Hit, float FloorSweepDistance, float MaxWalkSlopeCosine, struct FFloorCheckResult* OutFloorResult);
	static float TryMoveToFallAlongSurface(class USceneComponent* UpdatedComponent, class UPrimitiveComponent* UpdatedPrimitive, class UMoverComponent* MoverComponent, struct FVector& Delta, float PctOfDeltaToMove, struct FQuat& Rotation, struct FVector& Normal, struct FHitResult* Hit, bool bHandleImpact, float FloorSweepDistance, float MaxWalkSlopeCosine, struct FFloorCheckResult* OutFloorResult, struct FMovementRecord* MoveRecord);
...
public:
	...
	uint8                                         Pad_36F4[0x4];                                     // 0x014C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_36F5[0x8];                                     // 0x0180(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_36F6[0x128];                                   // 0x01A0(0x0128)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_36F7[0x7];                                     // 0x02D9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_36F8[0x7];                                     // 0x02F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3702[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3704[0x3];                                     // 0x0069(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3705[0x4];                                     // 0x007C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	static bool IsHitSurfaceWalkable(struct FHitResult& Hit, float MaxWalkSlopeCosine);
...
{
public:
	static bool CanStepUpOnHitSurface(struct FHitResult& Hit);
	static struct FProposedMove ComputeControlledGroundMove(struct FGroundMoveParams& InParams);
	static struct FVector ComputeDeflectedMoveOntoRamp(struct FVector& OrigMoveDelta, struct FHitResult& RampHitResult, float MaxWalkSlopeCosine, bool bHitFromLineTrace);
	static float TryWalkToSlideAlongSurface(class USceneComponent* UpdatedComponent, class UPrimitiveComponent* UpdatedPrimitive, class UMoverComponent* MoverComponent, struct FVector& Delta, float PctOfDeltaToMove, struct FQuat& Rotation, struct FVector& Normal, struct FHitResult* Hit, bool bHandleImpact, struct FMovementRecord* MoveRecord, float MaxWalkSlopeCosine, float MaxStepHeight);
...
{
public:
	struct FRotator GetTurn(const struct FRotator& TargetOrientation, struct FMoverTickStartData& FullStartState, struct FMoverDefaultSyncState& MoverState, struct FMoverTimeStep& TimeStep, struct FProposedMove& ProposedMove, class UMoverBlackboard* SimBlackboard);
...
{
public:
	uint8                                         Pad_370E[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_370F[0x4];                                     // 0x003C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3710[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3711[0x4];                                     // 0x0034(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3712[0x8];                                     // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3713[0x8];                                     // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3714[0x50];                                    // 0x0028(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	static struct FVector GetLocationFromSyncState(struct FMoverDefaultSyncState& SyncState);
	static struct FVector GetMoveDirectionIntentFromInputs(struct FCharacterDefaultInputs& Inputs);
	static struct FVector GetMoveDirectionIntentFromSyncState(struct FMoverDefaultSyncState& SyncState);
	static struct FRotator GetOrientationFromSyncState(struct FMoverDefaultSyncState& SyncState);
	static struct FVector GetVelocityFromSyncState(struct FMoverDefaultSyncState& SyncState);
	static void SetMoveIntent(struct FCharacterDefaultInputs& Inputs, struct FVector& WorldDirectionIntent);
...
public:
	...
	uint8                                         Pad_3719[0x1];                                     // 0x00AB(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_371A[0x64];                                    // 0x00B4(0x0064)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void OnHistoryTrackingRollback(struct FMoverTimeStep& NewTimeStep, struct FMoverTimeStep& InvalidatedTimeStep);
	void OnMovementSimRollback(struct FMoverTimeStep& NewTimeStep, struct FMoverTimeStep& InvalidatedTimeStep);
	void OnMovementSimTick(struct FMoverTimeStep& TimeStep);
...
public:
	...
	uint8                                         Pad_371B[0x4];                                     // 0x0034(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_371C[0x130];                                   // 0x00A0(0x0130)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_371E[0x20];                                    // 0x0290(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	static void K2_AddDataToCollection(struct FMoverDataCollection& Collection, int32& SourceAsRawBytes);
	static void K2_GetDataFromCollection(bool* DidSucceed, struct FMoverDataCollection& Collection, int32* TargetAsRawBytes);
...
{
public:
	uint8                                         Pad_3723[0x8];                                     // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void K2_OnTrigger(struct FSimulationTickParams& Params_0);

	struct FTransitionEvalResult K2_OnEvaluate(struct FSimulationTickParams& Params_0) const;
...
{
public:
	static struct FProposedMove ComputeControlledWaterMove(struct FWaterMoveParams& InParams);
	static void UpdateWaterSplineData(struct FUpdateWaterSplineDataParams& UpdateWaterSplineDataParams, struct FWaterCheckResult* OutWaterResult);
...
public:
	...
	uint8                                         Pad_3725[0x8];                                     // 0x0040(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void K2_OnRegistered(class FName ModeName);
	struct FMoverTickEndData K2_OnSimulationTick(struct FSimulationTickParams& Params_0);
	...
	struct FProposedMove K2_OnGenerateMove(struct FMoverTickStartData& StartState, struct FMoverTimeStep& TimeStep) const;
...
public:
	...
	uint8                                         Pad_3726[0x3];                                     // 0x0069(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3727[0xC];                                     // 0x0074(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void OnSimulationTick(struct FSimulationTickParams& Params_0, struct FMoverTickEndData* OutputState);

	void OnGenerateMove(struct FMoverTickStartData& StartState, struct FMoverTimeStep& TimeStep, struct FProposedMove* OutProposedMove) const;
	void ProcessLanded(struct FFloorCheckResult& FloorResult, struct FVector* Velocity, struct FRelativeBaseInfo* BaseInfo, struct FMoverTickEndData* TickEndData) const;
...
{
public:
	uint8                                         Pad_372A[0x8];                                     // 0x0048(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_372B[0x8];                                     // 0x00F0(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_372C[0x8];                                     // 0x0050(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	static bool GetMovementBaseTransform(class UPrimitiveComponent* MovementBase, class FName BoneName, struct FVector* OutLocation, struct FQuat* OutQuat);
	static bool IsADynamicBase(class UPrimitiveComponent* MovementBase);
	static bool IsBaseSimulatingPhysics(class UPrimitiveComponent* MovementBase);
	static bool TransformBasedDirectionToWorld(class UPrimitiveComponent* MovementBase, class FName BoneName, const struct FVector& LocalDirection, struct FVector* OutDirectionWorldSpace);
	static bool TransformBasedLocationToWorld(class UPrimitiveComponent* MovementBase, class FName BoneName, const struct FVector& LocalLocation, struct FVector* OutLocationWorldSpace);
	static bool TransformBasedRotatorToWorld(class UPrimitiveComponent* MovementBase, class FName BoneName, const struct FRotator& LocalRotator, struct FRotator* OutWorldSpaceRotator);
	...
	static bool TransformWorldDirectionToBased(class UPrimitiveComponent* MovementBase, class FName BoneName, const struct FVector& WorldSpaceDirection, struct FVector* OutLocalDirection);
	static bool TransformWorldLocationToBased(class UPrimitiveComponent* MovementBase, class FName BoneName, const struct FVector& WorldSpaceLocation, struct FVector* OutLocalLocation);
	static bool TransformWorldRotatorToBased(class UPrimitiveComponent* MovementBase, class FName BoneName, const struct FRotator& WorldSpaceRotator, struct FRotator* OutLocalRotator);
...
{
public:
	static bool CanEscapeGravity(struct FVector& PriorVelocity, struct FVector& NewVelocity, struct FVector& GravityAccel, float DeltaSeconds);
	static struct FRotator ComputeAngularVelocity(struct FRotator& From, struct FRotator& To, float DeltaSeconds, float TurningRateLimit);
	static struct FVector ComputeCombinedVelocity(struct FComputeCombinedVelocityParams& InParams);
	static struct FVector ComputeDirectionIntent(struct FVector& MoveInput, EMoveInputType MoveInputType);
	static struct FVector ComputeSlideDelta(struct FVector& Delta, float PctOfDeltaToMove, struct FVector& Normal, struct FHitResult& Hit);
	static struct FVector ComputeVelocity(struct FComputeVelocityParams& InParams);
	static struct FVector ComputeVelocityFromGravity(struct FVector& GravityAccel, float DeltaSeconds);
	static struct FVector ComputeVelocityFromPositions(struct FVector& FromPos, struct FVector& ToPos, float DeltaSeconds);
	static struct FVector ConstrainToPlane(struct FVector& Vector, struct FPlane& MovementPlane, bool bMaintainMagnitude);
	static bool IsExceedingMaxSpeed(struct FVector& Velocity, float InMaxSpeed);
	static float TryMoveToSlideAlongSurface(class USceneComponent* UpdatedComponent, class UPrimitiveComponent* UpdatedPrimitive, class UMoverComponent* MoverComponent, struct FVector& Delta, float PctOfDeltaToMove, struct FQuat& Rotation, struct FVector& Normal, struct FHitResult* Hit, bool bHandleImpact, struct FMovementRecord* MoveRecord);
	static bool TrySafeMoveUpdatedComponent(class USceneComponent* UpdatedComponent, class UPrimitiveComponent* UpdatedPrimitive, struct FVector& Delta, struct FQuat& NewRotation, bool bSweep, struct FHitResult* OutHit, ETeleportType Teleport, struct FMovementRecord* MoveRecord);
...
public:
	...
	uint8                                         Pad_3750[0x18];                                    // 0x0080(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3751[0x8];                                     // 0x0030(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3752[0x8];                                     // 0x0080(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3753[0x4];                                     // 0x0094(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3754[0x8];                                     // 0x0050(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3755[0x8];                                     // 0x00F8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3756[0x4];                                     // 0x0104(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3757[0x8];                                     // 0x0058(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3758[0x4];                                     // 0x0084(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3759[0x20];                                    // 0x0030(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
