...
public:
	...
	uint8                                         Pad_31FE[0x8];                                     // 0x0088(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	static struct FConversationTaskResult AbortConversation(struct FConversationContext& Context);
	...
	static bool CanConversationContinue(struct FConversationTaskResult& ConversationTasResult);
...
public:
	...
	uint8                                         Pad_3203[0x4];                                     // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3204[0x4];                                     // 0x006C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3205[0x28];                                    // 0x0028(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3206[0x138];                                   // 0x0068(0x0138)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	static class UConversationInstance* StartConversation(struct FGameplayTag& ConversationEntryTag, class AActor* Instigator, struct FGameplayTag& InstigatorTag, class AActor* Target, struct FGameplayTag& TargetTag, TSubclassOf<class UConversationInstance> ConversationInstanceClass);
	static class UConversationInstance* StartConversationFromGraph(struct FGameplayTag& ConversationEntryTag, class AActor* Instigator, struct FGameplayTag& InstigatorTag, class AActor* Target, struct FGameplayTag& TargetTag, class UConversationDatabase* Graph);
...
public:
	...
	uint8                                         Pad_320D[0x7];                                     // 0x0079(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void GatherStaticExtraData(struct FConversationContext& Context, TArray<struct FConversationNodeParameterPair>* InOutExtraData) const;
...
public:
	...
	uint8                                         Pad_3210[0x4];                                     // 0x0084(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3211[0x60];                                    // 0x00A0(0x0060)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3212[0x4];                                     // 0x0104(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3213[0x8];                                     // 0x0188(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void ClientExecuteTaskAndSideEffects(const struct FConversationNodeHandle& Handle, class UConversationDatabase* Graph);
	...
	class AActor* GetParticipantActor(struct FGameplayTag& ParticipantTag) const;
...
{
public:
	uint8                                         Pad_3215[0x8];                                     // 0x0030(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3216[0x160];                                   // 0x0098(0x0160)(Fixing Struct Size After Last Property [ Dumper-7 ])
