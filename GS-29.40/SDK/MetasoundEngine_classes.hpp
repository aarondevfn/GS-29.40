...
{
public:
	static struct FMetasoundFrontendLiteral CreateBoolArrayMetaSoundLiteral(TArray<bool>& Value);
	static struct FMetasoundFrontendLiteral CreateBoolMetaSoundLiteral(bool Value);
	static struct FMetasoundFrontendLiteral CreateFloatArrayMetaSoundLiteral(TArray<float>& Value);
	static struct FMetasoundFrontendLiteral CreateFloatMetaSoundLiteral(float Value);
	static struct FMetasoundFrontendLiteral CreateIntArrayMetaSoundLiteral(TArray<int32>& Value);
	static struct FMetasoundFrontendLiteral CreateIntMetaSoundLiteral(int32 Value);
	static struct FMetasoundFrontendLiteral CreateMetaSoundLiteralFromParam(struct FAudioParameter& Param);
	static struct FMetasoundFrontendLiteral CreateObjectArrayMetaSoundLiteral(TArray<class UObject*>& Value);
	static struct FMetasoundFrontendLiteral CreateObjectMetaSoundLiteral(class UObject* Value);
	static struct FMetasoundFrontendLiteral CreateStringArrayMetaSoundLiteral(TArray<class FString>& Value);
...
{
public:
	uint8                                         Pad_3347[0x88];                                    // 0x0028(0x0088)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_334A[0x40];                                    // 0x0030(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	static double GetTimeSeconds(struct FMetaSoundOutput& Output, bool* Success);
...
public:
	...
	uint8                                         Pad_3358[0x7];                                     // 0x0031(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_335A[0x4];                                     // 0x0074(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_335B[0x30];                                    // 0x0028(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_335C[0x8];                                     // 0x0318(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_335D[0x8];                                     // 0x0030(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_335E[0x198];                                   // 0x0048(0x0198)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_335F[0x8];                                     // 0x0060(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	struct FMetaSoundNodeHandle AddNodeByClassName(struct FMetasoundFrontendClassName& ClassName, EMetaSoundBuilderResult* OutResult, int32 MajorVersion);
	...
	bool GetNodeInputIsConstructorPin(struct FMetaSoundBuilderNodeInputHandle& InputHandle) const;
	bool GetNodeOutputIsConstructorPin(struct FMetaSoundBuilderNodeOutputHandle& OutputHandle) const;
...
{
public:
	uint8                                         Pad_3395[0x18];                                    // 0x0068(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3397[0x8];                                     // 0x0030(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_33AF[0x30];                                    // 0x0470(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_33B0[0x3];                                     // 0x0751(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_33B1[0xFC];                                    // 0x0764(0x00FC)(Fixing Struct Size After Last Property [ Dumper-7 ])
