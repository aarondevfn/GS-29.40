...
int32 UNiagaraDataChannelLibrary::GetDataChannelElementCount(class UObject* WorldContextObject, class UNiagaraDataChannelAsset* Channel, const struct FNiagaraDataChannelSearchParameters& SearchParams, bool bReadPreviousFrame)
{
	static class UFunction* Func = nullptr;
...
void UNiagaraDataChannelLibrary::ReadFromNiagaraDataChannelSingle(class UObject* WorldContextObject, class UNiagaraDataChannelAsset* Channel, int32 Param_Index, const struct FNiagaraDataChannelSearchParameters& SearchParams, bool bReadPreviousFrame, ENiagartaDataChannelReadResult* ReadResult)
{
	static class UFunction* Func = nullptr;
...
void UNiagaraDataChannelLibrary::WriteToNiagaraDataChannelSingle(class UObject* WorldContextObject, class UNiagaraDataChannelAsset* Channel, const struct FNiagaraDataChannelSearchParameters& SearchParams, bool bVisibleToBlueprint, bool bVisibleToNiagaraCPU, bool bVisibleToNiagaraGPU)
{
	static class UFunction* Func = nullptr;
...
void UNiagaraDataInterfaceArrayFunctionLibrary::SetNiagaraArrayMatrixValue(class UNiagaraComponent* NiagaraSystem, class FName OverrideName, int32 Param_Index, struct FMatrix& Value, bool bSizeToFit, bool bApplyLWCRebase)
{
	static class UFunction* Func = nullptr;
