...
void ADelMarAIController::HandleGroundedStateChanged(TScriptInterface<class IDelMarVehicleInterface>& VehicleRef, bool bValue)
{
	static class UFunction* Func = nullptr;
...
void UDelMarBTService_FindDriveGoal::HandleVehicleAnyWheelsOnGroundStateChanged(TScriptInterface<class IDelMarVehicleInterface>& VehicleRef, bool bAnyWheelsOnGround)
{
	static class UFunction* Func = nullptr;
...
void UDelMarBTTask_DriveTrack::HandleVehicleAnyWheelsOnGroundStateChanged(TScriptInterface<class IDelMarVehicleInterface>& VehicleRef, bool bAnyWheelsOnGround)
{
	static class UFunction* Func = nullptr;
...
void ADelMarRaceManager::NetMulticast_ResetRun(class AFortPlayerState* InPlayerState, bool bPlayerTriggered)
{
	static class UFunction* Func = nullptr;
...
bool ADelMarRaceManager::IsActiveRacer(class AFortPlayerState* PlayerState) const
{
	static class UFunction* Func = nullptr;
...
bool ADelMarRaceManager::IsSpectator(class AFortPlayerState* PlayerState) const
{
	static class UFunction* Func = nullptr;
...
void ADelMarChallengeRaceManager::NetMulticast_StartOvertime(double RaceFinishTimestamp)
{
	static class UFunction* Func = nullptr;
...
void ADelMarCompetitiveRaceManager::HandleFinalRacePositionsUpdated(TArray<struct FDelMarFinalRacePositionEntry>& FinalRacePositions, struct FDelMarEvent_RunRecorded& RecordedRun)
{
	static class UFunction* Func = nullptr;
...
void UDelMarConnectedHintComponent::PassNuxHintTypeToConnectedHintComponent(struct FGameplayTag& HintTypeTag)
{
	static class UFunction* Func = nullptr;
...
void UDelMarCoreSplineMeshComponent::OnBeginActorOverlap(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult)
{
	static class UFunction* Func = nullptr;
...
void ADelMarGhostPlaybackTrigger::BP_HandlePlaybackCompleted(struct FVector& Location)
{
	static class UFunction* Func = nullptr;
...
void ADelMarGhostPlaybackTrigger::OnBeginOverlap(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult)
{
	static class UFunction* Func = nullptr;
...
void UDelMarGlobalLeaderboardControllerComponent::ClientNewPersonalBest(struct FDelMarEvent_GlobalLeaderboardNewPersonalBest& PersonalBestEvent)
{
	static class UFunction* Func = nullptr;
...
void UDelMarGlobalLeaderboardControllerComponent::ServerNewPersonalBest(struct FDelMarEvent_GlobalLeaderboardNewPersonalBest& PersonalBestRetrievedEvent)
{
	static class UFunction* Func = nullptr;
...
void ADelMarGuidedTutorialZoneActor::OnBeginOverlap(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult)
{
	static class UFunction* Func = nullptr;
...
void ADelMarInputModifierHazard::OnBeginOverlap(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult)
{
	static class UFunction* Func = nullptr;
...
void UDelMarVehicleMovementSet::OnRep_AccelMultiplier(struct FFortGameplayAttributeData& OldSpeedMultiplier)
{
	static class UFunction* Func = nullptr;
...
void UDelMarVehicleMovementSet::OnRep_BonusSpeed(struct FFortGameplayAttributeData& OldBonusSpeed)
{
	static class UFunction* Func = nullptr;
...
void UDelMarVehicleMovementSet::OnRep_VehicleThrottleDisabled(struct FFortGameplayAttributeData& OldInputDisabled)
{
	static class UFunction* Func = nullptr;
...
void UDelMarPlayerRaceDataComponent::NetMulticast_CheckpointPassed_ParallelPath(struct FDelMarEvent_CheckpointPassed_ParallelPath& CheckpointEvent)
{
	static class UFunction* Func = nullptr;
...
void UDelMarPlayerRaceDataComponent::NetMulticast_CheckpointPassedOutOfOrder_ParallelPath(struct FDelMarEvent_CheckpointPassedOutOfOrder_ParallelPath& InCheckpointPassedOutOfOrderEvent)
{
	static class UFunction* Func = nullptr;
...
void UDelMarPlayerRaceDataComponent::NetMulticast_LapCompleted(struct FDelMarEvent_LapComplete& InLapEvent)
{
	static class UFunction* Func = nullptr;
...
void UDelMarPlayerRaceDataComponent::NetMulticast_RaceCompleted(double RunTime, bool bValidRun)
{
	static class UFunction* Func = nullptr;
...
void UDelMarPlayerRaceDataComponent::NetMulticast_SectionCompleted_ParallelPath(struct FDelMarEvent_SectionComplete_ParallelPath& InSectionEvent)
{
	static class UFunction* Func = nullptr;
...
void UDelMarPlayerRaceDataComponent::NetMulticast_TeleportEntered(struct FDelMarEvent_TeleportEnteredEvent& InCheckpointTeleportingEvent)
{
	static class UFunction* Func = nullptr;
...
void UDelMarProxyGhostVisualComponent::HandlePartCustomizationUpdated(int32 MeshPartIndex)
{
	static class UFunction* Func = nullptr;
...
void UDelMarRaceManagerVerbComponent::HandleFinalRacePositionsChanged(TArray<struct FDelMarFinalRacePositionEntry>& FinalRacePositions, struct FDelMarEvent_RunRecorded& RecordedRun)
{
	static class UFunction* Func = nullptr;
...
void UDelMarRaceManagerVerbComponent::HandlePlayerLapCompleted(struct FDelMarEvent_LapComplete& LapCompleteEvent)
{
	static class UFunction* Func = nullptr;
...
void UDelMarRaceManagerVerbComponent::HandlePlayerPositionsChanged(TArray<class AFortPlayerState*>& RacePositions)
{
	static class UFunction* Func = nullptr;
...
void ADelMarSpeedUpDevice::OnBeginOverlap(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult)
{
	static class UFunction* Func = nullptr;
...
void ADelMarTutorialTriggerActor::HandleColliderOverlap(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult)
{
	static class UFunction* Func = nullptr;
...
void UDelMarVehicleManager::BP_GetVehiclesInRange(struct FVector& SourcePosition, float Range, bool bDo2DCheck, TArray<class ADelMarVehicle*>* OutVehicles)
{
	static class UFunction* Func = nullptr;
...
void UDelMarVehicleManager::HandlePawnEnteredVehicle(TScriptInterface<class IFortVehicleInterface>& Vehicle, class AFortPawn* Pawn, int32 SeatIndex)
{
	static class UFunction* Func = nullptr;
...
void UDelMarVehicleManager::HandlePawnExitedVehicle(TScriptInterface<class IFortVehicleInterface>& Vehicle, class AFortPawn* Pawn, int32 SeatIndex)
{
	static class UFunction* Func = nullptr;
...
void ADelMarVehicle::AddTargetSpeedAdjustment(class FName& Source, float Value)
{
	static class UFunction* Func = nullptr;
...
void ADelMarVehicle::AddWorldBonusSpeedStack(struct FDelMarWorldBonusSpeedStack& BonusSpeedStack)
{
	static class UFunction* Func = nullptr;
...
void ADelMarVehicle::ServerAddReplicatedGameplayTag(struct FGameplayTag& InTag)
{
	static class UFunction* Func = nullptr;
...
void ADelMarVehicle::ServerAddReplicatedGameplayTags(struct FGameplayTagContainer& InTags)
{
	static class UFunction* Func = nullptr;
...
// Function DelMarCore.DelMarVehicle.ServerOnAppliedTeleportLocation
// (Net, NetReliable, Native, Event, Protected, NetServer)

void ADelMarVehicle::ServerOnAppliedTeleportLocation()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DelMarVehicle", "ServerOnAppliedTeleportLocation");
...
// Function DelMarCore.DelMarVehicle.ServerOnAppliedTeleportRotation
// (Net, NetReliable, Native, Event, Protected, NetServer)

void ADelMarVehicle::ServerOnAppliedTeleportRotation()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DelMarVehicle", "ServerOnAppliedTeleportRotation");
...
void ADelMarVehicle::ServerRemoveReplicatedGameplayTag(struct FGameplayTag& InTag)
{
	static class UFunction* Func = nullptr;
...
void ADelMarVehicle::ServerRemoveReplicatedGameplayTags(struct FGameplayTagContainer& InTags)
{
	static class UFunction* Func = nullptr;
...
void ADelMarVehicle::SetTeleportRotation(struct FRotator& DestRotation)
{
	static class UFunction* Func = nullptr;
...
bool ADelMarVehicle::VehicleHasTag(struct FGameplayTag& InTag) const
{
	static class UFunction* Func = nullptr;
...
void UDelMarVehicleNetworkPhysicsComponent::OnRep_ReplicatedState(struct FDelMarVehicleReplicatedState& PrevReplicatedState)
{
	static class UFunction* Func = nullptr;
...
void UDelMarVehicleStateTagManagerComponent::HandleAnyWheelsOnGroundChanged(TScriptInterface<class IDelMarVehicleInterface>& Vehicle, bool bWheelsOnGround)
{
	static class UFunction* Func = nullptr;
...
void UDelMarVehicleVerbComponent::HandleAnyWheelsOnGroundChanged(TScriptInterface<class IDelMarVehicleInterface>& Vehicle, bool bWheelsOnGround)
{
	static class UFunction* Func = nullptr;
...
class UAudioComponent* ADelMarAudioController::PlaySound(class USoundBase* Sound, float InFadeInTime, float InTargetVolume, bool bDisableAttenuation, EAudioFaderCurve InFadeCurve)
{
	static class UFunction* Func = nullptr;
...
void UDelMarAudioMixModifierExtension::AddMixGroup(struct FAudioMixModifierGroup& InMixModifier)
{
	static class UFunction* Func = nullptr;
...
void UDelMarAudioMixModifierExtension::RemoveMixGroup(struct FAudioMixModifierGroup& InMixModifier)
{
	static class UFunction* Func = nullptr;
...
void UDelMarAudioMixModifierExtension::RemoveMixGroupByName(class FName InName)
{
	static class UFunction* Func = nullptr;
...
void UDelMarSubmixSendExtension::SetSend(class USoundSubmixBase* InSubmix, float InLevel, bool bTrackCount)
{
	static class UFunction* Func = nullptr;
...
int32 UDelMarNuxBlueprintFunctionLibrary::GetCurrentLapNumber(class ADelMarVehicle* Vehicle)
{
	static class UFunction* Func = nullptr;
...
struct FDelMarRankedInfo UDelMarNuxBlueprintFunctionLibrary::GetCurrentRankedInfoForVehicle(class ADelMarVehicle* Vehicle)
{
	static class UFunction* Func = nullptr;
...
void ADelMarCheckpoint::HandlePawnEnteredVehicle(TScriptInterface<class IFortVehicleInterface>& Vehicle, class AFortPawn* Pawn, int32 SeatIndex)
{
	static class UFunction* Func = nullptr;
...
const struct FCheckpointTrackDistance ADelMarCheckpoint::GetTrackDistanceDataForTrack(class ADelMarTrackBase* InTrack, bool bEnsureAssociated) const
{
	static class UFunction* Func = nullptr;
...
bool ADelMarCheckpoint::IsAssociatedWithTrack(class ADelMarTrackBase* InTrack) const
{
	static class UFunction* Func = nullptr;
...
bool UDelMarBlueprintLibrary::BP_KillAndRespawnVehicle(class AController* Controller, const struct FGameplayTag& CausedByTag)
{
	static class UFunction* Func = nullptr;
...
class FText UDelMarBlueprintLibrary::DelMarFormatTime(double TimeSeconds, bool bIncludeMilliseconds)
{
	static class UFunction* Func = nullptr;
...
double UDelMarBlueprintLibrary::GetClientWorldTimeSeconds(class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
...
class ADelMarPlayspace* UDelMarBlueprintLibrary::GetDelMarPlayspace(class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
...
class ADelMarVehicle* UDelMarBlueprintLibrary::GetDelMarVehicle(class APlayerController* PlayerController)
{
	static class UFunction* Func = nullptr;
...
EDelMarNetModel UDelMarBlueprintLibrary::GetNetModel(class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
...
class AFortPlayerController* UDelMarBlueprintLibrary::GetPrimaryPlayerController(class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
...
class AFortPlayerState* UDelMarBlueprintLibrary::GetPrimaryPlayerState(class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
...
double UDelMarBlueprintLibrary::GetTimerDeltaFromServerTime(double TimestampSeconds, EDelMarTimerDirection Direction, bool bCapAtZero, bool* bIsPositive, class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
...
void UDelMarBlueprintLibrary::SetDelMarControlsText(class APlayerController* PlayerController, struct FDelMarEvent_SetControlsText& Event)
{
	static class UFunction* Func = nullptr;
...
void UDelMarBlueprintLibrary::SetDelMarTutorialHint(class APlayerController* PlayerController, struct FDelMarEvent_SetTutorialHint& Event)
{
	static class UFunction* Func = nullptr;
...
void UDelMarCheatManager::DelMarForceLoadLevel(class FString& LevelName)
{
	static class UFunction* Func = nullptr;
...
void UDelMarCheatManager::DelMarGiveSelfSomeCompetitiveMMRStats(int32 MyPosition, int32 TotalNumberOfPlayers, int32 NumberOfTimesToSendMMRUpdate)
{
	static class UFunction* Func = nullptr;
...
void UDelMarCheatManager::DelMarGrantTurboCharges(float Amount, bool bGrantToEveryone)
{
	static class UFunction* Func = nullptr;
...
void UDelMarCheatManager::DelMarSetDemoModeEnabled(bool bEnabled)
{
	static class UFunction* Func = nullptr;
...
void UDelMarCheatManager::DelMarSetGlobalInputEnabled(const class FString& InputTag, bool bEnableInput)
{
	static class UFunction* Func = nullptr;
...
void UDelMarCheatManager::DelMarSetInputMappingContextEnabled(const class FString& InputTag, bool bEnableInput)
{
	static class UFunction* Func = nullptr;
...
void UDelMarCheatManager::DelMarSetReplicatedTagEnabledOnSelf(const class FString& InputTag, bool bEnabled)
{
	static class UFunction* Func = nullptr;
...
void UDelMarCheatManager::DelMarSetTurboCharges(float Amount, bool bGrantToEveryone)
{
	static class UFunction* Func = nullptr;
...
void UDelMarCheatManager::DelMarSetTutorialSection(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
void UDelMarCheatManager::DelMarTeleportToNextCheckpoint_ParallelPath(int32 ParallelPathIndex)
{
	static class UFunction* Func = nullptr;
...
void UDelMarCheatManager::DelMarTeleportToPreviousCheckpoint_ParallelPath(int32 ParallelPathIndex)
{
	static class UFunction* Func = nullptr;
...
void ADelMarTimeDelayedStateSequencer::SetEnabled(bool bEnabled)
{
	static class UFunction* Func = nullptr;
...
struct FGameplayTag ADelMarTimeDelayedStateSequencer::GetStateTagAtIndex(int32 Param_Index) const
{
	static class UFunction* Func = nullptr;
...
void UDelMarGlobalInputDisabler::SetGlobalInputsEnabled(const struct FGameplayTagContainer& InputTags, bool bEnable)
{
	static class UFunction* Func = nullptr;
...
void ADelMarCosmeticActor::BP_OnAnyWheelsOnGroundChanged(TScriptInterface<class IDelMarVehicleInterface>& VehicleRef, bool bValue)
{
	static class UFunction* Func = nullptr;
...
void ADelMarCosmeticActor::BP_OnWheelsOnGroundChanged(TScriptInterface<class IDelMarVehicleInterface>& VehicleRef, bool bValue)
{
	static class UFunction* Func = nullptr;
...
void UDelMarMatchmakingComponent::ClientStartMatchmaking(struct FOnlineLinkId& LinkId)
{
	static class UFunction* Func = nullptr;
...
void UDelMarLocalCheckpointVisibilityControllerComponent::HandleCheckpointPassed(struct FDelMarEvent_CheckpointPassed_ParallelPath& CheckpointEvent)
{
	static class UFunction* Func = nullptr;
...
void UDelMarLocalCheckpointVisibilityControllerComponent::HandleLapComplete(struct FDelMarEvent_LapComplete& LapEvent)
{
	static class UFunction* Func = nullptr;
...
void UDelMarNetworkInputComponent::ServerSendInputs(struct FDelMarNetworkInputPacket& InputPacket)
{
	static class UFunction* Func = nullptr;
...
void UDelMarPlayerPreferencesComponent::ServerUpdateAerialPitchActivation(bool bInAerialPitchActivationEnabled)
{
	static class UFunction* Func = nullptr;
...
void UDelMarPlayerPreferencesComponent::ServerUpdatePitchInverted(bool bInPitchInverted)
{
	static class UFunction* Func = nullptr;
...
void UDelMarPlayerPreferencesComponent::ServerUpdateVerticalKickflipInverted(bool bInVerticalKickflipInverted)
{
	static class UFunction* Func = nullptr;
...
void UDelMarRequestComponent::HandleLoadoutsChangedOnServer(struct FCosmeticLoadout& CosmeticLoadout)
{
	static class UFunction* Func = nullptr;
...
void UDelMarRunRecordPlayerComponent::PrintRecords(struct FDelMarRunRecord& RunRecord, const class FString& Param_Name)
{
	static class UFunction* Func = nullptr;
...
void UDelMarRunRecordPlayerComponent::NetMulticast_LapRecorded(struct FDelMarEvent_LapRecorded& InLapRecordedEvent)
{
	static class UFunction* Func = nullptr;
...
void UDelMarRunRecordPlayerComponent::NetMulticast_RunRecorded(struct FDelMarEvent_RunRecorded& InRunRecordedEvent)
{
	static class UFunction* Func = nullptr;
...
void UDelMarRunRecordPlayerComponent::NetMulticast_SectionRecorded(struct FDelMarEvent_SectionRecorded& InSectionRecordedEvent)
{
	static class UFunction* Func = nullptr;
...
void UDelMarTutorialRequestComponent::Server_RequestStartRace(bool bSkipCountdown)
{
	static class UFunction* Func = nullptr;
...
void UDelMarLevelManagerComponent::RequestLevelLoad(struct FGameplayTagContainer& DesiredMap)
{
	static class UFunction* Func = nullptr;
...
void UDelMarLevelManagerComponent::ServerRequestLevel(struct FGameplayTagContainer& DesiredMap)
{
	static class UFunction* Func = nullptr;
...
void ADelMarPlayspace::ServerRequestLoadingLevel(struct FGameplayTagContainer& DesiredMap)
{
	static class UFunction* Func = nullptr;
...
void ADelMarPlayspace::ServerRequestLoadingLevelWithLinkCode(struct FOnlineLinkId& DesiredMap)
{
	static class UFunction* Func = nullptr;
...
void ADelMarPlayspace::ServerReturnToSetup(struct FGameplayTagContainer& OptionalMapToForceLoad)
{
	static class UFunction* Func = nullptr;
...
void ADelMarPlayspace::ServerReturnToSetupWithLinkCode(struct FOnlineLinkId& OptionalMapToForceLoad)
{
	static class UFunction* Func = nullptr;
...
void UDelMarCheckpointManagerComponent::HandleRaceFinished(struct FDelMarEvent_RaceFinished& Event)
{
	static class UFunction* Func = nullptr;
...
void UDelMarCheckpointManagerComponent::HandleResetRace(struct FDelMarEvent_ResetRace& Event)
{
	static class UFunction* Func = nullptr;
...
int32 ADelMarDeathRaceManager::GetPointsAwardForPlacement(int32 InPlacement) const
{
	static class UFunction* Func = nullptr;
...
void UDelMarRaceConfigComponent::OnRep_VehicleAbilityConfig(struct FDelMarVehicleAbilityConfig& OldConfig)
{
	static class UFunction* Func = nullptr;
