...
void ABuildingGameplayActorLaserGrid::CosmeticDestroyOutletInstance(struct FLaserGridOutletEntry& OutletEntry)
{
...
void ABuildingGameplayActorLaserGrid::HandleLaserCollisionOverlap(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult)
{
	static class UFunction* Func = nullptr;
...
void ABuildingGameplayActorLaserGrid::LaserGridTriggered(struct FLaserGridConnectionEntry& LaserConnectionData, class AActor* TriggeringActor)
{
	static class UFunction* Func = nullptr;
...
void ABuildingGameplayActorLaserGrid::SetLaserGridEnable(bool bEnable)
{
	static class UFunction* Func = nullptr;
...
bool ABuildingGameplayActorLaserGrid::CanActorTriggerLaserGrid(class AActor* TriggeringActor) const
{
	static class UFunction* Func = nullptr;
