...
void UHijackerComponent::EjectHijacker(class AActor* DamageCauser, float Damage, struct FVector& EventLocation)
{
	static class UFunction* Func = nullptr;
...
bool UHijackerComponent::TryHijack(class AActor* VehicleTarget, struct FInteractionType& InteractionType)
{
	static class UFunction* Func = nullptr;
...
void UHijackerComponent::BP_GetThrownVelocity(class AActor* DamageCauser, float Damage, struct FVector& EventLocation, struct FVector* OutVelocity) const
{
	static class UFunction* Func = nullptr;
...
void URappellingComponent::OnCapsuleHit(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, struct FVector& NormalImpulse, struct FHitResult& Hit)
{
	static class UFunction* Func = nullptr;
...
void URappellingComponent::StartRappelling_Server(struct FVector& NewGravityDirection, struct FVector& ClientRappellingEdge, struct FVector& ClientRappellingNormal)
{
	static class UFunction* Func = nullptr;
