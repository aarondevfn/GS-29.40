...
public:
	...
	uint8                                         Pad_9A46[0x7];                                     // 0x02B1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	bool BindToOnOtherActorBeginOverlap(TDelegate<void(class AActor* OtherActor)>& InEvent);
	bool BindToOnOtherActorEndOverlap(TDelegate<void(class AActor* OtherActor)>& InEvent);
	...
	void SetRelativeScale3DForBoundsComponent(struct FVector& Scale3D);
	bool SetStaticMeshForBoundsComponent(class UStaticMesh* NewMesh);
	void UnBindFromOnOtherActorBeginOverlap(TDelegate<void(class AActor* OtherActor)>& InEvent);
	void UnBindFromOnOtherActorEndOverlap(TDelegate<void(class AActor* OtherActor)>& InEvent);
	void UpdateOverLapShape(EFNEVolumeShapeTypeEnum EShape, bool bUseCustomShape, class UStaticMesh* CustomShape);
...
public:
	...
	uint8                                         Pad_9A4B[0x7];                                     // 0x0601(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9A4C[0x7];                                     // 0x0659(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9A4D[0x20];                                    // 0x0670(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9A4E[0x8];                                     // 0x06E8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void SetEnableOverlapBehavior(EVolumeEnableOverlapBehavior InOverlapBehavior);
	void SetRelativeScale3DForBoundsComponent(struct FVector& Scale3D);
	bool SetStaticMeshForBoundsComponent(class UStaticMesh* NewMesh);
