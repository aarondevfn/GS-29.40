...
void UEncounterMobManagerComponent::OnMobActorSpawn(class AActor* SpawnedActor, class UFortAthenaLivingWorldEventData* EventData)
{
	static class UFunction* Func = nullptr;
...
void ULWMEncounterInstance::OnMobActorSpawn(class AActor* SpawnedActor, class UFortAthenaLivingWorldEventData* EventData)
{
	static class UFunction* Func = nullptr;
...
class UEncounterMobManagerComponent* UEncounterBlueprintLibrary::GetRelevantMobManagerComponentForActor(class AActor* Actor)
{
	static class UFunction* Func = nullptr;
...
void UEncounterManagerComponent::SetPersistentValue(struct FGameplayTag& Identifier, int32 Value)
{
	static class UFunction* Func = nullptr;
...
int32 UEncounterManagerComponent::GetPersistentValue(struct FGameplayTag& Identifier) const
{
	static class UFunction* Func = nullptr;
...
TSoftClassPtr<class UClass> UEncounterManagerComponent::GetVariable_ActorClass(struct FGameplayTag& VarName) const
{
	static class UFunction* Func = nullptr;
...
const TArray<struct FFortAthenaLivingWorldEventDataActorSpawnDescription> UEncounterManagerComponent::GetVariable_ActorDescription(struct FGameplayTag& VarName) const
{
	static class UFunction* Func = nullptr;
...
bool UEncounterManagerComponent::GetVariable_Bool(struct FGameplayTag& VarName) const
{
	static class UFunction* Func = nullptr;
...
float UEncounterManagerComponent::GetVariable_Float(struct FGameplayTag& VarName) const
{
	static class UFunction* Func = nullptr;
...
struct FGameplayTag UEncounterManagerComponent::GetVariable_GameplayTag(struct FGameplayTag& VarName) const
{
	static class UFunction* Func = nullptr;
...
struct FGameplayTagContainer UEncounterManagerComponent::GetVariable_GameplayTagContainer(struct FGameplayTag& VarName) const
{
	static class UFunction* Func = nullptr;
...
int32 UEncounterManagerComponent::GetVariable_Int(struct FGameplayTag& VarName) const
{
	static class UFunction* Func = nullptr;
...
const class UFortWorldItemDefinition* UEncounterManagerComponent::GetVariable_ItemDefinition(struct FGameplayTag& VarName) const
{
	static class UFunction* Func = nullptr;
...
const class UFortAthenaLivingWorldEncounter* UEncounterManagerComponent::GetVariable_LWMEncounter(struct FGameplayTag& VarName) const
{
	static class UFunction* Func = nullptr;
...
struct FGameplayTagQuery UEncounterManagerComponent::GetVariable_TagQuery(struct FGameplayTag& VarName) const
{
	static class UFunction* Func = nullptr;
