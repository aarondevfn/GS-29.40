...
public:
	...
	uint8                                         Pad_7092[0x4];                                     // 0x0034(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_7097[0x4];                                     // 0x002C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_709F[0x8];                                     // 0x0030(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<int32, class UObject*>                   TweenContexts;                                     // 0x0038(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_70A0[0x60];                                    // 0x0088(0x0060)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_70AB[0x40];                                    // 0x0050(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	static void BP_TranslationTo(int32* OutTweenId, class UObject* ContextObject, class UWidget* Target, const struct FTweenOptionalVector2D& FromOptions, struct FVector2D& ToValue, bool bIsRelative, float Duration, const struct FTweenDelayOptions& DelayOptions, ETweenBuiltInEasing EasingFunction, class UCurveFloat* EasingCurve, const struct FTweenLoopOptions& LoopOptions, bool bAutoPlay, bool bAutoKill);
