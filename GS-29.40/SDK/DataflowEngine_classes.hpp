...
{
public:
	uint8                                         Pad_1A11[0x20];                                    // 0x0028(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1A12[0x20];                                    // 0x0060(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1A13[0x10];                                    // 0x0098(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1A14[0x20];                                    // 0x0098(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1A15[0x7];                                     // 0x00B9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1A16[0x28];                                    // 0x0060(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1A17[0x7];                                     // 0x0089(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
