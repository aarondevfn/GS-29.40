...
bool UEpicStreamMediaSource::ShouldStreamBePlaying(class UObject* WorldContextObject, class UPrimitiveComponent* PrimitiveComponent, float CullRadius) const
{
	static class UFunction* Func = nullptr;
