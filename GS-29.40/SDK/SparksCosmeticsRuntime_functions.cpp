...
void USparksAccountItemDefinition::GetVariantChannelOptionNames(const struct FGameplayTag& ChannelTag, class FText* OutChannelName, TArray<class FString>* OutNames) const
{
	...
	if (OutChannelName != nullptr)
		*OutChannelName = Parms.OutChannelName;
...
class USparksCosmeticCatalog* USparksCosmeticCatalog::GetSparksCosmeticCatalog(class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
...
class USparksAccountItemDefinition* USparksCosmeticCatalog::GetItemDefFromAssetID(struct FPrimaryAssetId& AssetId)
{
	static class UFunction* Func = nullptr;
...
class FName USparksCosmeticComponent::GetEquippedJamSongShortnameForIndex(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
class FString USparksCosmeticComponent::GetEquippedJamSongUIDForIndex(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
class FName USparksCosmeticComponent::GetOwnedJamSongShortnameForIndex(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
class UFXSystemAsset* USparksInstrumentItemDefBase::GetAuxFXSystem(struct FSparksVariantChoices& Choices) const
{
	static class UFunction* Func = nullptr;
...
class UMaterialInstance* USparksInstrumentItemDefBase::GetAuxiliaryMaterial(struct FSparksVariantChoices& Choices) const
{
	static class UFunction* Func = nullptr;
...
class UMaterialInstance* USparksInstrumentItemDefBase::GetAuxiliaryMaterial2(struct FSparksVariantChoices& Choices) const
{
	static class UFunction* Func = nullptr;
...
class USkeletalMesh* USparksInstrumentItemDefBase::GetAuxiliaryMesh(struct FSparksVariantChoices& Choices) const
{
	static class UFunction* Func = nullptr;
...
class UMaterialInstance* USparksInstrumentItemDefBase::GetLeftHandMaterial(struct FSparksVariantChoices& Choices) const
{
	static class UFunction* Func = nullptr;
...
class USkeletalMesh* USparksInstrumentItemDefBase::GetLeftHandMesh(struct FSparksVariantChoices& Choices) const
{
	static class UFunction* Func = nullptr;
...
class UFXSystemAsset* USparksInstrumentItemDefBase::GetLHFXSystem(struct FSparksVariantChoices& Choices) const
{
	static class UFunction* Func = nullptr;
...
class UFXSystemAsset* USparksInstrumentItemDefBase::GetMainFXSystem(struct FSparksVariantChoices& Choices) const
{
	static class UFunction* Func = nullptr;
...
class UMaterialInstance* USparksInstrumentItemDefBase::GetMaterial(struct FSparksVariantChoices& Choices) const
{
	static class UFunction* Func = nullptr;
...
class USkeletalMesh* USparksInstrumentItemDefBase::GetMesh(struct FSparksVariantChoices& Choices) const
{
	static class UFunction* Func = nullptr;
...
const class UCatalogData* USparksJamEmoteItemDefinition::GetJamSongMetaData(class UObject* WorldContextObject) const
{
	static class UFunction* Func = nullptr;
...
class FName USparksJamEmoteItemDefinition::GetJamSongShortName(class UObject* WorldContextObject) const
{
	static class UFunction* Func = nullptr;
...
bool USparksJamEmoteItemDefinition::IsJamLoopEnabled(class AFortPlayerController* PlayerController) const
{
	static class UFunction* Func = nullptr;
