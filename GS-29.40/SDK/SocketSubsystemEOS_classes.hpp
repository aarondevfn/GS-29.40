...
{
public:
	uint8                                         Pad_2A45[0x8];                                     // 0x1E90(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	bool                                          bIsPassthrough;                                    // 0x08F0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsUsingP2PSockets;                                // 0x08F1(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2A46[0x6];                                     // 0x08F2(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
