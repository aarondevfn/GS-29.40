...
void UFortContentGateRatingWidget::OnLabelUpdated(bool bLabelEnabled, class FText& LabelText, class FText& LabelNumber)
{
	static class UFunction* Func = nullptr;
...
void UFortContentGateRatingWidget::OnStyleUpdated(struct FSqueegeeStyleParams& StyleParams)
{
	static class UFunction* Func = nullptr;
...
void UFortContentManagementDetails::OnPreviewImageChanged(bool bIsLoading, class UTexture* Texture)
{
	static class UFunction* Func = nullptr;
...
void UFortContentManagementDetails::OnShowActivityData(class FText& ActivityDisplayName, class FText& ActivityDescription, const class FString& CreatorName, class FText& LinkCode, bool IsCreative, struct FDateTime& UnlockTime, class UFortGameActivity* GameActivity)
{
	static class UFunction* Func = nullptr;
	...
	Parms.ActivityDisplayName = ActivityDisplayName;
	Parms.ActivityDescription = ActivityDescription;
...
void UFortContentManagementButton::OnShowError(class FText& ErrorText)
{
	static class UFunction* Func = nullptr;
...
void UFortContentManagementButton::OnShowGameActivity(class UFortGameActivity* NewGameActivity)
{
	static class UFunction* Func = nullptr;
...
void UFortContentManagementLabelWidget::OnSetLabel(class FText& InText)
{
	static class UFunction* Func = nullptr;
