...
void UMovieSceneComponentMaterialParameterSection::AddColorParameterKey(struct FMaterialParameterInfo& InParameterInfo, const struct FFrameNumber& InTime, const struct FLinearColor& InValue, const class FString& InLayerName, const class FString& InAssetName)
{
	static class UFunction* Func = nullptr;
...
void UMovieSceneComponentMaterialParameterSection::AddScalarParameterKey(struct FMaterialParameterInfo& InParameterInfo, const struct FFrameNumber& InTime, float InValue, const class FString& InLayerName, const class FString& InAssetName)
{
	static class UFunction* Func = nullptr;
...
bool UMovieSceneComponentMaterialParameterSection::RemoveColorParameter(struct FMaterialParameterInfo& InParameterInfo)
{
	static class UFunction* Func = nullptr;
...
bool UMovieSceneComponentMaterialParameterSection::RemoveScalarParameter(struct FMaterialParameterInfo& InParameterInfo)
{
	static class UFunction* Func = nullptr;
