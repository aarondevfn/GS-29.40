...
public:
	...
	uint8                                         Pad_2B7D[0x64];                                    // 0x00E0(0x0064)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRandomStream                          SeededRNG;                                         // 0x0144(0x0008)(ZeroConstructor, Transient, NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2B7E[0x54];                                    // 0x014C(0x0054)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2B80[0x30];                                    // 0x00A0(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2B81[0x1D8];                                   // 0x0100(0x01D8)(Fixing Struct Size After Last Property [ Dumper-7 ])
