...
void AVehicleCosmeticsAudioController::BP_OnAudioDataLoaded(class USoundBase* Sound)
{
	static class UFunction* Func = nullptr;
...
void AVehicleCosmeticsAudioController::BP_OnUpdateAudioData(class UVehicleAudioCosmeticData* CosmeticData)
{
	static class UFunction* Func = nullptr;
...
void AVehicleCosmeticsAudioController::UpdateAudioData(class UVehicleAudioCosmeticData* CosmeticData)
{
	static class UFunction* Func = nullptr;
...
void UVehicleCosmeticsAudioManager::RegisterVehicleWithAsset(struct FVehicleCosmeticLoadRequestInfo& RequestInfo)
{
	static class UFunction* Func = nullptr;
