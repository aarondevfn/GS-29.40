...
bool UEpicMediaMetadataResolver::GetBlurl(const class FString& InVUID, bool bInBlurlLive, struct FEpicMediaOptions& InMediaOptions)
{
...
bool UEpicMediaMetadataResolver::GetData(const class FString& UID, bool bLive, struct FEpicMediaOptions& InMediaOptions)
{
	static class UFunction* Func = nullptr;
