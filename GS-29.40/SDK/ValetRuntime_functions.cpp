...
void AFortDagwoodVehicle::OnRep_FakeTires(TArray<ETireStates>& PrevTireStates)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class AFortValetAudioController*        Param_ValetAudio                                       (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void AFortDagwoodVehicle::SetValetAudioController(class AFortValetAudioController* Param_ValetAudio)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_ValetAudio = Param_ValetAudio;
