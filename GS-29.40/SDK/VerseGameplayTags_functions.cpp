...
bool IVerseGameplayTagAssetInterface::HasAllMatchingGameplayTags(struct FVerseGameplayTagContainer& TagContainer) const
{
	static class UFunction* Func = nullptr;
...
bool IVerseGameplayTagAssetInterface::HasAnyMatchingGameplayTags(struct FVerseGameplayTagContainer& TagContainer) const
{
	static class UFunction* Func = nullptr;
