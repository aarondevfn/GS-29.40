...
public:
	...
	uint8                                         Pad_8B23[0xF];                                     // 0x0029(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_8B24[0x58];                                    // 0x0030(0x0058)(Fixing Size After Last Property [ Dumper-7 ])
	...
	FMulticastInlineDelegateProperty_             OnSongCatalogRetrieved;                            // 0x0190(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	void GetSongList(ESongSortMethod SortMethod, ESongSortDirection SortDirection, struct FGameplayTagQuery& TagQuery, TArray<class UCatalogData*>& OutResults);
	void OnCalendarActiveEventsChanged(TArray<class FString>& ActiveEventFlags);
