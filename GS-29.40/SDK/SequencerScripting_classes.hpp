...
{
public:
	uint8                                         Pad_8241[0x18];                                    // 0x0028(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_8242[0x18];                                    // 0x0040(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void SetTime(struct FFrameNumber& NewFrameNumber, float SubFrame, EMovieSceneTimeUnit TimeUnit);
...
public:
	...
	uint8                                         Pad_8245[0x4];                                     // 0x002C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_8246[0x28];                                    // 0x0030(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	class UMovieSceneScriptingActorReferenceKey* AddKey(struct FFrameNumber& InTime, const struct FMovieSceneObjectBindingID& NewValue, float SubFrame, EMovieSceneTimeUnit TimeUnit);
	void RemoveDefault();
	...
	TArray<class UMovieSceneScriptingKey*> GetKeysByIndex(TArray<int32>& Indices) const;
...
{
public:
	uint8                                         Pad_8248[0x18];                                    // 0x0040(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_824B[0x28];                                    // 0x0030(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	class UMovieSceneScriptingBoolKey* AddKey(struct FFrameNumber& InTime, bool NewValue, float SubFrame, EMovieSceneTimeUnit TimeUnit);
	void RemoveDefault();
	void RemoveKey(class UMovieSceneScriptingKey* Key);
...
{
public:
	uint8                                         Pad_824F[0x18];                                    // 0x0040(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_8252[0x28];                                    // 0x0030(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	class UMovieSceneScriptingByteKey* AddKey(struct FFrameNumber& InTime, uint8 NewValue, float SubFrame, EMovieSceneTimeUnit TimeUnit, EMovieSceneKeyInterpolation InInterpolation);
	void RemoveDefault();
	void RemoveKey(class UMovieSceneScriptingKey* Key);
...
{
public:
	uint8                                         Pad_8255[0x18];                                    // 0x0040(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_8258[0x28];                                    // 0x0030(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	class UMovieSceneScriptingDoubleKey* AddKey(struct FFrameNumber& InTime, double NewValue, float SubFrame, EMovieSceneTimeUnit TimeUnit, EMovieSceneKeyInterpolation InInterpolation);
	void RemoveDefault();
	void RemoveKey(class UMovieSceneScriptingKey* Key);
...
{
public:
	uint8                                         Pad_825C[0x18];                                    // 0x0040(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_825F[0x28];                                    // 0x0030(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	class UMovieSceneScriptingEventKey* AddKey(struct FFrameNumber& InTime, const struct FMovieSceneEvent& NewValue, float SubFrame, EMovieSceneTimeUnit TimeUnit);
	void RemoveKey(class UMovieSceneScriptingKey* Key);
...
{
public:
	uint8                                         Pad_8264[0x18];                                    // 0x0040(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_8265[0x18];                                    // 0x0040(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_8266[0x40];                                    // 0x0030(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	class UMovieSceneScriptingFloatKey* AddKey(struct FFrameNumber& InTime, float NewValue, float SubFrame, EMovieSceneTimeUnit TimeUnit, EMovieSceneKeyInterpolation InInterpolation);
	void RemoveDefault();
	void RemoveKey(class UMovieSceneScriptingKey* Key);
...
{
public:
	uint8                                         Pad_8269[0x18];                                    // 0x0040(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_826C[0x28];                                    // 0x0030(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	class UMovieSceneScriptingIntegerKey* AddKey(struct FFrameNumber& InTime, int32 NewValue, float SubFrame, EMovieSceneTimeUnit TimeUnit);
	void RemoveDefault();
	void RemoveKey(class UMovieSceneScriptingKey* Key);
...
{
public:
	uint8                                         Pad_826F[0x18];                                    // 0x0040(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_8272[0x28];                                    // 0x0030(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	class UMovieSceneScriptingObjectPathKey* AddKey(struct FFrameNumber& InTime, class UObject* NewValue, float SubFrame, EMovieSceneTimeUnit TimeUnit);
	void RemoveDefault();
	void RemoveKey(class UMovieSceneScriptingKey* Key);
...
{
public:
	uint8                                         Pad_8275[0x18];                                    // 0x0040(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_8278[0x28];                                    // 0x0030(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	class UMovieSceneScriptingStringKey* AddKey(struct FFrameNumber& InTime, const class FString& NewValue, float SubFrame, EMovieSceneTimeUnit TimeUnit);
	void RemoveDefault();
	void RemoveKey(class UMovieSceneScriptingKey* Key);
...
public:
	...
	static void SetMaterialInfo(class UMovieSceneComponentMaterialTrack* Track, struct FComponentMaterialInfo& MaterialInfo);
...
public:
	...
	static void SetMaterialInfo(class UMovieScenePrimitiveMaterialTrack* Track, struct FComponentMaterialInfo& MaterialInfo);
...
public:
	...
	static class UMovieSceneScriptingChannel* GetChannel(class UMovieSceneSection* Section, class FName& ChannelName);
...
public:
	...
	static int32 AddMarkedFrameToSequence(class UMovieSceneSequence* Sequence, struct FMovieSceneMarkedFrame& InMarkedFrame, EMovieSceneTimeUnit TimeUnit);
