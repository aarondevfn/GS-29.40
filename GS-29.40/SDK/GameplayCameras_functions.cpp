...
bool UCameraAnimationCameraModifier::IsCameraAnimationActive(struct FCameraAnimationHandle& Handle) const
{
	static class UFunction* Func = nullptr;
...
bool UGameplayCamerasSubsystem::IsCameraAnimationActive(class APlayerController* PlayerController, struct FCameraAnimationHandle& Handle) const
{
	static class UFunction* Func = nullptr;
