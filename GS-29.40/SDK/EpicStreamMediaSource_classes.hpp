...
public:
	...
	uint8                                         Pad_3409[0x4];                                     // 0x00AC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_340A[0x2];                                     // 0x0102(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_340B[0x1];                                     // 0x0113(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_340C[0x2];                                     // 0x014A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_340D[0x398];                                   // 0x0158(0x0398)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnVideoUrlSuccess;                                 // 0x04F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnVideoUrlFailed;                                  // 0x0500(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMetaDataFailure;                                 // 0x0510(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMediaLicensedAudioTreatmentChanged;              // 0x0520(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_340E[0x10];                                    // 0x0530(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_340F[0x250];                                   // 0x0588(0x0250)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool ShouldStreamBePlaying(class UObject* WorldContextObject, class UPrimitiveComponent* PrimitiveComponent, float CullRadius) const;
