...
public:
	...
	uint8                                         Pad_14ED[0x4];                                     // 0x02B4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_14EE[0x1];                                     // 0x031B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_14EF[0x8];                                     // 0x0328(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	bool AttachInPlace(class UPrimitiveComponent* InComponent);
	bool AttachTo(class UPrimitiveComponent* InComponent, struct FVector& WorldLocation, struct FVector& AxleDirection, const struct FVector& SteerAxis);
	void Detach();
	...
	void OnRep_RuntimeData(struct FAttachableWheelRuntimeData& RuntimeDataPrev);
	...
	bool GetWorldSpaceAttachData(struct FAttachableWheelAttachData* OutAttachData, class UPrimitiveComponent* PrimitiveComponent, class FName BodyName) const;
...
public:
	...
	uint8                                         Pad_14F6[0xC];                                     // 0x00FC(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void DrawDebug() const;
	class AAttachableWheel* GetAttachedWheelClosestOnAxis(struct FVector& Point, float* OutClosetDistanceToAxis, struct FVector* OutClosestPointOnAxis, struct FVector* OutClosestAxis) const;
