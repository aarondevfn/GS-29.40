...
void USparksSongCatalog::GetSongList(ESongSortMethod SortMethod, ESongSortDirection SortDirection, struct FGameplayTagQuery& TagQuery, TArray<class UCatalogData*>& OutResults)
{
	static class UFunction* Func = nullptr;
...
void USparksSongCatalog::OnCalendarActiveEventsChanged(TArray<class FString>& ActiveEventFlags)
{
	static class UFunction* Func = nullptr;
