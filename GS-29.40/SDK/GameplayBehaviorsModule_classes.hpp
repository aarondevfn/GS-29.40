...
public:
	...
	uint8                                         Pad_35B2[0x7];                                     // 0x0051(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_35B3[0x14];                                    // 0x0028(0x0014)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_35B4[0x18];                                    // 0x0040(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_35B8[0xF];                                     // 0x0099(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_35B9[0x7];                                     // 0x0059(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	static struct FGameplayTagContainer GetBlackboardValueAsGameplayTag(class UBTNode* NodeOwner, struct FBlackboardKeySelector& Key);
	static struct FGameplayTagContainer GetBlackboardValueAsGameplayTagFromBlackboardComp(class UBlackboardComponent* BlackboardComp, class FName& KeyName);
	static void SetBlackboardValueAsGameplayTag(class UBTNode* NodeOwner, struct FBlackboardKeySelector& Key, const struct FGameplayTagContainer& Value);
	static void SetValueAsGameplayTagForBlackboardComp(class UBlackboardComponent* BlackboardComp, class FName& KeyName, const struct FGameplayTagContainer& GameplayTagValue);
