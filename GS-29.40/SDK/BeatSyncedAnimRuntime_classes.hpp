...
{
public:
	static struct FFMontageBeatSyncInfo CalculateMontageBeatSyncInfo(class UMusicClockComponent* MusicClock, class UAnimMontage* Montage, float LengthInBeats, float MsOffset);
	static float CalculateMontagePlayRate(class UMusicClockComponent* MusicClock, class UAnimMontage* Montage, float MontageBeatLength);
...
public:
	...
	static float GetCurrentBeat(class UMusicClockComponent* InMusicClock, bool bRounded);
	static float GetCurrentBeat_Unsafe(class UMusicClockComponent* InMusicClock, bool bRounded);
	static struct FBeatAndTime GetCurrentBeatAndTime(class UMusicClockComponent* MusicClock, class UObject* WorldContext, bool bAlwaysAllowPreviewBPM, float PreviewBPM, bool bForceUnsafe);
	static float GetCurrentBeatForBPM(float InBPM, class UObject* WorldContextObject);
	static float GetCurrentSongTime(class UMusicClockComponent* InMusicClock, bool bRounded);
	static float GetCurrentSongTime_Unsafe(class UMusicClockComponent* InMusicClock, bool bRounded);
...
{
public:
	uint8                                         Pad_8B91[0x4];                                     // 0x00A0(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8B92[0x2];                                     // 0x00B2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8B93[0x2];                                     // 0x00C6(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8B94[0x4];                                     // 0x00CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool IsMusicPlaying();
	const class UPreciseBeatSyncedAnimMetaData* LookupMontageTimingInfo_BP(class UAnimMontage* Montage, class AFortPlayerPawn* PlayerPawn);
...
{
public:
	uint8                                         Pad_8B95[0x18];                                    // 0x00A0(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
