...
public:
	...
	uint8                                         Pad_844B[0x8];                                     // 0x0330(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_844D[0x58];                                    // 0x00A0(0x0058)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void OnAttackerSpawned(class AActor* SpawnedAttacker, class UFortAthenaLivingWorldEventData* EventData);
	...
	void OnDefenderSpawned(class AActor* SpawnedDefender, class UFortAthenaLivingWorldEventData* EventData);
	void OnEncounterEnd();
...
{
public:
	uint8                                         Pad_8454[0x8];                                     // 0x0038(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_8455[0x4];                                     // 0x018C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_8456[0x8];                                     // 0x0038(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_8457[0x50];                                    // 0x0098(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8458[0x20];                                    // 0x0130(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8459[0x8];                                     // 0x0188(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_845A[0x4];                                     // 0x0198(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_845B[0x3];                                     // 0x019D(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void AddAllowedPointProvider(TScriptInterface<class IFortAthenaLivingWorldPointProviderInterface>& PointProvider);
	void AdvanceEncounterStage();
	void OnActorDestroyed__DelegateSignature(class AActor* DestroyedActor, class UFortAthenaLivingWorldEventData* EventData);
	void OnActorDied__DelegateSignature(class AActor* DiedActor);
	void OnActorSpawned__DelegateSignature(class AActor* SpawnedActor, class UFortAthenaLivingWorldEventData* EventData);
	...
	void OnEventSpawned__DelegateSignature(TArray<class AActor*>& Param_SpawnedActors);
	void OnLastActorDied__DelegateSignature();
	void PauseEncounter();
	void RemoveAllowedPointProvider(TScriptInterface<class IFortAthenaLivingWorldPointProviderInterface>& PointProvider);
...
public:
	...
	uint8                                         Pad_845F[0x4];                                     // 0x003C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8460[0x7];                                     // 0x0069(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_8461[0x8];                                     // 0x00A0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8462[0xC];                                     // 0x0164(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8463[0x498];                                   // 0x0758(0x0498)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8464[0x60];                                    // 0x0C50(0x0060)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void LivingWorldManagerToggleActorMinimap(const class FString& Param_Name);
	...
	void LWMF();
	void LWMTAM(const class FString& Param_Name);
	...
	bool RegisterTagDensityReservoir(class AActor* ActorDensityReservoir, TArray<struct FFortAthenaLivingWorldEventTagDensityRegistration>& TagsDensity);
	void RequestEventGeneration();
	...
	bool TrySpawnEvent(const struct FDataTableRowHandle& EventEntry, struct FTransform& SpawnLocation, TDelegate<void(TArray<class AActor*>& SpawnedActors, bool bSuccess)>& OnRequestFinished, int32* RequestID);
	bool TrySpawnEventForRegistry(const struct FDataRegistryId& EventId, struct FTransform& SpawnLocation, TDelegate<void(TArray<class AActor*>& SpawnedActors, bool bSuccess)>& OnRequestFinished, int32* RequestID);
	bool TrySpawnEventWithPreDespawn(const struct FDataTableRowHandle& EventEntry, struct FTransform& SpawnLocation, TDelegate<void(TArray<class AActor*>& SpawnedActors, bool bSuccess)>& OnRequestFinished, const struct FGameplayTag& DespawnDensityTag, float MaxAllowedDensityValue, int32* RequestID);
	bool TrySpawnEventWithPreDespawnForRegistry(const struct FDataRegistryId& EventId, struct FTransform& SpawnLocation, TDelegate<void(TArray<class AActor*>& SpawnedActors, bool bSuccess)>& OnRequestFinished, const struct FGameplayTag& DespawnDensityTag, float MaxAllowedDensityValue, int32* RequestID);
	...
	bool HasPendingSpawnRequestForEncounter(class UFortAthenaLivingWorldEncounterInstance* EncounterInstance) const;
	bool IsEncounterCategoryActive(TSoftObjectPtr<class UFortAthenaLivingWorldEncounter> EncounterType) const;
	...
	int32 QueryEventBudgetForRegistry(const struct FDataRegistryId& EventId, class AActor* SpawnLocation) const;
...
public:
	...
	uint8                                         Pad_8476[0x4];                                     // 0x00CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8477[0x18];                                    // 0x0188(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_8479[0x10];                                    // 0x0028(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_847A[0x7];                                     // 0x0121(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_847B[0x8];                                     // 0x0158(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	FMulticastInlineDelegateProperty_             OnAllActorSpawnedDelegate;                         // 0x0858(0x0010)(ZeroConstructor, Transient, InstancedReference, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_847C[0x18];                                    // 0x0868(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_847D[0x2];                                     // 0x08AE(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_847E[0x5];                                     // 0x0903(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_847F[0x8];                                     // 0x0920(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  PrefabTags;                                        // 0x0928(0x0020)(Transient, Protected, NativeAccessSpecifierProtected)

public:
	static class AFortAthenaLivingWorldPrefab* GetOwningLivingWorldPrefab(class UObject* WorldContextObject);

	void AllowSpawnerToSpawn();
	void CallWhenAllActorHaveSpawned(TDelegate<void(TArray<class AActor*>& SpawnedActors)>& DelegateToCall);
	void OnAllActorSpawnedDelegate__DelegateSignature(TArray<class AActor*>& Param_SpawnedActors);
	void DestroyBuildingsInLevelBounds(TDelegate<void()>& FinishedDelegate);
	void OnBuildingInLevelBoundsDestroyed__DelegateSignature();
	void MakeLevelVisible();
	void OnAllActorSpawned__DelegateSignature(TArray<class AActor*>& Param_SpawnedActors);
...
public:
	void CallWhenActorSpawned(TDelegate<void(class AActor* SpawnedActor)>& DelegateToCall);
	void OnActorSpawnedDelegate__DelegateSignature(class AActor* Param_SpawnedActor);
	void OnActorSpawned__DelegateSignature(class AActor* Param_SpawnedActor);
...
public:
	...
	void K2_OnAllActorSpawned(TArray<class AActor*>& SpawnedActor, TScriptInterface<class IFortAthenaLivingWorldPointProviderInterface>& SourcePointProvider) const;
	void K2_OnSpawnedActor(class AActor* SpawnedActor, TScriptInterface<class IFortAthenaLivingWorldPointProviderInterface>& SourcePointProvider) const;
	void K2_OnSpawnedActorFailed(TScriptInterface<class IFortAthenaLivingWorldPointProviderInterface>& SourcePointProvider) const;
...
public:
	...
	uint8                                         Pad_8481[0xC];                                     // 0x00A4(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_8483[0x18];                                    // 0x0028(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_8484[0x4];                                     // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8485[0x4];                                     // 0x0044(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8486[0x4];                                     // 0x005C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8487[0x8];                                     // 0x0088(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_8488[0x40];                                    // 0x0290(0x0040)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_8489[0x8];                                     // 0x0290(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_848A[0x5];                                     // 0x0333(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_848B[0x20];                                    // 0x0368(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_848D[0x7];                                     // 0x0389(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_848E[0x8];                                     // 0x0448(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_848F[0x8];                                     // 0x02C8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8490[0x6];                                     // 0x02D2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8491[0x6];                                     // 0x0312(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8492[0x1B0];                                   // 0x0428(0x01B0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_8495[0x8];                                     // 0x0290(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8496[0x7];                                     // 0x02C1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8497[0x38];                                    // 0x0358(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_849A[0x8];                                     // 0x0290(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  FiltersTags;                                       // 0x0298(0x0020)(Edit, NativeAccessSpecifierPrivate)
	...
	uint8                                         Pad_849B[0x2];                                     // 0x02C2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_849C[0x28];                                    // 0x0348(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void OnCurrentPlaylistLoaded(class FName PlaylistName, struct FGameplayTagContainer& PlaylistContextTags);
	void OnWorldFinishedInitialization(struct FGameplayTagContainer& ContextTags);
	void SetForcedPawnToUse(class APawn* InForcedPawnToUse);
...
{
public:
	uint8                                         Pad_849F[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_84A0[0x7];                                     // 0x00C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_84A1[0x4];                                     // 0x0174(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_84A2[0xE8];                                    // 0x01E8(0x00E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
