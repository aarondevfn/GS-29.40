...
void AFortGameplayCueNotify_CrownWear::ApplyCrownWear(TArray<class UFXSystemComponent*>& ParticleComponents)
{
...
void AFortGameplayCueNotify_CrownWear::OnIntroFXTimelineTick(struct FVector& CurveValue)
{
	static class UFunction* Func = nullptr;
...
bool UFortControllerComponent_VictoryCrowns::AuthorityHasDroppedCrownItem(class UFortItem* CrownItem) const
{
	static class UFunction* Func = nullptr;
...
bool UFortControllerComponent_VictoryCrowns::AuthorityHasHeldCrownItem(class UFortItem* CrownItem) const
{
	static class UFunction* Func = nullptr;
...
bool UFortControllerComponent_VictoryCrowns::AuthorityHasSquadDroppedCrownItem(class UFortItem* CrownItem) const
{
	static class UFunction* Func = nullptr;
...
bool UFortControllerComponent_VictoryCrowns::AuthorityHasSquadHeldCrownItem(class UFortItem* CrownItem) const
{
	static class UFunction* Func = nullptr;
...
bool UFortControllerComponent_VictoryCrowns::AuthoritySquadHasSeenCrownItem(class UFortItem* CrownItem, bool bDropped) const
{
	static class UFunction* Func = nullptr;
...
bool UFortGameStateComponent_VictoryCrowns::IsCrownBearer(class AFortPlayerStateAthena* FortPSA) const
{
	static class UFunction* Func = nullptr;
