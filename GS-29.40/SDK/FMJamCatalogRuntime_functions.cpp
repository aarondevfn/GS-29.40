...
void UFMJamLoop::GetMidi(EMusicKeyMode Mode, TSoftObjectPtr<class UMidiFile>* OutMetasoundMidi, TSoftObjectPtr<class UFusionPatch>* OutMetasoundFusion) const
{
	static class UFunction* Func = nullptr;
...
int32 UFMJamLoop::GetSemitoneTranspose(EMusicKey ToKey) const
{
	static class UFunction* Func = nullptr;
...
class UFMJamLoop* UFMJamSong::GetLoop(EFMJamLoopType LoopType) const
{
	static class UFunction* Func = nullptr;
...
EFMJamLoopType UFMJamSong::GetLoopTypeForLoop(class UFMJamLoop* Loop) const
{
	static class UFunction* Func = nullptr;
...
class UFMJamSongCatalog* UFMJamSongCatalog::GetFMJamSongCatalog(class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
...
EFMJamLoopType UFMJamSongCatalog::GetLoopTypeByTag(struct FGameplayTag& LoopTag)
{
	static class UFunction* Func = nullptr;
...
class FText UFMJamSongCatalog::GetLoopTypeText(EFMJamLoopType& LoopType)
{
	static class UFunction* Func = nullptr;
...
class UFMJamSongCatalog* UFMJamSongCatalog::TryGetFMJamSongCatalog(class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
...
TArray<class UFMJamSong*> UFMJamSongCatalog::GetRandomSongList(int32 NumSongs, struct FGameplayTagQuery& TagQuery) const
{
	static class UFunction* Func = nullptr;
...
class UFMJamSong* UFMJamSongCatalog::GetSongByShortName(class FName ShortName) const
{
	static class UFunction* Func = nullptr;
...
class UCatalogData* UFMJamSongCatalog::GetSongCatalogEntryByShortName(class FName ShortName) const
{
	static class UFunction* Func = nullptr;
...
TArray<class UFMJamSong*> UFMJamSongCatalog::GetSortedSongList(EFMJamSongCatalogSortMethod SortMethod, EFMJamSongCatalogSortDirection SortDirection, struct FGameplayTagQuery& TagQuery) const
{
	static class UFunction* Func = nullptr;
...
class FName UFortJamEmoteItemDefinition::GetJamSongShortNameForPlayer(class AFortPlayerState* PlayerState) const
{
	static class UFunction* Func = nullptr;
...
bool UFortJamEmoteItemDefinition::IsJamLoopEnabled(class AFortPlayerController* PlayerController) const
{
	static class UFunction* Func = nullptr;
