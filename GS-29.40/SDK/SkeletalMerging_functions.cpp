...
class USkeletalMesh* USkeletalMergingLibrary::MergeMeshes(struct FSkeletalMeshMergeParams& Params_0)
{
...
class USkeleton* USkeletalMergingLibrary::MergeSkeletons(struct FSkeletonMergeParams& Params_0)
{
	static class UFunction* Func = nullptr;
