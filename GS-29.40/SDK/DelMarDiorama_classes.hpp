...
public:
	void BP_OnBoundVehicleChanged(class ADelMarVehicle* NewVehicle);
...
public:
	...
	uint8                                         Pad_91FB[0x18];                                    // 0x02E8(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_91FC[0x4];                                     // 0x03D8(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_91FD[0x8];                                     // 0x03E0(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_91FE[0x4];                                     // 0x003C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_91FF[0x4];                                     // 0x0054(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_9200[0x8];                                     // 0x0A28(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_9201[0x1];                                     // 0x003F(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_9202[0x2];                                     // 0x0462(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9203[0x4];                                     // 0x0474(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_9204[0x8];                                     // 0x0488(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_9205[0x8];                                     // 0x00C8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9206[0xC];                                     // 0x01C4(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_9207[0x30];                                    // 0x0038(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_9208[0x8];                                     // 0x0158(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_920C[0x18];                                    // 0x00A0(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_920D[0x4];                                     // 0x015C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void ClientReceiveEmote(struct FGameplayTag& EmoteTag, class APlayerState* Instigator);
	void ClientReceiveInteraction(struct FGameplayTag& InteractionTag, class APlayerState* Instigator, class APlayerState* Receiver);
	...
	void ServerReceiveEmote(struct FGameplayTag& EmoteTag);
	void ServerReceiveInteraction(struct FGameplayTag& EmoteTag, class APlayerState* Receiver);
