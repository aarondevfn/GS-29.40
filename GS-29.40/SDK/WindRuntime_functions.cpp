...
void UWindSplineComponent::GetClosestActiveLocations(struct FVector& InTargetLocation, bool* bIsClosestPointActive, struct FVector* ClosestPointOnSpline, TArray<struct FVector>* ClosestActiveLocations) const
{
	static class UFunction* Func = nullptr;
...
void UWindSplineComponent::GetWindDataAtLocation(struct FVector& InTargetLocation, struct FVector* OutDirection, float* OutAttenuation) const
{
	static class UFunction* Func = nullptr;
