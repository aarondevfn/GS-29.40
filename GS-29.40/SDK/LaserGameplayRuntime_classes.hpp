...
public:
	...
	uint8                                         Pad_9352[0xE];                                     // 0x0532(0x000E)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_9353[0x3];                                     // 0x00A5(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_9354[0x4];                                     // 0x09B4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9355[0x4];                                     // 0x0A4C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9356[0x8];                                     // 0x0B78(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9357[0x4];                                     // 0x0C2C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9358[0x3];                                     // 0x0D91(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void HandleLaserCollisionOverlap(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult);
	...
	void LaserGridTriggered(struct FLaserGridConnectionEntry& LaserConnectionData, class AActor* TriggeringActor);
	void OnRep_bEnabled();
	void OnRep_LaserGridConnections();
	void SetLaserGridEnable(bool bEnable);

	bool CanActorTriggerLaserGrid(class AActor* TriggeringActor) const;
