...
{
public:
	uint8                                         Pad_8C54[0x78];                                    // 0x0030(0x0078)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	bool HasProvider(class FName& Param_Name) const;
	bool TryGetResults(class FName& Param_Name, struct FHarmonixAudioAnalyzerResults* Results) const;
...
{
public:
	uint8                                         Pad_8C58[0x8];                                     // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UHarmonixAudioAnalyzerResultsProvider* CreateHarmonixAudioAnalyzerResultsProvider(class FName Param_Name);

	void SetArbitraryTextureData(TArray<float>& ArbitraryTextureData);
...
public:
	...
	uint8                                         Pad_8C5A[0x4];                                     // 0x0134(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8C5B[0x6];                                     // 0x013A(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_8C5C[0x8];                                     // 0x0140(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8C5D[0x4];                                     // 0x014C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8C5E[0x1C];                                    // 0x0154(0x001C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_8C5F[0x3];                                     // 0x0179(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8C60[0x6];                                     // 0x0182(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
