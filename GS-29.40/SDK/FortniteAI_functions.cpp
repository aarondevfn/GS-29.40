...
bool UFortAISmartObjectUserComponent::CommandAIToUseSO(struct FFortAICommandSOUsageData& CommandSOUsageData)
{
	static class UFunction* Func = nullptr;
...
class UAnimMontage* UFortAISmartObjectUserComponent::FindSmartObjectAnimMontageByTag(struct FGameplayTagContainer& Tags, class AActor* SmartObjectActor) const
{
	static class UFunction* Func = nullptr;
...
class UContextualAnimSceneAsset* UFortAISmartObjectUserComponent::FindSmartObjectAnimSceneByTag(struct FGameplayTagContainer& Tags, class AActor* SmartObjectActor) const
{
	static class UFunction* Func = nullptr;
...
void UFortAthenaAIRuntimeParameters_BehaviorTreeControl::DisableBehaviorTreeBranch(EBehaviorTreeBranches Behavior)
{
	static class UFunction* Func = nullptr;
...
void UFortAthenaAIRuntimeParameters_BehaviorTreeControl::EnableBehaviorTreeBranch(EBehaviorTreeBranches Behavior)
{
	static class UFunction* Func = nullptr;
...
bool UFortAthenaAIRuntimeParameters_BehaviorTreeControl::IsBehaviorTreeBranchActive(EBehaviorTreeBranches Behavior) const
{
	static class UFunction* Func = nullptr;
...
float IFortAIEnvironmentalDangerSourceInterface::GetDangerAtLocation(struct FVector& Location) const
{
	static class UFunction* Func = nullptr;
...
void UFortAthenaAIEvaluator_Movement::OnCurrentUnstuckSteeringAttemptFinished(EUnstuckSteeringReason UnstuckSteeringReason)
{
	static class UFunction* Func = nullptr;
...
void UFortAthenaAISpawnerDataComponent_GameplayAbilityBase::SetReplicatedTagsToApplyToPawn(struct FGameplayTagContainer& InGameplayTagContainer)
{
	static class UFunction* Func = nullptr;
...
void UFortAthenaAISpawnerDataComponent_InventoryBase::SetAddStartingItemsToInventory(bool bInAddStartingItemsToInventory)
{
	static class UFunction* Func = nullptr;
...
void UFortAthenaAISpawnerDataComponent_AIBotInventory::SetGrantPickAxe(bool bInGrantPickAxe)
{
	static class UFunction* Func = nullptr;
...
bool UFortBehaviorValueBlueprintUtility::GetBool(struct FFortBehaviorValue_Bool& Value, class UBehaviorTreeComponent* BehaviorTreeComp)
{
	static class UFunction* Func = nullptr;
...
class UClass* UFortBehaviorValueBlueprintUtility::GetClass(struct FFortBehaviorValue_Class& Value, class UBehaviorTreeComponent* BehaviorTreeComp)
{
	static class UFunction* Func = nullptr;
...
uint8 UFortBehaviorValueBlueprintUtility::GetEnum(struct FFortBehaviorValue_Enum& Value, class UBehaviorTreeComponent* BehaviorTreeComp)
{
	static class UFunction* Func = nullptr;
...
float UFortBehaviorValueBlueprintUtility::GetFloat(struct FFortBehaviorValue_Float& Value, class UBehaviorTreeComponent* BehaviorTreeComp)
{
	static class UFunction* Func = nullptr;
...
int32 UFortBehaviorValueBlueprintUtility::GetInt32(struct FFortBehaviorValue_Int32& Value, class UBehaviorTreeComponent* BehaviorTreeComp)
{
	static class UFunction* Func = nullptr;
...
class FName UFortBehaviorValueBlueprintUtility::GetName(struct FFortBehaviorValue_Name& Value, class UBehaviorTreeComponent* BehaviorTreeComp)
{
	static class UFunction* Func = nullptr;
...
class UObject* UFortBehaviorValueBlueprintUtility::GetObject(struct FFortBehaviorValue_Object& Value, class UBehaviorTreeComponent* BehaviorTreeComp)
{
	static class UFunction* Func = nullptr;
...
struct FRotator UFortBehaviorValueBlueprintUtility::GetRotator(struct FFortBehaviorValue_Rotator& Value, class UBehaviorTreeComponent* BehaviorTreeComp)
{
	static class UFunction* Func = nullptr;
...
class FString UFortBehaviorValueBlueprintUtility::GetString(struct FFortBehaviorValue_String& Value, class UBehaviorTreeComponent* BehaviorTreeComp)
{
	static class UFunction* Func = nullptr;
...
struct FGameplayTagContainer UFortBehaviorValueBlueprintUtility::GetTagContainer(struct FFortBehaviorValue_GameplayTagContainer& Value, class UBehaviorTreeComponent* BehaviorTreeComp)
{
	static class UFunction* Func = nullptr;
...
struct FVector UFortBehaviorValueBlueprintUtility::GetVector(struct FFortBehaviorValue_Vector& Value, class UBehaviorTreeComponent* BehaviorTreeComp)
{
	static class UFunction* Func = nullptr;
...
void UAthenaAIPopulationTracker::EnableClientAISpawnTracking(bool bEnable)
{
	static class UFunction* Func = nullptr;
...
TArray<class AController*> UAthenaAIPopulationTracker::GetAIMatchingQuery(struct FGameplayTagQuery& TagQuery) const
{
	static class UFunction* Func = nullptr;
...
bool AAIHotSpot::CanUseSlotByIndex(class AAIController* AI, int32 Param_Index) const
{
	static class UFunction* Func = nullptr;
...
class UAIHotSpotSlot* AAIHotSpot::GetSlotByOwner(class AAIController* AIOwner) const
{
	static class UFunction* Func = nullptr;
...
int32 AAIHotSpot::GetSlotIndexByOwner(class AAIController* AIOwner) const
{
	static class UFunction* Func = nullptr;
...
EAIHotSpotSlot AAIHotSpot::GetSlotStateByOwner(class AAIController* AIOwner) const
{
	static class UFunction* Func = nullptr;
...
bool AAIHotSpot::HasAssignedAI(class AAIController* AI, EAIHotSpotAssignmentFilter Filter) const
{
	static class UFunction* Func = nullptr;
...
bool AAIHotSpot::IsAIAllowed(class AAIController* AI) const
{
	static class UFunction* Func = nullptr;
...
bool UAIHotSpotSlot::IsAIAllowed(class AAIController* AI) const
{
	static class UFunction* Func = nullptr;
...
const class APlayerController* UAthenaAIServiceCreativePlayerBots::GetLastHiringPlayer(class AActor* HiredOwner) const
{
	static class UFunction* Func = nullptr;
...
int32 AFortAIDirector::GetPlayerPawnsInRange(struct FVector& Origin, float Radius, TArray<class AFortPlayerPawn*>* OutPawns) const
{
	static class UFunction* Func = nullptr;
...
bool AFortAIDirector::IsAnyEncounterGoalWithinDistanceOfPoint(struct FVector& Point, float Distance, bool bOnlyActiveEncounters) const
{
	static class UFunction* Func = nullptr;
...
bool AFortAIDirector::IsLineTooCloseToPatrolWards(struct FVector& LineStart, struct FVector& LineEnd) const
{
	static class UFunction* Func = nullptr;
...
bool AFortAIDirector::IsPointTooCloseToPatrolWards(struct FVector& Point, EWardAffectType WardEffectTypeFilter) const
{
	static class UFunction* Func = nullptr;
...
class UAthenaAIServiceZoneManager* UAthenaAIServiceZoneManager::GetAthenaAIServiceZoneManager(class UObject* WorldContextObject, bool bWarnIfNull)
{
	static class UFunction* Func = nullptr;
...
bool UAthenaAIServiceZoneManager::IsInDangerZone(struct FVector& Location) const
{
	static class UFunction* Func = nullptr;
...
bool UAthenaAIServiceZoneManager::IsLOFOccluded(struct FVector& StartLocation, struct FVector& EndLocation) const
{
	static class UFunction* Func = nullptr;
...
void UFortPathFollowingComponent::OnAIMoveBlocked__DelegateSignature(struct FHitResult& HitResult)
{
	static class UFunction* Func = nullptr;
...
struct FGameplayTag UFortAIManagerMinigameComponent::GetSpawnTagFromPawnObject(class UObject* PawnObject) const
{
	static class UFunction* Func = nullptr;
...
void UFortAINavInvokerComponent::SetInvokerRadii(float GenerationRadius, float RemovalRadius)
{
	static class UFunction* Func = nullptr;
...
void UFortPawnComponent_AICustomEffects::AddCustomEffect(struct FGameplayTag& CustomEffectTag, struct FNPCCustomEffect& InEffect)
{
	static class UFunction* Func = nullptr;
...
void UFortPawnComponent_AICustomEffects::PlayCustomEffect(class UNiagaraSystem* Effect, struct FTransform& Transform)
{
	static class UFunction* Func = nullptr;
...
void UFortPawnComponent_AICustomEffects::SetCustomEffects(TArray<struct FNPCCustomEffect>& CustomEffectList)
{
	static class UFunction* Func = nullptr;
...
struct FNPCCustomEffect UFortPawnComponent_AICustomEffects::GetCustomEffect(struct FGameplayTag& CustomEffectTag) const
{
	static class UFunction* Func = nullptr;
...
void AFortAIGoalManager::ClearGoalDiscouragementFromActor(class AFortAIController* AI, class AActor* Actor)
{
	static class UFunction* Func = nullptr;
...
bool AFortAIGoalManager::IsDiscouragedFromActor(class AFortAIController* AI, class AActor* Actor)
{
	static class UFunction* Func = nullptr;
...
class UFortAsyncAction_MakeTieredWaveEncounterSettings* UFortAsyncAction_MakeTieredWaveEncounterSettings::CreateAsyncAction_MakeTieredWaveEncounterSettings(struct FTieredWaveSetData& Param_WaveData, struct FFortEncounterSettings& InEncounterSettings)
{
	static class UFunction* Func = nullptr;
...
void AFortAthenaAIBotController::AddTargetInfo(class AActor* Target, bool bForceTarget, EPerceptionState PerceptionState, float ForgetTime, float ForgetDistance)
{
	static class UFunction* Func = nullptr;
...
void AFortAthenaAIBotController::AddTargetInfos(TArray<class AActor*>& Targets, EPerceptionState PerceptionState, float ForgetTime, float ForgetDistance)
{
	static class UFunction* Func = nullptr;
...
void AFortAthenaAIBotController::Cheat_ForceAthenaCosmeticItemInSlot(class UAthenaCosmeticItemDefinition* CosmeticItem, EAthenaCustomizationCategory Slot, int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
class AFortWeapon* AFortAthenaAIBotController::EquipBestWeapon(bool bUpdateBB)
{
	static class UFunction* Func = nullptr;
...
class AFortWeapon* AFortAthenaAIBotController::EquipWeapon(class UFortWorldItem* Weapon, bool bUpdateBB)
{
	static class UFunction* Func = nullptr;
...
void AFortAthenaAIBotController::OnAlertLevelChanged(EAlertLevel OldAlertLevel, EAlertLevel NewAlertLevel)
{
	static class UFunction* Func = nullptr;
...
void AFortAthenaAIBotController::OnCharacterLaunched(class UFortMovementComp_Character* MovementComp, struct FVector& LaunchVelocity)
{
	static class UFunction* Func = nullptr;
...
void AFortAthenaAIBotController::OnKnockbacked(struct FGameplayTag& KnockbackTypeTag)
{
	static class UFunction* Func = nullptr;
...
void AFortAthenaAIBotController::OnTargetInVehicleDamaged(class AActor* DamageCauser, class AController* EventInstigator, float Damage, struct FVector& EventLocation)
{
	static class UFunction* Func = nullptr;
...
void AFortAthenaAIBotController::OnTargetTagChanged(struct FGameplayTag& UpdatedTag, int32 TagCount)
{
	static class UFunction* Func = nullptr;
...
void AFortAthenaAIBotController::QueueStim(class AActor* SourceActor, struct FVector& SourceLocation, struct FVector& SourceDirection, EStimType NewStimType, float StimStrength, class FName StimTag)
{
	static class UFunction* Func = nullptr;
...
void AFortAthenaAIBotController::RequestMoveAwayFromBox(struct FBox& MoveAwayBox)
{
	static class UFunction* Func = nullptr;
...
void AFortAthenaAIBotController::ResetPerceptionAndTargets(EBlackboardUpdateType BlackboardUpdateType)
{
	static class UFunction* Func = nullptr;
...
void AFortAthenaAIBotController::SetAlertLevel(EAlertLevel NewAlertLevel, EBlackboardUpdateType BlackboardUpdateType, bool bForceUpdate)
{
	static class UFunction* Func = nullptr;
...
void AFortAthenaAIBotController::SetAllowModifySensesEnabled(bool bAllow)
{
	static class UFunction* Func = nullptr;
...
void AFortAthenaAIBotController::SetAllowPropagatedTarget(bool bAllow)
{
	static class UFunction* Func = nullptr;
...
void AFortAthenaAIBotController::SetLeashActorToFollow(class AActor* ActorToFollow, float LeashLocationUpdateRate, struct FVector& LocalOffset)
{
	static class UFunction* Func = nullptr;
...
void AFortAthenaAIBotController::SetRadialLeashAlertLevelOverride(struct FLeashInfoOverride& LeashInfoOverride, EAlertLevel AlertLevel)
{
	static class UFunction* Func = nullptr;
...
const class UFortWorldItem* AFortAthenaAIBotController::GetSlotItemByItemDefinition(class UFortItemDefinition* ItemDefinition) const
{
	static class UFunction* Func = nullptr;
...
const class UFortWorldItem* AFortAthenaAIBotController::GetSlotItemByTag(struct FGameplayTag& TagToCheck) const
{
	static class UFunction* Func = nullptr;
...
const class UFortWorldItem* AFortAthenaAIBotController::GetSlotItemByTagQuery(struct FGameplayTagQuery& TagQuery) const
{
	static class UFunction* Func = nullptr;
...
bool AFortAthenaAIBotController::IsLocationInsideLeash(struct FVector& Location, bool bUseInnerRadius) const
{
	static class UFunction* Func = nullptr;
...
class UAthenaAIServiceCover* UAthenaAIServiceCover::GetAthenaAIServiceCover(class UObject* WorldContextObject, bool bWarnIfNull)
{
	static class UFunction* Func = nullptr;
...
void UFortCreativeCreatureManagerInfoComponent::SetScoreDistribution(EScoreDistributionType InScoreDistribution)
{
	static class UFunction* Func = nullptr;
...
void UFortQueryTwoPointSolver::OnCustomRotationMode(struct FVector& InPointA, struct FVector& Querier)
{
	static class UFunction* Func = nullptr;
...
bool UFortGameplayInteractionSmartObjectBehaviorDefinition::CanBeUsedBy(class AActor* User, class AActor* SmartObjectActor) const
{
	static class UFunction* Func = nullptr;
...
class AFortAthenaPatrolPoint* AFortAthenaPatrolPath::GetPatrolPoint(int32 Param_Index) const
{
	static class UFunction* Func = nullptr;
...
bool UAthenaAIBlueprintLibrary::AIPawnFromGAHasLuringPickupAsGoal(struct FGameplayAbilityActorInfo& ActorInfo, struct FGameplayTag& GameplayTag, float MaxLifetime, EFortPickupSpawnSource RequiredPickupSpawnSource)
{
	static class UFunction* Func = nullptr;
...
bool UAthenaAIBlueprintLibrary::IsItemDefinitionSupported(class UObject* WorldContextObject, class UItemDefinitionBase* FortItemDef)
{
	static class UFunction* Func = nullptr;
...
void UAthenaAIBlueprintLibrary::MakeBotGroupsTakeEachOtherAsTargets(TArray<class AActor*>& GroupA, TArray<class AActor*>& GroupB, EPerceptionState PerceptionState, float ForgetTime, float ForgetDistance)
{
	static class UFunction* Func = nullptr;
...
class AThreatCloud* AFortThreatVisualsManager::GetThreatCloud(struct FThreatLocationInfo& ThreatLocInfo) const
{
	static class UFunction* Func = nullptr;
...
class UAIGoalComponent* UAIGoalComponent::GetAIGoalComponent(class AActor* Actor)
{
	static class UFunction* Func = nullptr;
...
class UAIHotSpotSlot* UAIHotSpotSlotGenerator::AddSlot(struct FVector& RelativeLocation, struct FRotator& RelativeRotation, TSubclassOf<class UAIHotSpotSlot> CustomSlotClass, bool bEnabled) const
{
	static class UFunction* Func = nullptr;
...
// float                                   Param_LoseSightRadius                                  (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UFortAthenaAISpawnerDataComponent_PerceptionBase::SetVisibilityRange(float InSightRadius, float Param_LoseSightRadius, bool bInRestrictOverrideToUnaware)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_LoseSightRadius = Param_LoseSightRadius;
...
// float                                   Param_StealthMeterTarget                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   Param_StealthMeterTargetTime                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UFortAthenaAlertStateComponent::OnStealthMeterChanged(class AFortAthenaAIBotController* BotController, float Param_StealthMeterTarget, float Param_StealthMeterTargetTime)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_StealthMeterTarget = Param_StealthMeterTarget;
	Parms.Param_StealthMeterTargetTime = Param_StealthMeterTargetTime;
...
class UFortAthenaAISpawnerDataComponent* UFortAthenaAISpawnerDataComponentList::GetComponentClassForModification(TSubclassOf<class UFortAthenaAISpawnerDataComponent> ClassToGet)
{
	static class UFunction* Func = nullptr;
...
class UFortAthenaAISpawnerDataComponent* UFortAthenaAISpawnerDataComponentList::GetOrCreateComponentClassForModification(class UObject* ComponentOuter, TSubclassOf<class UFortAthenaAISpawnerDataComponent> ClassToClone) const
{
	static class UFunction* Func = nullptr;
...
void UFortAthenaAISpawnerDataComponent_AffiliationBase::SetOverrideTeamIndex(int32 InOverrideTeamIdx)
{
	static class UFunction* Func = nullptr;
...
void UFortAthenaAISpawnerDataComponent_AIBotBehavior::DisableBehaviorTreeBranch(EBehaviorTreeBranches Behavior)
{
	static class UFunction* Func = nullptr;
...
void UFortAthenaAISpawnerDataComponent_AIBotBehavior::EnableBehaviorTreeBranch(EBehaviorTreeBranches Behavior)
{
	static class UFunction* Func = nullptr;
...
bool UFortAthenaAISpawnerDataComponent_AIBotBehavior::IsBehaviorTreeBranchActive(EBehaviorTreeBranches Behavior) const
{
	static class UFunction* Func = nullptr;
...
void UFortAthenaAISpawnerDataComponent_AIBotGameplay::SetLeashLocation(struct FVector& InLeashLocation)
{
	static class UFunction* Func = nullptr;
...
void UFortAthenaAISpawnerDataComponent_AIBotGameplay::SetNameSettings(EBotNamingMode InNamingMode, class FString& InName, bool bInAddPlayerIDSuffix)
{
	static class UFunction* Func = nullptr;
...
void UFortAthenaAISpawnerDataComponent_SpawnParamsBase::SetSpawnTransform(struct FTransform& InSpawnTransform)
{
	static class UFunction* Func = nullptr;
...
void UFortAthenaLeashComponent::SetLeashCenter(struct FVector& NewCenter)
{
	static class UFunction* Func = nullptr;
...
bool UFortAthenaLeashComponent::IsInsideLeash(struct FVector& Location) const
{
	static class UFunction* Func = nullptr;
...
void UFortPlayerStateComponent_ClientAITracker::ServerOnAISpawned(class AFortPawn* NewAI, class APlayerController* LocalPC)
{
	static class UFunction* Func = nullptr;
