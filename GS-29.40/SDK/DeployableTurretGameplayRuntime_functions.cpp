...
void UDeployableTurretAnimInstance::SetNativeVariables(class ABuildingGameplayActor* OwningTurretBGA, struct FDeployableTurretBPAnimData& AnimData)
{
...
float UDeployableTurretLibrary::DeployableTurret_CalculateTargetingLaserScale(class AActor* TurretActor, struct FTransform& CurrentTurretAimTransform, struct FVector& LaserOrigin, float MaxLaserRange, float DistMult)
{
	static class UFunction* Func = nullptr;
...
struct FVector UDeployableTurretLibrary::DeployableTurret_GetAimLocationForTargetActor(class AActor* TargetActor, TMap<struct FGameplayTag, struct FScalableFloat>& NonPlayerPawnTargetTagToZOffsetMap)
{
	static class UFunction* Func = nullptr;
