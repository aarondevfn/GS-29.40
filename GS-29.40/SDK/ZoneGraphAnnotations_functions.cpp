...
void UZoneGraphDisturbanceAnnotationBPLibrary::TriggerDanger(class UObject* WorldContextObject, class AActor* Instigator, struct FVector& Position, float Radius, float Duration)
{
	static class UFunction* Func = nullptr;
