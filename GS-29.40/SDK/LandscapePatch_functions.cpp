...
void ALandscapePatchManager::MovePatchToIndex(class ULandscapePatchComponent* Patch, int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
int32 ALandscapePatchManager::GetIndexOfPatch(class ULandscapePatchComponent* Patch) const
{
	static class UFunction* Func = nullptr;
...
void ULandscapeTexturePatch::AddWeightPatch(class FName& InWeightmapLayerName, ELandscapeTexturePatchSourceMode SourceMode, bool bUseAlphaChannel)
{
	static class UFunction* Func = nullptr;
...
ELandscapeTexturePatchSourceMode ULandscapeTexturePatch::GetWeightPatchSourceMode(class FName& InWeightmapLayerName)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class FName                             InWeightmapLayerName                                   (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// ELandscapeTexturePatchBlendMode         Param_BlendMode                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void ULandscapeTexturePatch::SetWeightPatchBlendModeOverride(class FName& InWeightmapLayerName, ELandscapeTexturePatchBlendMode Param_BlendMode)
{
	static class UFunction* Func = nullptr;
	...
	Parms.InWeightmapLayerName = InWeightmapLayerName;
	Parms.Param_BlendMode = Param_BlendMode;
...
void ULandscapeTexturePatch::SetWeightPatchSourceMode(class FName& InWeightmapLayerName, ELandscapeTexturePatchSourceMode NewMode)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// float                                   Param_ResolutionMultiplier                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
bool ULandscapeTexturePatch::GetInitResolutionFromLandscape(float Param_ResolutionMultiplier, struct FVector2D* ResolutionOut) const
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_ResolutionMultiplier = Param_ResolutionMultiplier;
