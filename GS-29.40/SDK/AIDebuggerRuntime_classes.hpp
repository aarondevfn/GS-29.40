...
public:
	...
	void NextNavMesh();
	void StartAIDebugger(class FString& AIDebuggerSoftClassPath);
...
{
public:
	uint8                                         Pad_81FD[0x98];                                    // 0x0500(0x0098)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_81FE[0x8];                                     // 0x05A8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_81FF[0x3];                                     // 0x00B9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8200[0x4E];                                    // 0x00C2(0x004E)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void SetVisualizationEnable(EAIDebuggerVisualization VisualizationType, bool bEnable);
	...
	bool IsVisualizationEnabled(EAIDebuggerVisualization VisualizationType) const;
