...
public:
	...
	static bool DoesChoiceHaveWinner(struct FWarEffortFundingMetadata& MetaData, int32 ChoiceIndex);
	static float GetIndexFundedPercent(struct FWarEffortFundingMetadata& MetaData, int32 Param_Index, EWarEffortFundingStationType StationType);
	static bool IsIndexFunded(struct FWarEffortFundingMetadata& MetaData, int32 Param_Index, EWarEffortFundingStationType StationType);
	static bool IsOption1ChoiceWinner(struct FWarEffortFundingMetadata& MetaData, int32 ChoiceIndex);
	static bool IsOption2ChoiceWinner(struct FWarEffortFundingMetadata& MetaData, int32 ChoiceIndex);
	static class FString WriteTextToBuffer(class FText& Text);
...
{
public:
	uint8                                         Pad_9126[0x68];                                    // 0x0028(0x0068)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool IsLocationCorrupted(struct FVector& Location, float Padding) const;
...
public:
	...
	uint8                                         Pad_9129[0x4];                                     // 0x04E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_912A[0x8];                                     // 0x04F0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_912B[0x8];                                     // 0x0508(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_912C[0x8];                                     // 0x0488(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_912D[0x1F];                                    // 0x04D1(0x001F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_9131[0x50];                                    // 0x02C8(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
