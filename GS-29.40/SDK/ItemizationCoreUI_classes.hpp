...
public:
	...
	uint8                                         Pad_8300[0x30];                                    // 0x00F0(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_8301[0x3];                                     // 0x006D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8302[0xF0];                                    // 0x0090(0x00F0)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void DropAll();
	void DropAmount(int64 Amount);
	void DropHalf();
	void SetEquippableItemActive(bool bActive);
	void SetItemSlotNumber(int32 SlotNumber);
	void ToggleEquippableItemActive();
	void UpdateCanSwap(class UInventoryItemEntryViewModel* SwapInventoryItemEntryViewModel);
	void UseItem();
...
public:
	...
	uint8                                         Pad_8303[0x8];                                     // 0x0078(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_8304[0x5];                                     // 0x0083(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	void AddItemEntries(TArray<class UInventoryItemEntryViewModel*>& ItemEntryViewModels);
...
public:
	...
	uint8                                         Pad_8305[0x18];                                    // 0x0078(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	static class UInventoryViewModel* FindInventoryViewModel(class UInventoryDefinition* InventoryDefinition, TArray<class UInventoryViewModel*>& InventoryViewModels);
	static TArray<class UInventoryItemEntryViewModel*> GetInventoryItemEntryViewModels(const TArray<class UInventoryItemEntryViewModel*>& InventoryItemEntryViewModels, bool bIncludeEmptySlots);
...
public:
	...
	uint8                                         Pad_8307[0x2];                                     // 0x01EE(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void SetGridItems(TArray<class UObject*>& GridItems);
	void SetSlotAlignment(EHorizontalAlignment InSlotHorizontalAlignment, EVerticalAlignment InSlotVerticalAlignment);
