...
void AVideoScheduleDeviceBase::OnControlVideoPlayer(const class FString& VUID, const struct FDateTime& StartTime, TArray<class AController*>& Players, class ULevelSequence* Sequence)
{
...
void AVideoScheduleDeviceBase::TestControlVideoPlayer(const class FString& VUID, const struct FDateTime& StartTime, TArray<class AController*>& Players)
{
	static class UFunction* Func = nullptr;
