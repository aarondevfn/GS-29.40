...
class UOptimusNode* UOptimusNodeGraph::AddFunctionReferenceNode(TSoftObjectPtr<class UOptimusFunctionNodeGraph> InFunctionGraph, struct FVector2D& InPosition)
{
	static class UFunction* Func = nullptr;
...
TArray<class UOptimusNode*> UOptimusNodeGraph::AddLoopTerminalNodes(struct FVector2D& InPosition)
{
	static class UFunction* Func = nullptr;
