...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class FString                           Param_ScreenName                                       (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void APapayaTimedEvents::SetupTimedEvents_Native(const class FString& Param_ScreenName)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_ScreenName = std::move(Param_ScreenName);
