...
void UXpEverywhereAccoladesWidget::AccoladeTriggered(int32 XpValue, class FText& SimulatedName, class FText& SimulatedText, TSoftObjectPtr<class UTexture2D>& PreviewImage, EFortSimulatedXPSize SimulatedXpSize, EFortAccoladeType AccoladeType, TSoftObjectPtr<class USoundCue>& SoundCue, EFortAccoladeTierType AccoladeTier)
{
...
void UXpEverywhereAccoladesWidget::OpenWidget(class UFortAccoladeItemDefinition* AccoladeDef, int32 XpValue, class FText& DisplayName, TSoftObjectPtr<class UTexture2D>& AccoladeLargePreviewImageOverride, class FText& SimulatedName, class FText& SimulatedText, EFortSimulatedXPSize SimulatedXpSize)
{
	static class UFunction* Func = nullptr;
...
int32 UXpEverywhereBar::GetTotalXpRequiredForLevel(int32 InLevel) const
{
	static class UFunction* Func = nullptr;
...
void UXpEverywhereReticleWidget::UpdateXPAmount(int32 NewAmount, class USoundCue* Cue, EFortSimulatedXPSize SimulatedXpSize)
{
	static class UFunction* Func = nullptr;
