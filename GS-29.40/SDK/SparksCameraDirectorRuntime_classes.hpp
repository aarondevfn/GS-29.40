...
public:
	...
	uint8                                         Pad_8BAB[0x7];                                     // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_8BAD[0x8];                                     // 0x00D0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8BAE[0x4];                                     // 0x00DC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8BAF[0x2];                                     // 0x0132(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8BB0[0x7];                                     // 0x0149(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSparksCommonDynamicCameraDirectorEvent DynamicEvent;                                      // 0x0150(0x0038)(Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_8BB1[0x18];                                    // 0x0188(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8BB2[0x4];                                     // 0x024C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8BB3[0x3];                                     // 0x0271(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8BB4[0x4];                                     // 0x027C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void ActivateCameraControl(bool bActive);
	void DebugLockSpecificCameraShot(struct FSparksCameraShot& Shot, bool bLockToFirstFrame, class AActor* Target);
	...
	void HandleDirectorDynamicEvent(struct FSparksCommonDynamicCameraDirectorEvent& Payload);
	void HandleForceIntermissionEvent(struct FSparksCommonForceIntermissionCameraDirectorEvent& Payload);
	void HandleIntermissionTagsEvent(struct FSparksCommonIntermissionCameraDirectorEvent& Payload);
	void InitDynamicCameras();
	void InsertPerformanceMap(class USparksPerformanceMap* Map);
	void InsertSequence(struct FSparksCameraDirectorSequence& Sequence);
	...
	void PlaySequenceEntry(struct FSparksCameraDirectorSequenceEntry& Entry, float MsOffset, bool bIntermission, class AActor* ForceTarget);
	float PlayShot(struct FSparksCameraDirectorSequenceEntry* Entry);
	void ReplaceWithNonCloseupShot(struct FSparksCameraDirectorSequenceEntry& OldEntry);
...
public:
	...
	uint8                                         Pad_8BBB[0x7];                                     // 0x0171(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	class USparksCameraDirectorSequenceGenerator* FindBestGenerator(struct FSparksPerformanceMapSection& Section);
	bool GenerateEntry(struct FSparksPerformanceMapSection& Section, struct FSparksCameraDirectorSequenceEntry* OutEntry);
	bool GenerateSequence(struct FSparksPerformanceMapSection& Section, struct FSparksCameraDirectorSequence* OutSequence);
	void Init();
...
public:
	...
	class AActor* GetMatchingCameraTarget(struct FGameplayTagContainer& Tags, float ShotTimeMS, bool bPreferLocal);
	...
	bool GetStaticShot(int32 Param_Index, struct FSparksCameraShot* OutShot) const;
...
public:
	...
	uint8                                         Pad_8BC7[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	int32                                         Index_SparksCameraShotSelectRuleBase;              // 0x0048(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_8BC8[0x4];                                     // 0x004C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	bool ChooseShot(struct FSparksPerformanceMapSection& Section, struct FSparksCameraDirectorSequenceEntry* OutShot);
...
public:
	bool                                          bIsInitialized;                                    // 0x0028(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_8BCB[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	int32                                         Index_SparksCameraPoolSelectRuleBase;              // 0x0108(0x0004)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_8BCC[0x4];                                     // 0x010C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	bool ChooseExitShot(struct FSparksPerformanceMapSection& Section, struct FSparksCameraDirectorSequenceEntry* OutShot);
	bool ChooseIntroShot(struct FSparksPerformanceMapSection& Section, struct FSparksCameraDirectorSequenceEntry* OutShot);
	bool ChooseShot(struct FSparksPerformanceMapSection& Section, struct FSparksCameraDirectorSequenceEntry* OutShot);
	bool Init(struct FSparksCameraSectionWrapper& Section);
	bool Reset();
...
public:
	bool                                          bIsInitialized;                                    // 0x0028(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_8BD1[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	ESparksSectionGeneratorResult GenerateEntry(struct FSparksPerformanceMapSection& Section, class USparksCameraPluginDataProvider* DataProvider, struct FSparksCameraDirectorSequenceEntry* OutEntry);
	ESparksSectionGeneratorResult GenerateExitEntry(struct FSparksPerformanceMapSection& Section, class USparksCameraPluginDataProvider* DataProvider, struct FSparksCameraDirectorSequenceEntry* OutEntry);
	ESparksSectionGeneratorResult GenerateIntroEntry(struct FSparksPerformanceMapSection& Section, class USparksCameraPluginDataProvider* DataProvider, struct FSparksCameraDirectorSequenceEntry* OutEntry);
	ESparksSectionGeneratorResult GenerateSequence(struct FSparksPerformanceMapSection& Section, class USparksCameraPluginDataProvider* DataProvider, struct FSparksCameraDirectorSequence* OutSequence);
	const struct FSparksCameraFilter GetFilter();
	bool Init(struct FSparksCameraSectionWrapper& InPool, class USparksCameraDirectorConfig* Config);
	bool Reset();
...
public:
	...
	static float ScoreTagContainers(struct FGameplayTagContainer& Tags1, struct FGameplayTagContainer& Tags2);
	static ESparksFilterResult ScoreTagsAgainstFilter(struct FSparksCameraFilter& Filter, struct FGameplayTagContainer& TagsToMatch, float* OutScore);
...
public:
	...
	uint8                                         Pad_8BDB[0x78];                                    // 0x00A8(0x0078)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	void AddSection(float StartMS, struct FGameplayTag& PrimaryTag, struct FGameplayTagContainer& SecondaryTags);
