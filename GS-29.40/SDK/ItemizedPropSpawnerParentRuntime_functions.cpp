...
// Parameters:
// TArray<class AEmeraldGlassIceWallChunk*>ChunksInMyWall                                         (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
...
void AEmeraldGlassIceWallChunk::AttachActors(TArray<class AEmeraldGlassIceWallChunk*>& ChunksInMyWall, TArray<class AActor*>& SupportingActors, class AActor* DirectBase)
{
	static class UFunction* Func = nullptr;
...
// bool                                    bAllowIceWallsAsSupportingActors                       (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TArray<class AEmeraldGlassIceWallChunk*>ChunksInMyWall                                         (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)

void AEmeraldGlassIceWallChunk::FindSupportingActors(TArray<class AActor*>& InOutSupportingActors, bool bAllowIceWallsAsSupportingActors, TArray<class AEmeraldGlassIceWallChunk*>& ChunksInMyWall)
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// struct FSereneYardOverlappedActorCheckDataCheckData                                              (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
bool AEmeraldGlassIceWallChunk::NativeShouldActorBlockSpawn(class AActor* Actor, bool bShouldLaunch, struct FGameplayTag& BlockTag)
{
	static class UFunction* Func = nullptr;
...
bool AEmeraldGlassIceWallChunk::NativeShouldDestroyOverlappedActor(class AActor* Actor, struct FGameplayTagContainer& TagsToDestroyOverlappedActor)
{
	static class UFunction* Func = nullptr;
...
bool AEmeraldGlassIceWallChunk::IsIceWallAllowedToOverlapActor(class AActor* Actor) const
{
	static class UFunction* Func = nullptr;
...
void USereneYardFunctionLibraryNative::BuildPropDataForWeaponData(TArray<struct FNativeItemizedPropSpawner_PropSpawnData>& PropSpawnDataArray, TArray<struct FTransform>* PropRelativeTransforms, TMap<ESereneYardChunkLocation, int32>* ChunkLocationToPropIndexMap)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct FSereneYardWeaponData            WeaponData                                             (ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
bool USereneYardFunctionLibraryNative::NativeCheckSpawnValidity(struct FSereneYardWeaponData& WeaponData, struct FVector& InOutTargetLocation, float CameraYaw, bool bCheckForAllChunks, TArray<bool>* OutValidity, TArray<double>* OutOffsets, TArray<class AActor*>* OutActorsBeingUsedAsBase, ESereneYardTargetingFailedReason* OutFailureReason)
{
	static class UFunction* Func = nullptr;
...
bool USereneYardFunctionLibraryNative::NativeUpdateTarget(struct FSereneYardWeaponData& WeaponData, struct FVector* OutTargetLocation, ESereneYardTargetingFailedReason* OutFailureReason, TArray<bool>* OutValidity)
{
	static class UFunction* Func = nullptr;
