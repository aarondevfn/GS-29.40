...
float UWarEffortFundingLibrary::GetIndexFundedPercent(struct FWarEffortFundingMetadata& MetaData, int32 Param_Index, EWarEffortFundingStationType StationType)
{
	static class UFunction* Func = nullptr;
...
bool UWarEffortFundingLibrary::IsIndexFunded(struct FWarEffortFundingMetadata& MetaData, int32 Param_Index, EWarEffortFundingStationType StationType)
{
	static class UFunction* Func = nullptr;
...
bool UCorruptionCoverageMap::IsLocationCorrupted(struct FVector& Location, float Padding) const
{
	static class UFunction* Func = nullptr;
