...
{
public:
	uint8                                         Pad_2726[0x8];                                     // 0x0058(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2727[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2728[0x10];                                    // 0x0030(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<uint32, struct FEntityComponentContainer> ComponentMap;                                      // 0x0040(0x0050)(Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2729[0x58];                                    // 0x0090(0x0058)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_272A[0x8];                                     // 0x0148(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_272B[0x1F];                                    // 0x0059(0x001F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_272C[0x38];                                    // 0x0078(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
