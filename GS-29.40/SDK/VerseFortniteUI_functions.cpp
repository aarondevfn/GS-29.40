...
struct FLinearColor UVerseFortniteUIAllowedConversionLibrary::Conv_SlateColorToLinearColor(struct FSlateColor& Value)
{
	static class UFunction* Func = nullptr;
...
void UVerseFortniteUIFrameworkText_Base::ExecuteServerTextCommitted(class FText& InText, ETextCommit InCommitMethod)
{
	static class UFunction* Func = nullptr;
