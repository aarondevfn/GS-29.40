...
bool ALandscape::RenderWeightmaps(const struct FTransform& InWorldTransform, const struct FBox2D& InExtents, TArray<class FName>& InWeightmapLayerNames, class UTextureRenderTarget* OutRenderTarget)
{
	static class UFunction* Func = nullptr;
