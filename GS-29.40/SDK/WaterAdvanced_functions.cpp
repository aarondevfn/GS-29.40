...
// Parameters:
// class UTextureRenderTarget2D*           Param_WaterInfoTexture                                 (ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UShallowWaterSubsystem::OnWaterInfoTextureCreated(class UTextureRenderTarget2D* Param_WaterInfoTexture)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_WaterInfoTexture = Param_WaterInfoTexture;
