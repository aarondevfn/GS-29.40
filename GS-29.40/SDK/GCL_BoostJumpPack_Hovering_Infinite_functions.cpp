...
void AGCL_BoostJumpPack_Hovering_Infinite_C::ExecuteUbergraph_GCL_BoostJumpPack_Hovering_Infinite(int32 EntryPoint, struct FHitResult& K2Node_CustomEvent_Hit, TDelegate<void(struct FHitResult& Hit)> K2Node_CreateDelegate_OutputDelegate)
{
...
bool AGCL_BoostJumpPack_Hovering_Infinite_C::OnRemove(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TDelegate<void(struct FHitResult& Hit)> K2Node_CreateDelegate_OutputDelegate, bool CallFunc_OnRemove_ReturnValue)
{
	static class UFunction* Func = nullptr;
