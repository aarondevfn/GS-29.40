...
void UFortMatchmakingPortalPopup::OnPlayerCanInteractChanged(bool bPlayerCanInteract, class FText& Message)
{
	static class UFunction* Func = nullptr;
...
class UFortAthenaCreativeMatchmakingWidget* UFortMatchmakingPortalPopup::GetMatchmakingFeedbackWidget(class UCommonActivatableWidget* MatchmakingFeedbackContainer) const
{
	static class UFunction* Func = nullptr;
