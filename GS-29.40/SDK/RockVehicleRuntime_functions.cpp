...
void ARockVehicle::OnSpringImpact__DelegateSignature(class FName Socket, float ImpactSpeed, struct FHitResult& OutHit)
{
	...
	Params::RockVehicle_OnSpringImpact__DelegateSignature Parms{};
...
void ARockVehicle::RockFreeCamToggledDelegate__DelegateSignature(bool bFreeCam)
{
	...
	Params::RockVehicle_RockFreeCamToggledDelegate__DelegateSignature Parms{};
...
void URockVehicleAnalyticsComponent::OnPawnEnteredSeat(TScriptInterface<class IFortVehicleInterface>& InVehicle, class AFortPawn* InPlayerPawn, int32 InSeatIndex)
{
	static class UFunction* Func = nullptr;
...
void URockVehicleAnalyticsComponent::OnPawnExitedSeat(TScriptInterface<class IFortVehicleInterface>& InVehicle, class AFortPawn* InPlayerPawn, int32 InSeatIndex)
{
	static class UFunction* Func = nullptr;
