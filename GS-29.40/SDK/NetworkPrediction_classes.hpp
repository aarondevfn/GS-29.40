...
public:
	...
	uint8                                         Pad_3179[0x8];                                     // 0x0158(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FReplicationProxy                      ReplicationProxy;                                  // 0x0160(0x0050)(Net, Transient, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_317A[0x10];                                    // 0x01B0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_317B[0x638];                                   // 0x0038(0x0638)(Fixing Struct Size After Last Property [ Dumper-7 ])
