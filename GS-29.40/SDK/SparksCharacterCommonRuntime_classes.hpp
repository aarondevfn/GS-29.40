...
public:
	...
	uint8                                         Pad_16D1[0x28];                                    // 0x0070(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16D2[0x1C];                                    // 0x009C(0x001C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_16D3[0xA];                                     // 0x04E6(0x000A)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_16D4[0x3];                                     // 0x03B1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void BP_OnLipSyncAssetChanged(TSoftObjectPtr<class UAnimSequence>& NewLipSyncAsset);
	void BP_OnMidiEventDriverChanged(TScriptInterface<class IMidiEventDriverInterface>& NewMidiEventDriver);
	void BP_OnSetInstrumentPSC(class USparksInstrumentAnimPlayerStateComponent* OldInstrumentPSC, class USparksInstrumentAnimPlayerStateComponent* NewInstrumentPSC);
...
public:
	...
	uint8                                         Pad_16D5[0xC];                                     // 0x03D4(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static int32 GetFretNumberFromMidiNote(uint8 MidiNote);
...
{
public:
	uint8                                         Pad_16D8[0x8];                                     // 0x00A0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16D9[0x5];                                     // 0x00F3(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16DA[0x18];                                    // 0x0110(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16DB[0x18];                                    // 0x0138(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16DC[0x18];                                    // 0x0160(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16DD[0x18];                                    // 0x0188(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16DE[0x18];                                    // 0x01B0(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16DF[0x18];                                    // 0x01D8(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16E0[0x18];                                    // 0x0200(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16E1[0x28];                                    // 0x0228(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
