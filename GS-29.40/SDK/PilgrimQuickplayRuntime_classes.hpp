...
public:
	...
	uint8                                         Pad_9057[0x4];                                     // 0x00A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_9058[0x7];                                     // 0x00A9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_9059[0xA8];                                    // 0x0148(0x00A8)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_905A[0xB];                                     // 0x01F5(0x000B)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_905F[0x3];                                     // 0x00CD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<int32, struct FPilgrimQuickplaySongResultData> SetlistResultMap;                                  // 0x00D0(0x0050)(Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_9060[0x8];                                     // 0x0120(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_9063[0x3];                                     // 0x00B1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9064[0x4];                                     // 0x00BC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_9065[0x2];                                     // 0x0032(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9066[0x7];                                     // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9067[0x7];                                     // 0x00A9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9068[0x4];                                     // 0x00C4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9069[0x7];                                     // 0x00D9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_906A[0x4];                                     // 0x0174(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UPilgrimQuickplayPlayerStateComponent* GetPilgrimQuickplayPlayerStateComponent(class APlayerState* PlayerState);
	...
	void SendHighscoreToServer(struct FPilgrimPersonalBestResult& Highscore, int32 SetlistIndex, bool bLoaded);
	void SendToClientsPerformanceData(int32 SetlistIndex, struct FPilgrimQuickplayPlayerPerformanceData& NewPerformanceData);
	void SendToClientsResetSetlistResultData();
	void SendToClientsSongResultData(int32 SetlistIndex, struct FPilgrimQuickplaySongResultData& NewPerformanceData);
	void SendToServerAllIntrosFinished(class UPilgrimQuickplayState_Intro* IntroState);
	void SendToServerPerformanceData(struct FPilgrimQuickplayPlayerPerformanceData& NewPerformanceData);
	void Server_GrantDefaultQuests();
	void Server_ResetDefaultQuests();
	void ServerSetHighscore(struct FPilgrimPersonalBestResultRpl& Highscore, int32 SetlistIndex, bool bLoaded);
	void SetCloseupCameraTime(float TotalTime);
	void SetHighscore(struct FPilgrimPersonalBestResultRpl& Highscore, int32 SetlistIndex, bool bLoaded);
	void SetPerformanceData(struct FPilgrimQuickplayPlayerPerformanceData& NewPerformanceData);
	...
	void SetSongResultData(struct FPilgrimQuickplaySongResultData& NewSongResultData);
...
public:
	...
	class UPilgrimQuickplayCameraDataSource*      CameraDataSource;                                  // 0x0858(0x0008)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)

public:
	void ForceActiveCameraDirector();
	void HandleDirectorResetEvent(struct FSparksCommonResetCameraDirectorEvent& Payload);
	void HandleDirectorStartEvent(struct FSparksCommonStartCameraDirectorEvent& Payload);
	void HandleDirectorStopEvent(struct FSparksCommonStopCameraDirectorEvent& Payload);
...
{
public:
	uint8                                         Pad_9077[0x10];                                    // 0x00F8(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	static EPilgrimQuickplayState GetPilgrimState(struct FGameplayTag& Tag);
	static struct FGameplayTag GetStateTag(EPilgrimQuickplayState& State);
...
public:
	...
	void PrepareStageForPlayer(class AFortPlayerPawn* Pawn, struct FVector& TeleportLocation, struct FRotator& TeleportRotation);
	void TeleportAllPlayers(struct FGameplayTagContainer& TeleportTagRequirements);
...
public:
	...
	uint8                                         Pad_907A[0x7C];                                    // 0x00FC(0x007C)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void UpdateCameraWaitTime(float NewWaitTime);
...
{
public:
	uint8                                         Pad_907B[0x8];                                     // 0x00D8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_907C[0xC];                                     // 0x00DC(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_907D[0x38];                                    // 0x0108(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_907E[0xC];                                     // 0x00DC(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_907F[0x1F];                                    // 0x0101(0x001F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_9082[0x28];                                    // 0x00A0(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void ServerOnTimedInputReceived(class UPilgrimPlayerControllerComponent* PilgrimPC, struct FPilgrimTimedInput& TimedInput);
...
public:
	...
	uint8                                         Pad_9083[0x8];                                     // 0x0180(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void SetupListeners(class UGameplayEventRouterComponent* EventRouter);
	void TeleportSpawnedStandins(TArray<class AFortPlayerStart*>& Destinations);
...
public:
	...
	uint8                                         Pad_9084[0x4];                                     // 0x00B4(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_9085[0x10];                                    // 0x0050(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
