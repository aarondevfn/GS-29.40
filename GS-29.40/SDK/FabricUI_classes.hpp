...
public:
	...
	uint8                                         Pad_A3EA[0x6];                                     // 0x008A(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_A3EB[0x7];                                     // 0x0091(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_A3EC[0x6];                                     // 0x0092(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_A3ED[0x2];                                     // 0x003A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_A3EE[0x4];                                     // 0x0044(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_A3EF[0x7];                                     // 0x0091(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_A3F0[0x6];                                     // 0x006A(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_A3F1[0x10];                                    // 0x0310(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	class UFabricWidget* AttachFabricWidget(TSubclassOf<class UFabricWidget>& FabricWidgetClass, struct FVector2D& GridPosition);
	void SetScreenGridDimensions(struct FVector2D& InNewDimensions);
...
public:
	...
	uint8                                         Pad_A3F2[0xF];                                     // 0x0671(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_A3F3[0x18];                                    // 0x0040(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
