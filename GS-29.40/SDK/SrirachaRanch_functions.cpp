...
void UStreamingRadioPlayerComponent::PlayIndex(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
void UStreamingRadioPlayerComponent::ServerPlayIndex(int32 InIndex, EStreamingRadioSourceState InState)
{
	static class UFunction* Func = nullptr;
