...
class UPilgrimQuickplayPlayerStateComponent* UPilgrimQuickplayPlayerStateComponent::GetPilgrimQuickplayPlayerStateComponent(class APlayerState* PlayerState)
{
	static class UFunction* Func = nullptr;
...
void UPilgrimQuickplayPlayerStateComponent::SendHighscoreToServer(struct FPilgrimPersonalBestResult& Highscore, int32 SetlistIndex, bool bLoaded)
{
	static class UFunction* Func = nullptr;
...
void UPilgrimQuickplayPlayerStateComponent::SendToClientsPerformanceData(int32 SetlistIndex, struct FPilgrimQuickplayPlayerPerformanceData& NewPerformanceData)
{
	static class UFunction* Func = nullptr;
...
void UPilgrimQuickplayPlayerStateComponent::SendToClientsSongResultData(int32 SetlistIndex, struct FPilgrimQuickplaySongResultData& NewPerformanceData)
{
	static class UFunction* Func = nullptr;
...
void UPilgrimQuickplayPlayerStateComponent::SendToServerPerformanceData(struct FPilgrimQuickplayPlayerPerformanceData& NewPerformanceData)
{
	static class UFunction* Func = nullptr;
...
void UPilgrimQuickplayPlayerStateComponent::ServerSetHighscore(struct FPilgrimPersonalBestResultRpl& Highscore, int32 SetlistIndex, bool bLoaded)
{
	static class UFunction* Func = nullptr;
...
void UPilgrimQuickplayPlayerStateComponent::SetHighscore(struct FPilgrimPersonalBestResultRpl& Highscore, int32 SetlistIndex, bool bLoaded)
{
	static class UFunction* Func = nullptr;
...
void UPilgrimQuickplayPlayerStateComponent::SetPerformanceData(struct FPilgrimQuickplayPlayerPerformanceData& NewPerformanceData)
{
	static class UFunction* Func = nullptr;
...
void UPilgrimQuickplayPlayerStateComponent::SetSongResultData(struct FPilgrimQuickplaySongResultData& NewSongResultData)
{
	static class UFunction* Func = nullptr;
...
void APilgrimQuickplayPlayspace::HandleDirectorResetEvent(struct FSparksCommonResetCameraDirectorEvent& Payload)
{
	static class UFunction* Func = nullptr;
...
void APilgrimQuickplayPlayspace::HandleDirectorStartEvent(struct FSparksCommonStartCameraDirectorEvent& Payload)
{
	static class UFunction* Func = nullptr;
...
void APilgrimQuickplayPlayspace::HandleDirectorStopEvent(struct FSparksCommonStopCameraDirectorEvent& Payload)
{
	static class UFunction* Func = nullptr;
...
EPilgrimQuickplayState UPilgrimQuickplayStateBPFL::GetPilgrimState(struct FGameplayTag& Tag)
{
	static class UFunction* Func = nullptr;
...
struct FGameplayTag UPilgrimQuickplayStateBPFL::GetStateTag(EPilgrimQuickplayState& State)
{
	static class UFunction* Func = nullptr;
...
void UPilgrimQuickplayStateMachine::PrepareStageForPlayer(class AFortPlayerPawn* Pawn, struct FVector& TeleportLocation, struct FRotator& TeleportRotation)
{
	static class UFunction* Func = nullptr;
...
void UPilgrimQuickplayStateMachine::TeleportAllPlayers(struct FGameplayTagContainer& TeleportTagRequirements)
{
	static class UFunction* Func = nullptr;
...
void UPilgrimQuickplayState_Intro::UpdateCameraWaitTime(float NewWaitTime)
{
	static class UFunction* Func = nullptr;
...
void UPilgrimQuickplaySuspendHandleComponent::ServerOnTimedInputReceived(class UPilgrimPlayerControllerComponent* PilgrimPC, struct FPilgrimTimedInput& TimedInput)
{
	static class UFunction* Func = nullptr;
...
void UPilgrimStandinDirector::TeleportSpawnedStandins(TArray<class AFortPlayerStart*>& Destinations)
{
	static class UFunction* Func = nullptr;
