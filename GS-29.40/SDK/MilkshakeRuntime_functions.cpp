...
float AMilkshakeEarthquakeActor::GetNormalizedMagnitudeAtLocation(struct FVector& Location)
{
	static class UFunction* Func = nullptr;
...
void AMilkshakeEarthquakeActor::TickEarthquakePhysicsActorForces(float DeltaSeconds)
{
	static class UFunction* Func = nullptr;
...
void AMilkshakeFieldSystemActor::SetStrength(float InStrength)
{
	static class UFunction* Func = nullptr;
