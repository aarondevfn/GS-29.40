...
// TDelegate<void(class UUserWidget* UserWidget)>K2Node_CreateDelegate_OutputDelegate_1                 (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UTabAccountOptions_New_C::ExecuteUbergraph_TabAccountOptions_New(int32 EntryPoint, class UUserWidget* K2Node_CustomEvent_UserWidget_1, TDelegate<void(class UUserWidget* UserWidget)> K2Node_CreateDelegate_OutputDelegate, class UUserWidget* Temp_object_Variable, TDelegate<void(class UUserWidget* UserWidget)> K2Node_CreateDelegate_OutputDelegate_1, class UUserWidget* K2Node_CustomEvent_UserWidget, class UUserWidget* Temp_object_Variable_1, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UFortAsyncAction_CreateWidgetAsync* CallFunc_CreateWidgetAsync_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue_1, class UFortAsyncAction_CreateWidgetAsync* CallFunc_CreateWidgetAsync_ReturnValue_1, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, double K2Node_CustomEvent_Value, class UFortSetting* K2Node_ComponentBoundEvent_Setting, class FName K2Node_ComponentBoundEvent_Action, bool K2Node_SwitchName_CmpSuccess)
{
	static class UFunction* Func = nullptr;
