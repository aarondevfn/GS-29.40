...
void UHurdleComponent::BP_CreateHurdleHighlight(struct FHurdleTargetingData& TargetingData)
{
	static class UFunction* Func = nullptr;
...
void UHurdleComponent::HandleNavLinkMoveStarted(struct FVector& LinkEndPoint)
{
	static class UFunction* Func = nullptr;
...
bool UHurdleLibrary::PerformHurdleTargeting(class ACharacter* Character, struct FHurdleInputConfigCache* HurdleInputConfig, struct FHurdleTargetingData* OutTargetingData, bool bIsAutoHurdle, struct FVector& OverrideAimDirection)
{
	static class UFunction* Func = nullptr;
