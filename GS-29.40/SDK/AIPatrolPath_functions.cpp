...
void UAIPatrolPathComponent::GeneratePathPoints(EFortCreativePatrolPathGroup PatrolPathGroup, bool bGenerationCausedByDuplication)
{
...
void UAIPatrolPathComponent::SetPatrollingMode(EPatrollingMode NewMode)
{
	static class UFunction* Func = nullptr;
...
void UAIPatrolPathComponent::SetPatrolPathGroup(EFortCreativePatrolPathGroup PatrolPathGroup)
{
	static class UFunction* Func = nullptr;
...
class UAIPatrolPathComponent* UAIPatrolPathComponent::GetPatrolPathPoint(int32 InPatrolPathIndex, int32 InPatrolPathPointIndex) const
{
	static class UFunction* Func = nullptr;
