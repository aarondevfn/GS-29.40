...
public:
	...
	uint8                                         Pad_878C[0x8];                                     // 0x00B0(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_878D[0x8];                                     // 0x0080(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_878E[0x10];                                    // 0x0B80(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScalableFloat                         RerollHoldInputSeconds;                            // 0x0B90(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	uint8                                         Pad_878F[0x8];                                     // 0x0BB8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_8790[0x4];                                     // 0x00AC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8791[0xF];                                     // 0x00C1(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static class UFortBattleRoyalePlayerAugmentSystem* Get(class AController* Controller);
...
public:
	...
	uint8                                         Pad_8795[0x20];                                    // 0x00F8(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8796[0x1];                                     // 0x0168(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8797[0x6];                                     // 0x016A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8798[0x6];                                     // 0x0182(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8799[0x28];                                    // 0x0208(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_879A[0x58];                                    // 0x0570(0x0058)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UFortControllerComponent_AugmentGrantingSystem* GetAugmentGrantingComponentFromController(class AController* Controller);
...
{
public:
	uint8                                         Pad_879B[0x20];                                    // 0x00A8(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_879C[0x18];                                    // 0x0138(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_879D[0xC];                                     // 0x0154(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_879F[0x40];                                    // 0x0180(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_87A1[0x50];                                    // 0x02D8(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_87A2[0x10];                                    // 0x0098(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static void AddToPlayerCollection(class AFortPlayerController* PlayerController, struct FGameplayTag& PlayerAugmentVariantTag);
...
{
public:
	uint8                                         Pad_87A7[0x18];                                    // 0x00A0(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	static class UFortPlayerStateComponent_PlayerAugmentSystem* GetAugmentComponent(class AActor* PlayerContextActor);
	static class UFortPlayerStateComponent_PlayerAugmentSystem* GetAugmentComponentValidated(EAugmentExecResult* OutExec, class AActor* PlayerContextActor);
