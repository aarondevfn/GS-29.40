...
// class UMaterialParameterCollection*     Param_Collection                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UWB_AudioAnalysis_FloatGraph_C::Initialize_MPC(class FName Param_Parameter, class UMaterialParameterCollection* Param_Collection, int32 Param_VectorIndex)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_Collection = Param_Collection;
