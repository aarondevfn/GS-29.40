...
// TArray<struct FFortReceivedItemLootInfo>Param_ItemDefs                                         (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
// bool                                    Param_bSelfGift                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UItemReceivedHeaderSubWidgetBase_C::SetBlueprintGiftBoxItem(class UFortGiftBoxItem* GiftBox, const class FString& FromUser, TArray<struct FFortReceivedItemLootInfo>& Param_ItemDefs, bool Param_bSelfGift)
{
	...
	Parms.Param_ItemDefs = std::move(Param_ItemDefs);
	Parms.Param_bSelfGift = Param_bSelfGift;
