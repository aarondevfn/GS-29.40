...
void UMVVMViewPanelWidgetExtension::BP_SetItems(TArray<class UObject*>& InItems)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MVVMViewPanelWidgetExtension", "BP_SetItems");

	Params::MVVMViewPanelWidgetExtension_BP_SetItems Parms{};
...
void UMVVMViewModelContextResolver::K2_DestroyInstance(class UObject* ViewModel, class UMVVMView* View) const
{
	static class UFunction* Func = nullptr;
