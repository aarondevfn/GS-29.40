...
void UAthenaFunctionLibrary_C::GetActorMeshExtents(class AActor* Actor, class UObject* __WorldContext, struct FVector* BoundingBoxExtents, const struct FVector& CurrentMin, const struct FVector& CurrentMax, const struct FVector& CallFunc_GetActorBounds_Origin, const struct FVector& CallFunc_GetActorBounds_BoxExtent, TArray<class UStaticMeshComponent*>& CallFunc_K2_GetComponentsByClass_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, int32 CallFunc_Array_Length_ReturnValue_1, bool CallFunc_Greater_IntInt_ReturnValue, int32 Temp_int_Array_Index_Variable, class UStaticMeshComponent* CallFunc_Array_Get_Item, bool CallFunc_IsVisible_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, const struct FBox& CallFunc_GetBoundingBox_ReturnValue, int32 Temp_int_Loop_Counter_Variable, double CallFunc_BreakVector_X, double CallFunc_BreakVector_Y, double CallFunc_BreakVector_Z, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, double CallFunc_BreakVector_X_1, double CallFunc_BreakVector_Y_1, double CallFunc_BreakVector_Z_1, bool CallFunc_EqualEqual_VectorVector_ReturnValue, const struct FVector& CallFunc_Subtract_VectorVector_ReturnValue, double CallFunc_BreakVector_X_2, double CallFunc_BreakVector_Y_2, double CallFunc_BreakVector_Z_2, double CallFunc_BreakVector_X_3, double CallFunc_BreakVector_Y_3, double CallFunc_BreakVector_Z_3, double CallFunc_FMax_ReturnValue, double CallFunc_FMin_ReturnValue, double CallFunc_FMin_ReturnValue_1, double CallFunc_FMin_ReturnValue_2, double CallFunc_FMax_ReturnValue_1, const struct FVector& CallFunc_MakeVector_ReturnValue, double CallFunc_FMax_ReturnValue_2, const struct FVector& CallFunc_MakeVector_ReturnValue_1)
{
	...
	Parms.Actor = Actor;
	Parms.__WorldContext = __WorldContext;
	Parms.CurrentMin = std::move(CurrentMin);
	Parms.CurrentMax = std::move(CurrentMax);
	Parms.CallFunc_GetActorBounds_Origin = std::move(CallFunc_GetActorBounds_Origin);
	Parms.CallFunc_GetActorBounds_BoxExtent = std::move(CallFunc_GetActorBounds_BoxExtent);
	...
	Parms.CallFunc_GetBoundingBox_ReturnValue = std::move(CallFunc_GetBoundingBox_ReturnValue);
	Parms.Temp_int_Loop_Counter_Variable = Temp_int_Loop_Counter_Variable;
...
bool UAthenaFunctionLibrary_C::ShouldAllowDeathEffects(const struct FGameplayTagContainer& Damage_Or_Death_Tags, class UObject* __WorldContext, const struct FGameplayTagQuery& AllowDeathEffectsTagQuery, bool CallFunc_DoesContainerMatchTagQuery_ReturnValue)
{
	...
	Parms.__WorldContext = __WorldContext;
	Parms.AllowDeathEffectsTagQuery = std::move(AllowDeathEffectsTagQuery);
...
void UAthenaFunctionLibrary_C::SpawnLootFromArray(TArray<struct FFortItemEntry>& Array, const struct FVector& Position, const struct FVector& Direction, int32 OverrideMaxStackCount, bool bToss, bool bRandomRotation, bool bBlockedFromAutoPickup, int32 PickupInstigatorHandle, EFortPickupSourceTypeFlag SourceType, EFortPickupSpawnSource Source, class AFortPlayerController* OptionalOwnerPC, bool bPickupOnlyRelevantToOwner, class UObject* __WorldContext, TArray<class AFortPickup*>* ItemPickupsSpawned, const TArray<class AFortPickup*>& PickupsSpawned, class FName LootTierData, int32 CallFunc_Array_Length_ReturnValue, int32 Temp_int_Loop_Counter_Variable, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Array_Index_Variable, const struct FFortItemEntry& CallFunc_Array_Get_Item, class UItemDefinitionBase* CallFunc_BreakFortItemEntry_ItemDefinition, int32 CallFunc_BreakFortItemEntry_Count, int32 CallFunc_BreakFortItemEntry_Level, int32 CallFunc_BreakFortItemEntry_LoadedAmmo, int32 CallFunc_BreakFortItemEntry_PhantomReserveAmmo, class UFortWorldItemDefinition* K2Node_DynamicCast_AsFort_World_Item_Definition, bool K2Node_DynamicCast_bSuccess, class AFortPickup* CallFunc_K2_SpawnPickupInWorld_ReturnValue, int32 CallFunc_Array_AddUnique_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// int32                                   Temp_int_Array_Index_Variable                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FFortItemEntry                   CallFunc_Array_Get_Item                                ()
// class AFortPickup*                      CallFunc_K2_SpawnPickupInWorldWithClassAndItemEntry_ReturnValue(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// int32                                   CallFunc_Array_AddUnique_ReturnValue                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAthenaFunctionLibrary_C::SpawnLootFromTableUsingItemEntry(class FName TierGroupName, int32 WorldLevel, int32 ForcedLootTier, const struct FVector& Position, const struct FVector& Direction, int32 OverrideMaxStackCount, bool bToss, bool bRandomRotation, bool bBlockedFromAutoPickup, int32 PickupInstigatorHandle, EFortPickupSourceTypeFlag SourceType, EFortPickupSpawnSource Source, class AFortPlayerController* OptionalOwnerPC, bool bPickupOnlyRelevantToOwner, class UObject* __WorldContext, TArray<class AFortPickup*>* ItemPickupsSpawned, const TArray<class AFortPickup*>& PickupsSpawned, class FName LootTierData, TArray<struct FFortItemEntry>& CallFunc_PickLootDrops_OutLootToDrop, bool CallFunc_PickLootDrops_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, int32 Temp_int_Loop_Counter_Variable, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Array_Index_Variable, const struct FFortItemEntry& CallFunc_Array_Get_Item, class AFortPickup* CallFunc_K2_SpawnPickupInWorldWithClassAndItemEntry_ReturnValue, int32 CallFunc_Array_AddUnique_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Temp_int_Array_Index_Variable = Temp_int_Array_Index_Variable;
	Parms.CallFunc_Array_Get_Item = std::move(CallFunc_Array_Get_Item);
	Parms.CallFunc_K2_SpawnPickupInWorldWithClassAndItemEntry_ReturnValue = CallFunc_K2_SpawnPickupInWorldWithClassAndItemEntry_ReturnValue;
	Parms.CallFunc_Array_AddUnique_ReturnValue = CallFunc_Array_AddUnique_ReturnValue;
