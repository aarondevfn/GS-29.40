...
public:
	...
	uint8                                         Pad_1E99[0x10];                                    // 0x0030(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	bool ClearModulator();
	bool SetModulator(class USoundModulatorBase* InModulator);
...
{
public:
	static void ActivateBus(class UObject* WorldContextObject, class USoundControlBus* Bus);
	static void ActivateBusMix(class UObject* WorldContextObject, class USoundControlBusMix* Mix);
	static void ActivateGenerator(class UObject* WorldContextObject, class USoundModulationGenerator* Generator);
	static void ClearAllGlobalBusMixValues(class UObject* WorldContextObject, float FadeTime);
	static void ClearGlobalBusMixValue(class UObject* WorldContextObject, class USoundControlBus* Bus, float FadeTime);
	static class USoundModulationGeneratorADEnvelope* CreateADEnvelopeGenerator(class UObject* WorldContextObject, class FName Param_Name, struct FSoundModulationADEnvelopeParams& Params_0);
	...
	static class USoundControlBusMix* CreateBusMixFromValue(class UObject* WorldContextObject, class FName Param_Name, TArray<class USoundControlBus*>& Buses, float Value, float AttackTime, float ReleaseTime, bool bActivate);
	static struct FSoundControlBusMixStage CreateBusMixStage(class UObject* WorldContextObject, class USoundControlBus* Bus, float Value, float AttackTime, float ReleaseTime);
	static class USoundModulationGeneratorEnvelopeFollower* CreateEnvelopeFollowerGenerator(class UObject* WorldContextObject, class FName Param_Name, const struct FEnvelopeFollowerGeneratorParams& Params_0);
	static class USoundModulationGeneratorLFO* CreateLFOGenerator(class UObject* WorldContextObject, class FName Param_Name, const struct FSoundModulationLFOParams& Params_0);
	static class UAudioModulationDestination* CreateModulationDestination(class UObject* WorldContextObject, class FName Param_Name, class USoundModulatorBase* Modulator);
	static class USoundModulationParameter* CreateModulationParameter(class UObject* WorldContextObject, class FName Param_Name, TSubclassOf<class USoundModulationParameter> ParamClass, float DefaultValue);
	static void DeactivateAllBusMixes(class UObject* WorldContextObject);
	static void DeactivateBus(class UObject* WorldContextObject, class USoundControlBus* Bus);
	static void DeactivateBusMix(class UObject* WorldContextObject, class USoundControlBusMix* Mix);
	static void DeactivateGenerator(class UObject* WorldContextObject, class USoundModulationGenerator* Generator);
	static TSet<class USoundModulatorBase*> GetModulatorsFromDestination(struct FSoundModulationDestinationSettings& Destination);
	static float GetModulatorValue(class UObject* WorldContextObject, class USoundModulatorBase* Modulator);
	static bool IsControlBusMixActive(class UObject* WorldContextObject, class USoundControlBusMix* Mix);
	static TArray<struct FSoundControlBusMixStage> LoadMixFromProfile(class UObject* WorldContextObject, class USoundControlBusMix* Mix, bool bActivate, int32 ProfileIndex);
	static void SaveMixToProfile(class UObject* WorldContextObject, class USoundControlBusMix* Mix, int32 ProfileIndex);
	static void SetGlobalBusMixValue(class UObject* WorldContextObject, class USoundControlBus* Bus, float Value, float FadeTime);
	static void UpdateMix(class UObject* WorldContextObject, class USoundControlBusMix* Mix, const TArray<struct FSoundControlBusMixStage>& Stages, float FadeTime);
	static void UpdateMixByFilter(class UObject* WorldContextObject, class USoundControlBusMix* Mix, const class FString& AddressFilter, TSubclassOf<class USoundModulationParameter> ParamClassFilter, class USoundModulationParameter* ParamFilter, float Value, float FadeTime);
	static void UpdateMixFromObject(class UObject* WorldContextObject, class USoundControlBusMix* Mix, float FadeTime);
	static void UpdateModulator(class UObject* WorldContextObject, class USoundModulatorBase* Modulator);
...
{
public:
	struct FSoundModulationADEnvelopeParams       Params;                                            // 0x0030(0x0014)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_1EAF[0x4];                                     // 0x0044(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1EB1[0x4];                                     // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1EB2[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1EB3[0x4];                                     // 0x0034(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1EB4[0x4];                                     // 0x003C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1EB5[0x4];                                     // 0x003C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
