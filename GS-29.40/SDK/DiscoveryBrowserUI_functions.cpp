...
void UFortDiscoverHomespace::SendHomespaceSubviewEvent(class UWidget* SubWidget, const class FString& Text) const
{
	static class UFunction* Func = nullptr;
...
void UFortActivityBrowserPlayWithFriendsTile::UpdateCTAButtonInfo(class FText& InteractionText, bool bInteractionFound)
{
	static class UFunction* Func = nullptr;
...
void UFortActivityBrowserPlayWithFriendsTile::UpdateCTAButtonInteraction(bool bIsInteractionEnabled)
{
	static class UFunction* Func = nullptr;
...
void UFortActivityBrowserRowView::HandleVerticalSwipe(int32 Direction)
{
	static class UFunction* Func = nullptr;
