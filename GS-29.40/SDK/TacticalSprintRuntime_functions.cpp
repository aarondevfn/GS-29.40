...
void UFortPlayerControllerComponent_TacticalSprint::AddCustomSprintMMEClass(TSubclassOf<class UFortMovementMode_ELTacSprint>& SprintMMEClassToAdd)
{
	static class UFunction* Func = nullptr;
...
void UFortPlayerControllerComponent_TacticalSprint::LogAndVisualLog(class UObject* LoggingSource, ESprintLoggingVerbosityLevel Verbosity, class FString& LogString)
{
	static class UFunction* Func = nullptr;
...
void UFortPlayerControllerComponent_TacticalSprint::RemoveCustomSprintMMEClass(TSubclassOf<class UFortMovementMode_ELTacSprint>& SprintMMEClassToRemove)
{
	static class UFunction* Func = nullptr;
