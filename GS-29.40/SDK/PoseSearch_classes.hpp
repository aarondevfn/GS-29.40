...
{
public:
	static struct FMotionMatchingAnimNodeReference ConvertToMotionMatchingNode(struct FAnimNodeReference& Node, EAnimNodeReferenceConversionResult* Result);
	static void ConvertToMotionMatchingNodePure(struct FAnimNodeReference& Node, struct FMotionMatchingAnimNodeReference* MotionMatchingNode, bool* Result);
	static void GetMotionMatchingSearchResult(struct FMotionMatchingAnimNodeReference& MotionMatchingNode, struct FPoseSearchBlueprintResult* Result, bool* bIsResultValid);
	static void ResetDatabasesToSearch(struct FMotionMatchingAnimNodeReference& MotionMatchingNode, EPoseSearchInterruptMode InterruptMode);
	static void SetDatabasesToSearch(struct FMotionMatchingAnimNodeReference& MotionMatchingNode, TArray<class UPoseSearchDatabase*>& Databases, EPoseSearchInterruptMode InterruptMode);
	static void SetDatabaseToSearch(struct FMotionMatchingAnimNodeReference& MotionMatchingNode, class UPoseSearchDatabase* Database, EPoseSearchInterruptMode InterruptMode);
	static void SetInterruptMode(struct FMotionMatchingAnimNodeReference& MotionMatchingNode, EPoseSearchInterruptMode InterruptMode);
...
public:
	...
	uint8                                         Pad_3494[0x4];                                     // 0x0044(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3495[0x104];                                   // 0x0074(0x0104)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3496[0x10];                                    // 0x0028(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3497[0x3];                                     // 0x007D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3498[0x4];                                     // 0x0084(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3499[0x4];                                     // 0x0044(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_349A[0x6];                                     // 0x0072(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	struct FQuat BP_GetWorldRotation(class UAnimInstance* AnimInstance) const;
...
public:
	...
	uint8                                         Pad_349C[0x4];                                     // 0x0044(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_349D[0x6];                                     // 0x0052(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_349E[0x6];                                     // 0x006A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_349F[0x7];                                     // 0x0071(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	struct FVector BP_GetWorldPosition(class UAnimInstance* AnimInstance) const;
...
public:
	...
	uint8                                         Pad_34A0[0x8];                                     // 0x0048(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	float BP_GetTimeToEvent(class UAnimInstance* AnimInstance) const;
...
public:
	...
	uint8                                         Pad_34A2[0x5];                                     // 0x0073(0x0005)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	struct FVector BP_GetWorldVelocity(class UAnimInstance* AnimInstance) const;
...
{
public:
	static struct FPoseSearchHistoryCollectorAnimNodeReference ConvertToPoseHistoryNode(struct FAnimNodeReference& Node, EAnimNodeReferenceConversionResult* Result);
	static void ConvertToPoseHistoryNodePure(struct FAnimNodeReference& Node, struct FPoseSearchHistoryCollectorAnimNodeReference* PoseSearchHistoryCollectorNode, bool* Result);
	static void GetPoseHistoryNodeTrajectory(struct FPoseSearchHistoryCollectorAnimNodeReference& PoseSearchHistoryCollectorNode, struct FPoseSearchQueryTrajectory* Trajectory);
	static void SetPoseHistoryNodeTrajectory(struct FPoseSearchHistoryCollectorAnimNodeReference& PoseSearchHistoryCollectorNode, struct FPoseSearchQueryTrajectory& Trajectory);
...
public:
	class UAnimSequenceBase* GetSequence(class FName& Role) const;
...
public:
	...
	uint8                                         Pad_34A7[0x2];                                     // 0x007E(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	static void GetTrajectorySampleAtTime(struct FPoseSearchQueryTrajectory& InTrajectory, float Time, struct FPoseSearchQueryTrajectorySample* OutTrajectorySample, bool bExtrapolate);
	static void HandleTrajectoryWorldCollisions(class UObject* WorldContextObject, class UAnimInstance* AnimInstance, struct FPoseSearchQueryTrajectory& InTrajectory, bool bApplyGravity, float FloorCollisionsOffset, struct FPoseSearchQueryTrajectory* OutTrajectory, struct FPoseSearchTrajectory_WorldCollisionResults* CollisionResult, ETraceTypeQuery TraceChannel, bool bTraceComplex, TArray<class AActor*>& ActorsToIgnore, EDrawDebugTrace DrawDebugType, bool bIgnoreSelf, float MaxObstacleHeight, const struct FLinearColor& TraceColor, const struct FLinearColor& TraceHitColor, float DrawTime);
	static void PoseSearchGenerateTrajectory(class UAnimInstance* InAnimInstance, struct FPoseSearchTrajectoryData& InTrajectoryData, float InDeltaTime, struct FPoseSearchQueryTrajectory& InOutTrajectory, float& InOutDesiredControllerYawLastUpdate, struct FPoseSearchQueryTrajectory* OutTrajectory, float InHistorySamplingInterval, int32 InTrajectoryHistoryCount, float InPredictionSamplingInterval, int32 InTrajectoryPredictionCount);
...
public:
	...
	uint8                                         Pad_34B0[0x4];                                     // 0x0034(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	float                                         CostAddend;                                        // 0x0030(0x0004)(Edit, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_34B1[0x4];                                     // 0x0034(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	static void MotionMatch(class UAnimInstance* AnimInstance, const TArray<class UObject*>& AssetsToSearch, class FName PoseHistoryName, const struct FPoseSearchFutureProperties& Future, struct FPoseSearchBlueprintResult* Result, int32 DebugSessionUniqueIdentifier);
	static void MotionMatchMulti(const TArray<class ACharacter*>& AnimInstances, const TArray<class FName>& Roles, const TArray<class UObject*>& AssetsToSearch, class FName PoseHistoryName, struct FPoseSearchBlueprintResult* Result, int32 DebugSessionUniqueIdentifier);
