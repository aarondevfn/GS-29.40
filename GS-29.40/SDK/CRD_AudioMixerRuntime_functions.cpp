...
void ACreativeAudioMixerDevice::OnPlayerRegistered(class AFortPlayerState* PlayerState)
{
	static class UFunction* Func = nullptr;
...
void ACreativeAudioMixerDevice::OnPlayerUnregistered(class AFortPlayerState* PlayerState)
{
	static class UFunction* Func = nullptr;
