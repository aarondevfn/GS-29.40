...
void AMPItemShop_VaultWorld_C::TransitionBackgroundBackward(double Backward, double FXTransitionFade, class UMaterialInstanceDynamic* Mid, double CallFunc_Lerp_ReturnValue, double CallFunc_Lerp_ReturnValue_1, float CallFunc_SetScalarParameterValue_Value_ImplicitCast, float CallFunc_SetScalarParameterValue_Value_ImplicitCast_1)
{
	static class UFunction* Func = nullptr;
...
void AMPItemShop_VaultWorld_C::Set_Background_from_Child_Actor(class AFortStaticMeshActor* K2Node_DynamicCast_AsFort_Static_Mesh_Actor, bool K2Node_DynamicCast_bSuccess)
{
	static class UFunction* Func = nullptr;
	...
	Params::MPItemShop_VaultWorld_C_Set_Background_from_Child_Actor Parms{};
...
void AMPItemShop_VaultWorld_C::OnSetupTextureBackground(class UTexture2D* LoadedBackgroundTexture, struct FVaultWorldBackgroundData& BackgroundInfo)
{
	static class UFunction* Func = nullptr;
...
void AMPItemShop_VaultWorld_C::OnSetupMaterialBackground(class UMaterialInterface* LoadedBackgroundMaterial, struct FVaultWorldBackgroundData& BackgroundInfo)
{
	static class UFunction* Func = nullptr;
...
void AMPItemShop_VaultWorld_C::HandleMaterialBackground(class UMaterialInterface* MaterialBackground, class UTexture2D* Temp_object_Variable, class UTexture2D* Temp_object_Variable_1)
{
	static class UFunction* Func = nullptr;
...
void AMPItemShop_VaultWorld_C::AssignFloorMaterial(class UMaterialInterface* SourceMaterial, class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void AMPItemShop_VaultWorld_C::AssignBackgroundMaterial(class UMaterialInterface* SourceMaterial, class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue)
{
	static class UFunction* Func = nullptr;
