...
public:
	...
	uint8                                         Pad_1F15[0x78];                                    // 0x0040(0x0078)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1F1A[0x78];                                    // 0x0060(0x0078)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1F1F[0x238];                                   // 0x00A0(0x0238)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool HasValidEventState(class UScriptStruct* EventType, class UObject* Context) const;
...
{
public:
	uint8                                         Pad_1F25[0x158];                                   // 0x0030(0x0158)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	static void ClearEventStateBackwardCompatible(class UObject* WorldContextObject, const struct FEventMessageTag& Channel, class UGameplayEventRouterComponent* Target, class UScriptStruct* EventType);
	static void ClearEventStateByContextBackwardCompatible(class UObject* WorldContextObject, const struct FEventMessageTag& Channel, class UGameplayEventRouterComponent* Target, class UScriptStruct* EventType, class UObject* Context);
	static class UGameplayEventRouterComponent* GetEventRouter(class UClass* Scope, class AActor* ContextActor);
	static class UGameplayEventRouterComponent* GetGlobalEventRouter(class UObject* WorldContextObject);
	static bool K2_BroadcastEventBackwardCompatible(class UObject* WorldContextObject, class UGameplayEventRouterComponent* Target, const struct FEventMessageTag& Channel, int32& EventData, class UObject* EventContext);
	static bool K2_BroadcastStatefulEventBackwardCompatible(class UObject* WorldContextObject, class UGameplayEventRouterComponent* Target, const struct FEventMessageTag& Channel, int32& EventData, class UObject* EventContext);
