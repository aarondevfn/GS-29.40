...
void UFortEventMoreInfoGroup::OnIconLoaded(class UObject* Icon)
{
	static class UFunction* Func = nullptr;
...
void UFortEventRewardWidget::OnInputMethodChanged(ECommonInputType NewInputType)
{
	static class UFunction* Func = nullptr;
...
void UFortEventScreenBase::OnScreenViewChanged(EEventScreenView PrevScreenView, EEventScreenView NewScreenView)
{
	static class UFunction* Func = nullptr;
...
void UFortEventScreenBase::OnSetBonusInfo(struct FBonusInfoMiniTagData& BonusInfo)
{
	static class UFunction* Func = nullptr;
...
void UFortEventScreenTeaser::BP_SetCountdownTimeRemaining(struct FTimespan& TimeRemaining)
{
	static class UFunction* Func = nullptr;
...
void UFortEventScreenTeaser::HandleActiveSeasonDataChanged(TArray<class FString>& ActiveEventFlags)
{
	static class UFunction* Func = nullptr;
...
void UFortEventTrackerModule_EventDetails::UpdateEventTimeRemaining(class FText& EventTimeRemainingText, struct FTimespan& TimeRemaining)
{
	static class UFunction* Func = nullptr;
	...
	Parms.EventTimeRemainingText = EventTimeRemainingText;
	Parms.TimeRemaining = std::move(TimeRemaining);
