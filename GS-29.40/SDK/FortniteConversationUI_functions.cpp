...
const class FText UFortItemFundBrief::GetDataForKey(class FString& Key, bool bUseIndexAdjustment)
{
	static class UFunction* Func = nullptr;
...
void UFortQuestBrief::OnQuestInformationRecieved(class FText& Objective, struct FFortRarityItemData& RarityData, struct FGameplayTag& CategoryTag, int32 XPReward, int32 MoneyReward, int32 TokenReward, TSoftObjectPtr<class UTexture2D>& TokenRewardIcon)
{
	static class UFunction* Func = nullptr;
