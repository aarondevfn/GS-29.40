...
{
public:
	uint8                                         Pad_A91C[0x8];                                     // 0x0030(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_A91D[0x8];                                     // 0x1EA0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_A91E[0x88];                                    // 0x1FD8(0x0088)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_A91F[0x4];                                     // 0x207C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_A920[0x40];                                    // 0x2090(0x0040)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_A921[0x398];                                   // 0x2100(0x0398)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_A922[0x30];                                    // 0x24D8(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_A923[0x18];                                    // 0x2518(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_A924[0x8];                                     // 0x2558(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_A925[0xA0];                                    // 0x2578(0x00A0)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_A926[0x4];                                     // 0x26BC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_A927[0x4C];                                    // 0x26E4(0x004C)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void K2_OnActiveCameraUpdated();
	void PreviewItem(class UDelMarCosmeticItemDefinition* Item);
	void Func_PreviewLoadout(struct FDelMarLoadout& Loadout);
	void ResetPreviewToCurrentLoadout();
	void SetPreviewSlot(struct FGameplayTag& InSlot);
	void SetUserRotationOffset(struct FRotator& InRotationOffset);
...
public:
	...
	uint8                                         Pad_A928[0xB];                                     // 0x09D5(0x000B)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_A929[0x4];                                     // 0x02D8(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_A92A[0x50];                                    // 0x0328(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_A92B[0x8];                                     // 0x03D8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_A92C[0x4];                                     // 0x0404(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_A92D[0x4];                                     // 0x0464(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_A92E[0xA0];                                    // 0x04C0(0x00A0)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	void AddBoosterActivationFlags(EDelMarVehicleBoosterFlags Param_Flags, class FName Param_Name);
	...
	void RemoveBoosterActivationFlags(class FName Param_Name);

	TArray<class UNiagaraComponent*> GetBoosters(EDelMarVehicleBoosterFlags Param_Flags) const;
...
public:
	...
	uint8                                         Pad_A934[0x4];                                     // 0x0464(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_A935[0x3];                                     // 0x04F5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_A936[0x2];                                     // 0x0502(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_A937[0x12C];                                   // 0x0574(0x012C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_A938[0x1C];                                    // 0x0458(0x001C)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_A939[0x38];                                    // 0x00A0(0x0038)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	void HandleBotControllerLoadoutChanged(class ADelMarAIController* AIController, struct FFortAthenaLoadout& Loadout);
	void HandlePlayerControllerLoadoutChanged(struct FCosmeticLoadout& Loadout);
...
public:
	...
	class UNiagaraComponent* GetBoosterBySocketName(class FName& SocketName) const;
...
public:
	...
	uint8                                         Pad_A93F[0x3];                                     // 0x02DD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_A940[0x20];                                    // 0x02F0(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_A941[0x8];                                     // 0x02E8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_A942[0x98];                                    // 0x0310(0x0098)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void BP_UpdateWheelContactFx(struct FDelMarVehicleCosmeticWheelInfo& WheelInfo, bool bActive, float AbsForwardSpeed, float AbsSideSpeed);
...
public:
	...
	uint8                                         Pad_A947[0x3];                                     // 0x002D(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_A948[0x7];                                     // 0x02C9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
