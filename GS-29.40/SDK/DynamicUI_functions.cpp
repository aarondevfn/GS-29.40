...
void UDynamicUIManager::AddScenes(TArray<class UDynamicUIScene*>& Scenes, class APlayerController*& Player)
{
	static class UFunction* Func = nullptr;
...
void UDynamicUIManager::RemoveScenes(TArray<class UDynamicUIScene*>& Scenes, class APlayerController*& Player)
{
	static class UFunction* Func = nullptr;
...
bool UDynamicUIManager::IsSceneActive(class UDynamicUIScene* Scene, class APlayerController*& Player) const
{
	static class UFunction* Func = nullptr;
...
bool UDynamicUIManager::IsSceneActiveOnFirstLocalPlayer(class UDynamicUIScene* Scene) const
{
	static class UFunction* Func = nullptr;
