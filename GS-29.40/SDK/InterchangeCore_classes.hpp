...
public:
	...
	uint8                                         Pad_B2F8[0x18];                                    // 0x0038(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_B2FA[0x18];                                    // 0x0028(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_B2FB[0x70];                                    // 0x0098(0x0070)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void ScriptedExecutePipeline(class UInterchangeBaseNodeContainer* BaseNodeContainer, TArray<class UInterchangeSourceData*>& SourceDatas, const class FString& ContentBasePath);
...
{
public:
	uint8                                         Pad_B300[0x28];                                    // 0x0028(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_B301[0x38];                                    // 0x0028(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_B319[0x50];                                    // 0x0078(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_B31E[0xE0];                                    // 0x0060(0x00E0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_B326[0x70];                                    // 0x0060(0x0070)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	static bool CreateUserDefinedAttribute_Boolean(class UInterchangeBaseNode* InterchangeNode, const class FString& UserDefinedAttributeName, bool& Value, const class FString& PayloadKey, bool RequiresDelegate);
	static bool CreateUserDefinedAttribute_Double(class UInterchangeBaseNode* InterchangeNode, const class FString& UserDefinedAttributeName, double& Value, const class FString& PayloadKey, bool RequiresDelegate);
	static bool CreateUserDefinedAttribute_Float(class UInterchangeBaseNode* InterchangeNode, const class FString& UserDefinedAttributeName, float& Value, const class FString& PayloadKey, bool RequiresDelegate);
	...
	static bool CreateUserDefinedAttribute_Int32(class UInterchangeBaseNode* InterchangeNode, const class FString& UserDefinedAttributeName, int32& Value, const class FString& PayloadKey, bool RequiresDelegate);
