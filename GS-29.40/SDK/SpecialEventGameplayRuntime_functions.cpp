...
struct FVector UFortControllerComponent_FakeKillRelevancy::GetDeathLocation(class AFortPlayerStateAthena* PlayerState) const
{
	static class UFunction* Func = nullptr;
...
void UFortCheatManager_SpecialEvent::StartEventScript(int32 InStartingIndex, float SequenceTimeOffset)
{
	static class UFunction* Func = nullptr;
...
void UFortCharacterMovementMutatorComponent::SetBuffetBubblesInitialFollowBoxOffsetPercent(struct FVector& BoxOffsetPercent)
{
	static class UFunction* Func = nullptr;
...
void UFortControllerComponent_SpecialEvent::SendSpecialClientEvent(struct FGameplayTag& EventTag, int32 Count)
{
	static class UFunction* Func = nullptr;
...
bool ISpecialEventCursorInstigatorInterface::SpecialEventCursorTrace(struct FHitResult* OutHitResult, class USpecialEventCursorPawnComponent* CursorPawnComponent, struct FGameplayTag& CursorModeTag, class UCameraComponent* CameraComponent, struct FVector& CursorWorldDirection)
{
	static class UFunction* Func = nullptr;
...
bool USpecialEventCursorPawnComponent::ConvertNormalizedToViewportLocation(struct FVector2D* OutViewportLocation, struct FVector2D& NormalizedLocation) const
{
	static class UFunction* Func = nullptr;
...
bool USpecialEventCursorPawnComponent::ConvertNormalizedToWorldLocationAndDirection(struct FVector* OutWorldLocation, struct FVector* OutWorldDirection, struct FVector2D& NormalizedLocation) const
{
	static class UFunction* Func = nullptr;
...
bool USpecialEventCursorPawnComponent::ConvertViewportToNormalizedLocation(struct FVector2D* OutNormalizedLocation, struct FVector2D& ViewportLocation) const
{
	static class UFunction* Func = nullptr;
...
bool USpecialEventCursorPawnComponent::ConvertViewportToWorldLocationAndDirection(struct FVector* OutWorldLocation, struct FVector* OutWorldDirection, struct FVector2D& ViewportLocation) const
{
	static class UFunction* Func = nullptr;
...
bool USpecialEventCursorPawnComponent::ConvertWorldToNormalizedLocation(struct FVector2D* OutNormalizedLocation, struct FVector& WorldLocation) const
{
	static class UFunction* Func = nullptr;
...
bool USpecialEventCursorPawnComponent::ConvertWorldToViewportLocation(struct FVector2D* OutViewportLocation, struct FVector& WorldLocation) const
{
	static class UFunction* Func = nullptr;
...
struct FVector2D USpecialEventCursorPawnComponent::GetCenteredWidgetLocation(class UUserWidget* Widget, struct FVector2D& ViewportLocation) const
{
	static class UFunction* Func = nullptr;
...
struct FGameplayTagContainer USpecialEventCursorPawnComponent::GetCursorModeTagsForWidget(class UUserWidget* Widget) const
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class AFortPlayerPawn*                  Param_Pawn                                             (ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class USpecialEventCursorWeaponComponent* USpecialEventCursorWeaponComponent::GetCurrentSpecialEventCursorWeaponComponent(class AFortPlayerPawn* Param_Pawn)
{
	static class UFunction* Func = nullptr;
...
class USpecialEventCursorPawnComponent* USpecialEventCursorWeaponComponent::GetSpecialEventCursorPawnComponentForCurrentWeapon(class AFortPlayerPawn* Param_Pawn)
{
	static class UFunction* Func = nullptr;
...
void USpecialEventCursorWeaponComponent::OnGetAimRotOverride(class AFortWeapon* Weapon, EFortAbilityTargetingSource TargetingSource, struct FRotator* OutOverride, bool* bOutExecutionResult)
{
	static class UFunction* Func = nullptr;
...
void USpecialEventGameplayLibrary::AddSpecialEventKillFeedEntry(class UObject* WorldContextObject, class AFortPlayerStateAthena* VictimPlayerState, class AFortPlayerStateAthena* KillerPlayerState, class FText NonPlayerVictimName, class FText NonPlayerKillerName, struct FGameplayTag& DeathCauseTag, EDeathCauseReason DeathCauseReason, float Distance)
{
	static class UFunction* Func = nullptr;
...
bool USpecialEventGameplayLibrary::AttachPawnToComponent(class AFortPawn* Pawn, class USceneComponent* Component, class FName SocketName, EAttachmentRule LocationRule, EAttachmentRule RotationRule, EAttachmentRule ScaleRule, bool bWeldSimulatedBodies)
{
	static class UFunction* Func = nullptr;
...
bool USpecialEventGameplayLibrary::DetachPawn(class AFortPawn* Pawn, EDetachmentRule LocationRule, EDetachmentRule RotationRule, EDetachmentRule ScaleRule)
{
	static class UFunction* Func = nullptr;
...
bool USpecialEventGameplayLibrary::DetachPawnFromComponent(class AFortPawn* Pawn, class USceneComponent* Component, EDetachmentRule LocationRule, EDetachmentRule RotationRule, EDetachmentRule ScaleRule)
{
	static class UFunction* Func = nullptr;
...
void USpecialEventGameplayLibrary::ForceUpdateGrass(class UObject* WorldContextObject, struct FVector& Location)
{
	static class UFunction* Func = nullptr;
...
void ASpecialEventScript::StartEventAtIndex(int32 InStartingIndex, float SequenceTimeOffset)
{
	static class UFunction* Func = nullptr;
...
void ASpecialEventScript::SetLocalPlayersSignificantForSpecialEventSequence(bool bIsSignificant) const
{
	static class UFunction* Func = nullptr;
...
void USpecialEventStatComponent::AdjustSpecialEventStat(class AActor* Actor, struct FGameplayTag& LookupTag, float Adjustment)
{
	static class UFunction* Func = nullptr;
...
const struct FSpecialEventStatArrayEntry USpecialEventStatComponent::GetSpecialEventStat(bool* bOutValid, class AActor* Actor, struct FGameplayTag& LookupTag)
{
	static class UFunction* Func = nullptr;
...
bool USpecialEventStatComponent::AdjustStat(struct FGameplayTag& LookupTag, float Adjustment, bool bLogError)
{
	static class UFunction* Func = nullptr;
...
const struct FSpecialEventStatArrayEntry USpecialEventStatComponent::GetStat(bool* bOutValid, struct FGameplayTag& LookupTag)
{
	static class UFunction* Func = nullptr;
...
float USpecialRelevancyHealthComponent::GetHealth(class AActor* RelevancyActor) const
{
	static class UFunction* Func = nullptr;
...
float USpecialRelevancyHealthComponent::GetHealthFromRelevancyIndex(int32 Param_Index) const
{
	static class UFunction* Func = nullptr;
...
float USpecialRelevancyHealthComponent::GetHealthPercent(class AActor* RelevancyActor) const
{
	static class UFunction* Func = nullptr;
...
float USpecialRelevancyHealthComponent::GetHealthPercentFromRelevancyIndex(int32 Param_Index) const
{
	static class UFunction* Func = nullptr;
