...
struct FFMontageBeatSyncInfo UBeatSyncedAnimLibrary::CalculateMontageBeatSyncInfo(class UMusicClockComponent* MusicClock, class UAnimMontage* Montage, float LengthInBeats, float MsOffset)
{
...
float UBeatSyncedAnimLibrary::CalculateMontagePlayRate(class UMusicClockComponent* MusicClock, class UAnimMontage* Montage, float MontageBeatLength)
{
	static class UFunction* Func = nullptr;
...
class UFortItemDefinition* UBeatSyncedAnimLibrary::GetLastEmoteExecuted(class AController* Controller)
{
	static class UFunction* Func = nullptr;
...
float UFMBeatTimingUtils::GetCurrentBeat(class UMusicClockComponent* InMusicClock, bool bRounded)
{
	static class UFunction* Func = nullptr;
...
float UFMBeatTimingUtils::GetCurrentBeat_Unsafe(class UMusicClockComponent* InMusicClock, bool bRounded)
{
	static class UFunction* Func = nullptr;
...
struct FBeatAndTime UFMBeatTimingUtils::GetCurrentBeatAndTime(class UMusicClockComponent* MusicClock, class UObject* WorldContext, bool bAlwaysAllowPreviewBPM, float PreviewBPM, bool bForceUnsafe)
{
	static class UFunction* Func = nullptr;
...
float UFMBeatTimingUtils::GetCurrentBeatForBPM(float InBPM, class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
...
float UFMBeatTimingUtils::GetCurrentSongTime(class UMusicClockComponent* InMusicClock, bool bRounded)
{
	static class UFunction* Func = nullptr;
...
float UFMBeatTimingUtils::GetCurrentSongTime_Unsafe(class UMusicClockComponent* InMusicClock, bool bRounded)
{
	static class UFunction* Func = nullptr;
...
const class UPreciseBeatSyncedAnimMetaData* UMontageBeatSyncComponent::LookupMontageTimingInfo_BP(class UAnimMontage* Montage, class AFortPlayerPawn* PlayerPawn)
{
	static class UFunction* Func = nullptr;
