...
bool UMusicSequencerHitComponent::RegisterMusicSequencerActor(class UObject* WorldContextObject, TScriptInterface<class IFortMusicSequencerInterface> Actor)
{
...
bool UMusicSequencerHitComponent::ReplicateMusicSequencerHit(class UObject* WorldContextObject, TScriptInterface<class IFortMusicSequencerInterface> HitInterface, class AController* Instigator)
{
	static class UFunction* Func = nullptr;
...
bool UMusicSequencerHitComponent::AddSequenceHitEvent(TScriptInterface<class IFortMusicSequencerInterface> HitInterface, class AController* Instigator)
{
	static class UFunction* Func = nullptr;
