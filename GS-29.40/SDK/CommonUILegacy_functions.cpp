...
void UCommonActivatablePanelLegacy::SetActionHandlerState(class UDataTable* DataTable, class FName RowName, EInputActionState State)
{
	static class UFunction* Func = nullptr;
...
bool UCommonInputManagerLegacy::StartListeningForExistingHeldAction(struct FDataTableRowHandle& InputActionDataRow, TDelegate<void()>& CompleteEvent, TDelegate<void(float HeldPercent)>& ProgressEvent)
{
	static class UFunction* Func = nullptr;
...
bool UCommonInputManagerLegacy::StopListeningForExistingHeldAction(struct FDataTableRowHandle& InputActionDataRow, TDelegate<void()>& CompleteEvent, TDelegate<void(float HeldPercent)>& ProgressEvent)
{
	static class UFunction* Func = nullptr;
...
bool UCommonInputManagerLegacy::IsPanelOnStack(class UCommonActivatablePanelLegacy* InPanel) const
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class UObject*                          Param_ContextProvidingObject                           (ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UCommonPopupMenuLegacy::SetContextProvider(class UObject* Param_ContextProvidingObject)
{
	static class UFunction* Func = nullptr;
...
void UCommonTabListWidgetLegacy::OnTabButtonCreated__DelegateSignature(class FName TabID, class UCommonButtonLegacy* TabButton)
{
	...
	Params::CommonTabListWidgetLegacy_OnTabButtonCreated__DelegateSignature Parms{};
...
void UCommonTabListWidgetLegacy::OnTabButtonRemoved__DelegateSignature(class FName TabID, class UCommonButtonLegacy* TabButton)
{
	...
	Params::CommonTabListWidgetLegacy_OnTabButtonRemoved__DelegateSignature Parms{};
...
void UCommonUISubsystemLegacy::InputSuspensionChanged__DelegateSignature(bool bInputSuspended)
{
	...
	Params::CommonUISubsystemLegacy_InputSuspensionChanged__DelegateSignature Parms{};
...
void UCommonWidgetStackLegacy::OnActiveWidgetChangedLegacy__DelegateSignature(class UWidget* InActiveWidget, int32 InActiveWidgetIndex)
{
	...
	Params::CommonWidgetStackLegacy_OnActiveWidgetChangedLegacy__DelegateSignature Parms{};
...
void UCommonWidgetSwitcherLegacy::SetActiveWidgetIndex_Advanced(int32 Param_Index, bool AttemptActivationChange)
{
	static class UFunction* Func = nullptr;
...
class UCommonButtonLegacy* UCommonButtonGroupLegacy::GetButtonAtIndex(int32 Param_Index) const
{
	static class UFunction* Func = nullptr;
