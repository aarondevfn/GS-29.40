...
bool UInterchangeFilePickerBase::ScriptedFilePickerForTranslatorAssetType(EInterchangeTranslatorAssetType TranslatorAssetType, struct FInterchangeFilePickerParameters* Parameters, TArray<class FString>* OutFilenames)
{
...
bool UInterchangeFilePickerBase::ScriptedFilePickerForTranslatorType(EInterchangeTranslatorType TranslatorType, struct FInterchangeFilePickerParameters* Parameters, TArray<class FString>* OutFilenames)
{
	static class UFunction* Func = nullptr;
...
const class UClass* UInterchangeManager::GetRegisteredFactoryClass(class UClass* ClassToMake) const
{
	static class UFunction* Func = nullptr;
...
void UInterchangeAssetImportData::SetPipelines(TArray<class UObject*>& InPipelines) const
{
	static class UFunction* Func = nullptr;
