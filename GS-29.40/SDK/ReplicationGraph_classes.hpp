...
public:
	...
	uint8                                         Pad_31C8[0x40];                                    // 0x0058(0x0040)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_31C9[0x4B0];                                   // 0x00B8(0x04B0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_31CA[0x8];                                     // 0x0598(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_31CB[0x18];                                    // 0x0038(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_31CC[0x80];                                    // 0x0050(0x0080)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_31CD[0xB8];                                    // 0x0050(0x00B8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_31CE[0x30];                                    // 0x00D0(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_31CF[0x80];                                    // 0x00D0(0x0080)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_31D0[0x10];                                    // 0x00D0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_31D1[0x40];                                    // 0x00D0(0x0040)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_31D2[0x230];                                   // 0x0050(0x0230)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_31D3[0x10];                                    // 0x0058(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_31D4[0x10];                                    // 0x00D0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FAlwaysRelevantActorInfo>       PastRelevantActors;                                // 0x00E0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_31D5[0x50];                                    // 0x00F0(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_31D6[0x10];                                    // 0x0060(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_31D7[0x144];                                   // 0x0030(0x0144)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_31D8[0x4];                                     // 0x017C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FLastLocationGatherInfo>        LastGatherLocations;                               // 0x0180(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_31D9[0xB0];                                    // 0x0190(0x00B0)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_31DA[0x120];                                   // 0x0258(0x0120)(Fixing Struct Size After Last Property [ Dumper-7 ])
