...
void ICrewScreenContentBlockingInterface::BlockScreenContent(bool bBlockScreen, class FText& ContentBlockedText)
{
...
class FText UFortTemporaryItemsRow::GetCategoryText(EAthenaCustomizationCategory InCategory) const
{
	static class UFunction* Func = nullptr;
...
void UFortTemporaryItemsScreenItemInfo::SetData(class UFortSubscriptionVM* SubscriptionVM, class UFortTemporaryItemsRewardVM* RewardVM)
{
	static class UFunction* Func = nullptr;
...
void UFortTemporaryItemsTileButton::SetupRewardItem(class UFortAccountItemDefinition* ItemDef)
{
	static class UFunction* Func = nullptr;
...
void UCrewPurchaseScreen::OnUserInformationTextsUpdated(class FText& UserInformationText1, class FText& UserInformationText2, EMcpSubscriptionState SubscriptionState)
{
	static class UFunction* Func = nullptr;
...
void UFortTemporaryItemsScreen::BP_OnContainerTabVisibilityUpdated(bool bTabsVisible, float SpacingAdjustmentForTabs)
{
	static class UFunction* Func = nullptr;
...
class FText UFortTemporaryItemsScreen::GetRemainingDaysLabel(class UFortTemporaryItemsVM* TemporaryItemsVM) const
{
	static class UFunction* Func = nullptr;
