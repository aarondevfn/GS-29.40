...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// float                                   Param_PlayRate                                         (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void ACinematicSequenceDeviceBase::SetPlayRate(float Param_PlayRate)
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class ULevelSequence*                   Param_Sequence                                         (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void ACinematicSequenceDeviceBase::SetSequence(class ULevelSequence* Param_Sequence)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_Sequence = Param_Sequence;
