...
// TDelegate<void(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon)>K2Node_CreateDelegate_OutputDelegate_1                 (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// TDelegate<void(class AFortPlayerPawn* Pawn)>K2Node_CreateDelegate_OutputDelegate_3                 (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void AGCN_Loop_Shadow_Bomb_C::UnbindEquippedWeapon(TDelegate<void(class AFortWeapon* NewWeapon, class AFortWeapon* PrevWeapon)> K2Node_CreateDelegate_OutputDelegate, bool CallFunc_IsValid_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::GCN_Loop_Shadow_Bomb_C_UnbindEquippedWeapon Parms{};
