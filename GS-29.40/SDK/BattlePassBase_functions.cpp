...
void UFortBattlePassCustomSkinCategoryTile::FocusTile(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
void UFortBattlePassCustomSkinCategoryTile::SetPreviewedTile(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
class FText UFortBattlePassContext::GetCurrentChapterAsText(bool bFullText) const
{
	static class UFunction* Func = nullptr;
...
class FText UFortBattlePassContext::GetCurrentSeasonNumberAsText(bool bFullText) const
{
	static class UFunction* Func = nullptr;
...
void UFortBattlePassDynamicIcon::OnBattlePassInfoUpdated(bool bOwnsBattlePass) const
{
	static class UFunction* Func = nullptr;
...
void UFortBattlePassRewardGridHeader::OnSetPageType(ERewardPageType PageType)
{
	static class UFunction* Func = nullptr;
...
void UFortBattlePassTileBase::OnStateChanged(EBattlePassTileAvailabilityStates NewState)
{
	static class UFunction* Func = nullptr;
...
void UFortBattlePassTileBase::SetSize(EPageItemTileSize TileSize, struct FVector2D& CellSpacing)
{
	static class UFunction* Func = nullptr;
...
void UFortBattlePassTileBase::SetState(EBattlePassTileAvailabilityStates NewState)
{
	static class UFunction* Func = nullptr;
...
void UFortBattlePassTile::OnSetCurrencyAndPrice(EBattlePassCurrencyType Currency, int32 Price)
{
	static class UFunction* Func = nullptr;
