...
// Parameters:
// struct FMcpVariantChannelInfo           InChannelInfo                                          (ConstParm, Parm, OutParm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UFortVariantRedirectorTile::OnVariantChangedEvent__DelegateSignature(struct FMcpVariantChannelInfo& InChannelInfo)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortVariantRedirectorTile", "OnVariantChangedEvent__DelegateSignature");

	Params::FortVariantRedirectorTile_OnVariantChangedEvent__DelegateSignature Parms{};

	Parms.InChannelInfo = std::move(InChannelInfo);
