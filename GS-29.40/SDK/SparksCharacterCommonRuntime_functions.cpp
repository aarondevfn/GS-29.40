...
// Parameters:
// TSoftObjectPtr<class UAnimSequence>     NewLipSyncAsset                                        (ConstParm, Parm, OutParm, ReferenceParm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void USparksInstrumentAnimInstance::BP_OnLipSyncAssetChanged(TSoftObjectPtr<class UAnimSequence>& NewLipSyncAsset)
{
	static class UFunction* Func = nullptr;
...
void USparksInstrumentAnimInstance::BP_OnMidiEventDriverChanged(TScriptInterface<class IMidiEventDriverInterface>& NewMidiEventDriver)
{
	static class UFunction* Func = nullptr;
...
int32 USparksGuitarAnimInstance::GetFretNumberFromMidiNote(uint8 MidiNote)
{
	static class UFunction* Func = nullptr;
