...
void ULimePawnComponent_EmotionalState::HandleLimeAwesomeLevelChanged(int32 NewAwesomeLevel)
{
	static class UFunction* Func = nullptr;
...
void ULimePawnComponent_EmotionalState::SetCurrentEmotionalState(ELimePawnEmotionalState NewEmotion)
{
	static class UFunction* Func = nullptr;
...
void ULimePawnComponent_EmotionalState::SetEmotionalState(struct FLimeEmotionalStateData& Emotion)
{
	static class UFunction* Func = nullptr;
