...
void UCraftingObjectComponent::OnRep_CraftingObjectRepStateData(struct FCraftingObjectRepStateData& OldValue)
{
	static class UFunction* Func = nullptr;
...
void UFortControllerComponent_CraftingNetworkEvents::ClientNotifyCraftingSuccess(class AActor* CraftingObject, class FName& FormulaRowName, TArray<struct FFortItemEntry>& ConsumedIngredients, const struct FCraftingMultiKey& Key)
{
	static class UFunction* Func = nullptr;
...
void UFortControllerComponent_CraftingNetworkEvents::NotifyCraftingSuccess(class AActor* CraftingObject, class FName& FormulaRowName, TArray<struct FFortItemEntry>& ConsumedIngredients, const struct FCraftingMultiKey& Key)
{
	static class UFunction* Func = nullptr;
...
void UFortControllerComponent_CraftingNetworkEvents::ServerStartCrafting(class AActor* CraftingObject, class FName& CraftingFormulaName, int32 NumberToCraft, const struct FCraftingMultiKey& Key, float OverriddenObjectStateLength)
{
	static class UFunction* Func = nullptr;
...
bool UCraftingLibrary::CanCraftFormula(class AFortPlayerController* FortPC, class AActor* CraftingObject, class FName CraftingFormulaRow, TArray<struct FCraftingIngredientQueryState>* OutIngredientStates, int32 NumberToCraft, struct FGameplayTagContainer& InInventoryGroups)
{
	static class UFunction* Func = nullptr;
...
bool UCraftingLibrary::CanCraftFormulaWithAdditionalItems(class AFortPlayerController* FortPC, class AActor* CraftingObject, class FName CraftingFormulaRow, TArray<struct FItemAndCount>& AdditionalItems, TArray<struct FCraftingIngredientQueryState>* OutIngredientStates, int32 NumberToCraft, struct FGameplayTagContainer& InInventoryGroups)
{
	static class UFunction* Func = nullptr;
...
void UCraftingLibrary::GetCraftingFormulasForCraftingObject(class AActor* CraftingObject, TArray<class FName>* OutFormulas)
{
	static class UFunction* Func = nullptr;
...
void UCraftingLibrary::GetUIDataForCraftingIngredientTags(class UObject* WorldContextObject, struct FGameplayTagContainer& IngredientTags, TArray<TSoftObjectPtr<class UItemDefinitionBase>>* OutItemDefs, TArray<TSoftObjectPtr<class UObject>>* OutIcons)
{
	static class UFunction* Func = nullptr;
...
bool UCraftingLibrary::IsFreeCraftingEnabled(class AActor* CraftingObject)
{
	static class UFunction* Func = nullptr;
...
bool UCraftingLibrary::IsValidIngredient(class AFortPlayerController* FortPC, class AActor* CraftingObject, class UItemDefinitionBase* ItemDef)
{
	static class UFunction* Func = nullptr;
...
void UCraftingLibrary::StartCrafting(class AFortPlayerController* Instigator, class AActor* CraftingObject, class FName& CraftingFormulaName, int32 NumberToCraft, const struct FCraftingMultiKey& Key, float OverriddenCraftingLength)
{
	static class UFunction* Func = nullptr;
