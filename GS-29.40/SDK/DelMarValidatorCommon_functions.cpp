...
void UDelMarWorldValidator_Task::AddError(class FText& Msg)
{
...
void UDelMarWorldValidator_Task::AddErrorTokenized(class UObject* InAsset, class FText& Msg)
{
	static class UFunction* Func = nullptr;
...
void UDelMarWorldValidator_Task::AddWarning(class FText& Msg)
{
	static class UFunction* Func = nullptr;
...
void UDelMarWorldValidator_Task::AddWarningTokenized(class UObject* InAsset, class FText& Msg)
{
	static class UFunction* Func = nullptr;
