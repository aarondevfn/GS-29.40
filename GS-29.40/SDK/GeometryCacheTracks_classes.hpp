...
{
public:
	struct FMovieSceneGeometryCacheParams         Params;                                            // 0x00F0(0x0040)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                         Pad_333F[0x8];                                     // 0x0098(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
