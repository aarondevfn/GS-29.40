...
void UFortMovementMode_ExtClambering::BP_GetAnimationMontageInformation(struct FClamberMontageInput& Context, class UAnimMontage** AnimMontage, class FName* StartSectionName, class FName* MontageMiddleSectionName)
{
...
void AInstancedLedgeActor::BP_OnAddInstance(struct FTransform& LedgeTransform, int32 InstanceIndex)
{
	static class UFunction* Func = nullptr;
...
void AInstancedLedgeActor::BP_OnRemoveInstance(struct FTransform& LedgeTransform, int32 InstanceIndex)
{
	static class UFunction* Func = nullptr;
...
void ULedgeLaunchWorldSubsystem::OnWallDied(float Damage, struct FGameplayTagContainer& DamageTags, const struct FVector& Momentum, struct FHitResult& HitInfo, class AFortPawn* InstigatedBy, class AActor* DamageCauser, const struct FGameplayEffectContextHandle& EffectContext)
{
	static class UFunction* Func = nullptr;
...
void UClamberingComponent::BP_HandleClamberingStateChanged(EClamberingState OldClamberingState, EClamberingState NewClamberingState)
{
	static class UFunction* Func = nullptr;
...
void UClamberingComponent::ServerStartClambering(struct FReplicatedClamberingTargetingData& InReplicatedTargetingData, double ClientLastTeleportTime)
{
	static class UFunction* Func = nullptr;
...
void UClamberingComponent::BP_IsValidTargetActor(class AActor* TargetActor, bool* bIsValidTargetActor) const
{
	static class UFunction* Func = nullptr;
