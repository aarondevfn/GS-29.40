...
void UBeatmatchCalibrationHelper::CalcCalibrationResult(TArray<float>& Samples, TArray<float>& SamplesDeltaTimes, float BPS, ECalibrationState* ResultingState, float* ResultMs)
{
