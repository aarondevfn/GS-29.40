...
public:
	...
	uint8                                         Pad_9317[0x3];                                     // 0x0165(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_9318[0x10];                                    // 0x0030(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFortCurieVoxelFirePropagationManagerTickFunction PrimaryTickFunction;                               // 0x0040(0x0030)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_9319[0x5F8];                                   // 0x0070(0x05F8)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_931A[0x10];                                    // 0x0670(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_931B[0x7];                                     // 0x01A9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_931C[0x30];                                    // 0x0040(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_931D[0x50];                                    // 0x0110(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_931E[0x60];                                    // 0x01F8(0x0060)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_931F[0x50];                                    // 0x02F8(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
