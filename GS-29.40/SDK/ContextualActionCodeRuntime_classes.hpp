...
{
public:
	uint8                                         Pad_9169[0x8];                                     // 0x0120(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_916A[0x4];                                     // 0x0154(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_916B[0x7];                                     // 0x0189(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_916C[0xC];                                     // 0x0184(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_916D[0x1C];                                    // 0x0494(0x001C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_916E[0x2];                                     // 0x0986(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_916F[0x3];                                     // 0x09A1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9170[0x3];                                     // 0x09AD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9171[0x4];                                     // 0x09B4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9172[0x10];                                    // 0x09C0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_9173[0x24];                                    // 0x09E4(0x0024)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_9174[0x5F];                                    // 0x0131(0x005F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void EjectHijacker(class AActor* DamageCauser, float Damage, struct FVector& EventLocation);
	void HandleOwnerJumpInput(bool bPressed);
	void OnCompleteHijack();
	void OnStartHijack(class AActor* VehicleTarget);
	bool TryHijack(class AActor* VehicleTarget, struct FInteractionType& InteractionType);

	void BP_CanCompleteHijack(bool* OutCanCompleteHijack) const;
	void BP_CanStartHijack(bool* OutCanStartHijack) const;
	void BP_GetThrownVelocity(class AActor* DamageCauser, float Damage, struct FVector& EventLocation, struct FVector* OutVelocity) const;
...
public:
	...
	uint8                                         Pad_9178[0x7];                                     // 0x0839(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_9179[0x20];                                    // 0x0878(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void EndRappelling();
	void EndRappelling_Server();
	void EndRappellingSwing_Server();
	void OnCapsuleHit(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, struct FVector& NormalImpulse, struct FHitResult& Hit);
	...
	void StartRappelling_Server(struct FVector& NewGravityDirection, struct FVector& ClientRappellingEdge, struct FVector& ClientRappellingNormal);
...
public:
	...
	uint8                                         Pad_917B[0x14];                                    // 0x1CEC(0x0014)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_917C[0x3];                                     // 0x00E1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_917D[0x3C];                                    // 0x00EC(0x003C)(Fixing Struct Size After Last Property [ Dumper-7 ])
