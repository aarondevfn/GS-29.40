...
public:
	...
	uint8                                         Pad_939A[0x8];                                     // 0x01C8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static struct FVector CalculateSquadAvgLocation(uint8 SquadID, class UObject* WorldContextObject);
...
public:
	...
	uint8                                         Pad_939C[0x7];                                     // 0x01F9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
