...
public:
	...
	struct FGameplayTag                           TC_AbilitiesGenericActiveAbilityActivate;          // 0x0B50(0x0004)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	class FName                                   N_SavedCollisionChannel;                           // 0x0B54(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          bPlayerHolsterState;                               // 0x0B68(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_C211[0x3];                                     // 0x0B69(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTag                           TC_AbilitiesGenericActiveAbilityEndAbility;        // 0x0B6C(0x0004)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
