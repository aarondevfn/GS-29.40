...
bool AAttachableWheel::AttachTo(class UPrimitiveComponent* InComponent, struct FVector& WorldLocation, struct FVector& AxleDirection, const struct FVector& SteerAxis)
{
	static class UFunction* Func = nullptr;
...
void AAttachableWheel::OnRep_RuntimeData(struct FAttachableWheelRuntimeData& RuntimeDataPrev)
{
	static class UFunction* Func = nullptr;
...
bool AAttachableWheel::GetWorldSpaceAttachData(struct FAttachableWheelAttachData* OutAttachData, class UPrimitiveComponent* PrimitiveComponent, class FName BodyName) const
{
	static class UFunction* Func = nullptr;
...
class AAttachableWheel* UAttachableWheelsComponent::GetAttachedWheelClosestOnAxis(struct FVector& Point, float* OutClosetDistanceToAxis, struct FVector* OutClosestPointOnAxis, struct FVector* OutClosestAxis) const
{
	static class UFunction* Func = nullptr;
