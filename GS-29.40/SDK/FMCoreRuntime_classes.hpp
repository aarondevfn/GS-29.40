...
public:
	...
	uint8                                         Pad_8AF3[0x2];                                     // 0x00F2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8AF4[0x2];                                     // 0x0106(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8AF5[0x2];                                     // 0x011A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_8AF6[0x4];                                     // 0x012C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void OnKeyChanged__DelegateSignature(EMusicKey Param_CurrentKey);
	void OnModeChanged__DelegateSignature(EMusicKeyMode Param_CurrentMode);
	...
	void OnSpeedChanged__DelegateSignature(float Param_CurrentSpeed);
	void OnTempoChanged__DelegateSignature(int32 Param_CurrentTempo);
