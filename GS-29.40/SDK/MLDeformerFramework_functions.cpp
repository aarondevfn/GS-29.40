...
class USkeletalMeshComponent* UMLDeformerComponent::FindSkeletalMeshComponent(class UMLDeformerAsset* Asset) const
{
	static class UFunction* Func = nullptr;
...
void UMLDeformerMorphModel::SetMorphTargetsMinMaxWeights(TArray<float>& MinValues, TArray<float>& MaxValues)
{
	static class UFunction* Func = nullptr;
