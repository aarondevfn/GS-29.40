...
void UFortMobilePlayerAugmentTimer::BP_OnHUDElementVisibilityChanged(struct FGameplayTagContainer& HiddenElementTagContainer, bool bIsSelectionItemEquipped, bool bForceCollapse)
{
	static class UFunction* Func = nullptr;
...
void UFortPlayerAugmentGranterWidget::OnInputTypeChanged(ECommonInputType NewInputType)
{
	static class UFunction* Func = nullptr;
...
void UFortPlayerAugmentInfoEntryWidget::OnItemPinColorSet(struct FLinearColor& PinColor)
{
	static class UFunction* Func = nullptr;
...
void UFortPlayerAugmentInfoEntryWidget::OnItemRaritySet(EFortRarity Rarity, struct FFortRarityItemData& RarityItemData)
{
	static class UFunction* Func = nullptr;
...
void UFortPlayerAugmentInventoryInfoWidget::OnItemRaritySet(EFortRarity Rarity, struct FFortRarityItemData& RarityItemData)
{
	static class UFunction* Func = nullptr;
...
void UFortPlayerAugmentInventoryListEntry::OnAugmentListItemSet(class UItemDefinitionBase* ItemDefinition)
{
	static class UFunction* Func = nullptr;
...
class FText UFortPlayerAugmentSpecialAcquiredNotificationWidget::ConstructEventDescription(class UFortPlayerAugmentItemDefinition* ItemDef) const
{
	static class UFunction* Func = nullptr;
...
void UFortPlayerAugmentInfoTouchWidget::SetAugmentIndexInList(int32 InAugmentIndexInList)
{
	static class UFunction* Func = nullptr;
