...
bool URadioPlayerWidgetBase::HaveToChangeSongInfo(struct FFortMediaInBandMetadata& MediaMetadata)
{
	static class UFunction* Func = nullptr;
...
bool URadioPlayerWidgetBase::IsMetadataEmpty(struct FFortMediaInBandMetadata& MediaMetadata)
{
	static class UFunction* Func = nullptr;
...
void URadioPlayerWidgetBase::NativeChangedSeatVehicle(int32 SeatIndex)
{
	static class UFunction* Func = nullptr;
