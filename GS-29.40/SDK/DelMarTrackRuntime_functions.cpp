...
void ADelMarTrackBase::SetTrackTypeTagAtIndex(int32 SplineIndex, struct FGameplayTag& Tag)
{
	static class UFunction* Func = nullptr;
...
struct FDelMarTrackPointDistanceRange ADelMarTrackBase::GetDistanceRangeFromPointRange(struct FDelMarTrackPointIndexRange& InRange) const
{
	static class UFunction* Func = nullptr;
...
bool ADelMarTrackBase::IsPointInOOBTube(struct FVector& Point) const
{
	static class UFunction* Func = nullptr;
...
float UDelMarTrackPositionComponent::GetTrackRadius(class ADelMarTrackBase* InTrack, float InDistanceAlongTrack) const
{
	static class UFunction* Func = nullptr;
...
bool ADelMarTrackSegmentBase::ContainsDistanceAlongSpline(float DistanceAlongSpline) const
{
	static class UFunction* Func = nullptr;
...
void UDelMarTrackPaletteTrackType::AddSegmentClassActorToStyle(struct FGameplayTag& StyleTag, class UClass* SegmentClass)
{
	static class UFunction* Func = nullptr;
...
struct FClosestLocationToWorldPlaneResult UDelMarTrackSplineComponent::FindClosestLocationForSegmentToWorldPlane(struct FVector& WorldPlaneOrigin, struct FVector& WorldPlaneNormal, int32 SegmentIndex, ESplineCoordinateSpace CoordinateSpace) const
{
	static class UFunction* Func = nullptr;
...
struct FClosestLocationToWorldPlaneResult UDelMarTrackSplineComponent::FindClosestLocationToWorldPlane(struct FVector& WorldPlaneOrigin, struct FVector& WorldPlaneNormal, ESplineCoordinateSpace CoordinateSpace) const
{
	static class UFunction* Func = nullptr;
...
struct FClosestLocationToWorldPlaneResult UDelMarTrackSplineComponent::FindInputKeyForNeighboringSegmentClosestToWorldPlane(struct FVector& WorldPlaneOrigin, struct FVector& WorldPlaneNormal, int32 SegmentIndex, int32* OutClosestSegmentIndex) const
{
	static class UFunction* Func = nullptr;
...
int32 UDelMarTrackSplineComponent::GetSplinePointClosestToWorldLocation(struct FVector& WorldLocation) const
{
	static class UFunction* Func = nullptr;
