...
void ABP_TeleportationDrone_C::PlaySpawnAnim(class UAnimInstance* CallFunc_GetAnimInstance_ReturnValue, class UAnimationAsset* CallFunc_Get_Spawn_Animation_ReturnValue, TDelegate<void(class UAnimMontage* Montage, bool bInterrupted)> K2Node_CreateDelegate_OutputDelegate, float CallFunc_SetPlayRate_Rate_ImplicitCast)
{
	static class UFunction* Func = nullptr;
