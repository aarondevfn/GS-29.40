...
struct FMotionMatchingAnimNodeReference UMotionMatchingAnimNodeLibrary::ConvertToMotionMatchingNode(struct FAnimNodeReference& Node, EAnimNodeReferenceConversionResult* Result)
{
...
void UMotionMatchingAnimNodeLibrary::GetMotionMatchingSearchResult(struct FMotionMatchingAnimNodeReference& MotionMatchingNode, struct FPoseSearchBlueprintResult* Result, bool* bIsResultValid)
{
	static class UFunction* Func = nullptr;
...
void UMotionMatchingAnimNodeLibrary::ResetDatabasesToSearch(struct FMotionMatchingAnimNodeReference& MotionMatchingNode, EPoseSearchInterruptMode InterruptMode)
{
	static class UFunction* Func = nullptr;
...
void UMotionMatchingAnimNodeLibrary::SetDatabasesToSearch(struct FMotionMatchingAnimNodeReference& MotionMatchingNode, TArray<class UPoseSearchDatabase*>& Databases, EPoseSearchInterruptMode InterruptMode)
{
	static class UFunction* Func = nullptr;
...
void UMotionMatchingAnimNodeLibrary::SetDatabaseToSearch(struct FMotionMatchingAnimNodeReference& MotionMatchingNode, class UPoseSearchDatabase* Database, EPoseSearchInterruptMode InterruptMode)
{
	static class UFunction* Func = nullptr;
...
void UMotionMatchingAnimNodeLibrary::SetInterruptMode(struct FMotionMatchingAnimNodeReference& MotionMatchingNode, EPoseSearchInterruptMode InterruptMode)
{
	static class UFunction* Func = nullptr;
...
struct FQuat UPoseSearchFeatureChannel_Heading::BP_GetWorldRotation(class UAnimInstance* AnimInstance) const
{
	static class UFunction* Func = nullptr;
...
struct FVector UPoseSearchFeatureChannel_Position::BP_GetWorldPosition(class UAnimInstance* AnimInstance) const
{
	static class UFunction* Func = nullptr;
...
float UPoseSearchFeatureChannel_TimeToEvent::BP_GetTimeToEvent(class UAnimInstance* AnimInstance) const
{
	static class UFunction* Func = nullptr;
...
struct FVector UPoseSearchFeatureChannel_Velocity::BP_GetWorldVelocity(class UAnimInstance* AnimInstance) const
{
	static class UFunction* Func = nullptr;
...
struct FPoseSearchHistoryCollectorAnimNodeReference UPoseSearchHistoryCollectorAnimNodeLibrary::ConvertToPoseHistoryNode(struct FAnimNodeReference& Node, EAnimNodeReferenceConversionResult* Result)
{
	static class UFunction* Func = nullptr;
...
void UPoseSearchHistoryCollectorAnimNodeLibrary::ConvertToPoseHistoryNodePure(struct FAnimNodeReference& Node, struct FPoseSearchHistoryCollectorAnimNodeReference* PoseSearchHistoryCollectorNode, bool* Result)
{
	static class UFunction* Func = nullptr;
...
void UPoseSearchHistoryCollectorAnimNodeLibrary::GetPoseHistoryNodeTrajectory(struct FPoseSearchHistoryCollectorAnimNodeReference& PoseSearchHistoryCollectorNode, struct FPoseSearchQueryTrajectory* Trajectory)
{
	static class UFunction* Func = nullptr;
...
void UPoseSearchHistoryCollectorAnimNodeLibrary::SetPoseHistoryNodeTrajectory(struct FPoseSearchHistoryCollectorAnimNodeReference& PoseSearchHistoryCollectorNode, struct FPoseSearchQueryTrajectory& Trajectory)
{
	static class UFunction* Func = nullptr;
...
class UAnimSequenceBase* UPoseSearchMultiSequence::GetSequence(class FName& Role) const
{
	static class UFunction* Func = nullptr;
...
void UPoseSearchTrajectoryLibrary::GetTrajectorySampleAtTime(struct FPoseSearchQueryTrajectory& InTrajectory, float Time, struct FPoseSearchQueryTrajectorySample* OutTrajectorySample, bool bExtrapolate)
{
	static class UFunction* Func = nullptr;
...
void UPoseSearchLibrary::MotionMatch(class UAnimInstance* AnimInstance, const TArray<class UObject*>& AssetsToSearch, class FName PoseHistoryName, const struct FPoseSearchFutureProperties& Future, struct FPoseSearchBlueprintResult* Result, int32 DebugSessionUniqueIdentifier)
{
	static class UFunction* Func = nullptr;
...
void UPoseSearchLibrary::MotionMatchMulti(const TArray<class ACharacter*>& AnimInstances, const TArray<class FName>& Roles, const TArray<class UObject*>& AssetsToSearch, class FName PoseHistoryName, struct FPoseSearchBlueprintResult* Result, int32 DebugSessionUniqueIdentifier)
{
	static class UFunction* Func = nullptr;
