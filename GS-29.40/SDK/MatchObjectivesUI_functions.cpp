...
void UMatchObjectivesOptionEntryWidget::OnMatchObjectiveEntrySetup(struct FUrgentQuestData& UrgentQuestData, struct FFortItemQuantityPair& VisibleReward, int32 ObjectiveCount)
{
	static class UFunction* Func = nullptr;
...
void UMatchObjectivesOptionEntryWidget::OnTeammateSelectionUpdated(TArray<class AFortPlayerState*>& PlayersThatHaveSelectedThis)
{
	static class UFunction* Func = nullptr;
...
void UMatchObjectivesSocialAvatar::SetSocialAvatar(class AFortPlayerState* PlayerState)
{
	static class UFunction* Func = nullptr;
...
void UMatchObjectivesSocialAvatar::SetSocialAvatarTexture(TSoftObjectPtr<class UTexture2D>& AvatarTexture)
{
	static class UFunction* Func = nullptr;
...
void UMatchObjectivesSelectorWidget::PopulateChallengeEntries(TArray<TScriptInterface<class IQuestDefinitionInterface>>& QuestOffering)
{
	static class UFunction* Func = nullptr;
...
void UMatchObjectivesSelectorWidget::SetSelectorState(EMatchQuestsSelectorState State)
{
	static class UFunction* Func = nullptr;
