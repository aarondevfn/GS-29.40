...
struct FVector UGrappleWeaponLibrary::CalculateDirectionalTargetOffset(struct FVector& DirToTarget, struct FVector& MovementOffset, struct FVector& LedgeOffset)
{
	static class UFunction* Func = nullptr;
...
void UGrappleWeaponLibrary::DidHitResultImpactLedge(class ACharacter* SourceCharacter, struct FHitResult& HitResult, struct FGrappleWeaponLedgeConfig& Config, bool* OutDidImpactWalkableSurface, bool* OutTargetingLedge, struct FVector* OutLedgeLocation, bool bDrawDebug)
{
	static class UFunction* Func = nullptr;
...
struct FGrappleWeaponTargetInfo UGrappleWeaponLibrary::GetGrappleWeaponTargetInfo(class AFortPlayerPawn* SourcePlayerPawn, struct FGrappleWeaponTargetingConfig& Config, float DrawDebugDuration)
{
	static class UFunction* Func = nullptr;
...
void UGrappleWeaponLibrary::IsTargetingLedge(class ACharacter* SourceCharacter, class AActor* TargetActor, struct FVector& TargetLocation, struct FVector& TargetNormal, struct FGrappleWeaponLedgeConfig& Config, bool* OutDidImpactWalkableSurface, bool* OutTargetingLedge, struct FVector* OutLedgeLocation, bool bDrawDebug)
{
	static class UFunction* Func = nullptr;
