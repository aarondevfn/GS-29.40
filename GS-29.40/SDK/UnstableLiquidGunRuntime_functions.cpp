...
const struct FLiquidRibbonSplineDetachment ALiquidRibbonManager::GetOrAddDetachment(int32 RibbonID, struct FLiquidRibbonSplineSegment& Segment)
{
	static class UFunction* Func = nullptr;
...
float ALiquidRibbonManager::CalculatePointFlashIntensity(int32 PointSize) const
{
	static class UFunction* Func = nullptr;
...
struct FVector ALiquidRibbonManager::GetPointOnSegment(float T, struct FLiquidRibbonSplineSegment& Segment) const
{
	static class UFunction* Func = nullptr;
...
void ALiquidRibbonManager::SetNiagaraData(class UNiagaraComponent* NiagaraComponent, TArray<struct FVector>& Positions, TArray<int32>& RibbonIDs, TArray<bool>& RibbonVisibilities, TArray<float>& FlashIntensities, TArray<int32>& RibbonSizes) const
{
	static class UFunction* Func = nullptr;
