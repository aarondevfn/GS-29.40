...
void UFortPlayerStateComponent_MatchQuests::Server_SetSelectedQuest(TScriptInterface<class IQuestDefinitionInterface>& Quest)
{
	static class UFunction* Func = nullptr;
...
void UFortPlayerStateComponent_MatchQuests::TryToGrantSelectedQuest(struct FFortGamePhaseUpdatedEvent& FortGamePhaseUpdatedEvent)
{
	static class UFunction* Func = nullptr;
...
void UMatchQuestsCheatManager::MatchQuests_LogReportSimulatedRolls(int32 RollsToSimulate) const
{
	static class UFunction* Func = nullptr;
