...
public:
	...
	uint8                                         Pad_90A6[0x50];                                    // 0x0030(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	class UPilgrimPresetConfiguration*            PilgrimPresetConfiguration;                        // 0x0028(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	int32                                         NumLanes;                                          // 0x02F0(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_90A7[0x4];                                     // 0x02F4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortSettingsRotator*                   Rotator_Preset;                                    // 0x02F8(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCommonButtonLegacy*                    Button_Decrease_Preset;                            // 0x0300(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCommonButtonLegacy*                    Button_Increase_Preset;                            // 0x0308(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_90A8[0x8];                                     // 0x0310(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void GetSelectedItems(int32* OutSelectedLaneNum, int32* OutSelectedIndex);
	void InitializeForLanes(int32 NewNumLanes, TArray<class UFortInputMappingContext*>& InputMappingContexts);
...
{
public:
	uint8                                         Pad_90AA[0x40];                                    // 0x0080(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_90AB[0x30];                                    // 0x00C0(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_90AC[0x60];                                    // 0x0080(0x0060)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_90AD[0x48];                                    // 0x0078(0x0048)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	void Initialize(class APlayerController* InOwningController, struct FGameplayTagContainer& InSortTags, struct FGameplayTagContainer& InFilterTags);
