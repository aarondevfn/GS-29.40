...
void UFortScoutDroneControllingComponent::BP_OnDestructionStarted(bool bInstantDestruction, struct FGameplayTag& DismissalReason)
{
	static class UFunction* Func = nullptr;
...
void UFortScoutDroneControllingComponent::BP_OnDismissalStarted(bool bInstantDismissal, struct FGameplayTag& DismissalReason)
{
	static class UFunction* Func = nullptr;
...
void UFortScoutDroneControllingComponent::OnPlayerInterruptionTagsChanged(struct FGameplayTag& Tag, int32 NewCount)
{
	static class UFunction* Func = nullptr;
