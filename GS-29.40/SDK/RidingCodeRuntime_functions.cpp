...
void UFortVehicleLayerAnimInstance_Riding::SetFootPhase(ERidingFootPhase InFootPhase)
{
	static class UFunction* Func = nullptr;
...
bool URidableComponent::CanRiderPlayEmote(class URiderComponent* Rider) const
{
	static class UFunction* Func = nullptr;
...
void URidableComponent::GetRidingCapsuleSize(class URiderComponent* Rider, float OriginalRadius, float OriginalHalfHeight, float* OutRadius, float* OutHalfHeight) const
{
	static class UFunction* Func = nullptr;
...
void URidableComponent::GetRidingEmoteCapsuleSize(class URiderComponent* Rider, float OriginalRadius, float OriginalHalfHeight, float* OutRadius, float* OutHalfHeight) const
{
	static class UFunction* Func = nullptr;
...
bool URidableComponent::ShouldCameraFocusOnRidable(class URiderComponent* Rider) const
{
	static class UFunction* Func = nullptr;
...
void URiderComponent::ClientNotifyEmoteFailure(struct FGameplayTagContainer& ErrorTags)
{
	static class UFunction* Func = nullptr;
...
void URiderComponent::HandleDeferredExitVelocity(struct FVector& ExitVelocity)
{
	static class UFunction* Func = nullptr;
