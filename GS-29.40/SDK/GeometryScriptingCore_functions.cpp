...
void UGeometryScriptLibrary_CollisionFunctions::ApproximateConvexHullsWithSimplerCollisionShapes(struct FGeometryScriptSimpleCollision& SimpleCollision, struct FGeometryScriptConvexHullApproximationOptions& ApproximateOptions, bool* bHasApproximated, class UGeometryScriptDebug* Debug)
{
...
void UGeometryScriptLibrary_CollisionFunctions::CombineSimpleCollision(struct FGeometryScriptSimpleCollision& CollisionToUpdate, struct FGeometryScriptSimpleCollision& AppendCollision, class UGeometryScriptDebug* Debug)
{
	static class UFunction* Func = nullptr;
...
struct FGeometryScriptSphereCovering UGeometryScriptLibrary_CollisionFunctions::ComputeNegativeSpace(struct FGeometryScriptDynamicMeshBVH& MeshBVH, struct FComputeNegativeSpaceOptions& NegativeSpaceOptions, class UGeometryScriptDebug* Debug)
{
	static class UFunction* Func = nullptr;
...
TArray<struct FSphere> UGeometryScriptLibrary_CollisionFunctions::Conv_GeometryScriptSphereCoveringToSphereArray(struct FGeometryScriptSphereCovering& SphereCovering)
{
	static class UFunction* Func = nullptr;
...
struct FGeometryScriptSphereCovering UGeometryScriptLibrary_CollisionFunctions::Conv_SphereArrayToGeometryScriptSphereCovering(TArray<struct FSphere>& Spheres)
{
	static class UFunction* Func = nullptr;
...
int32 UGeometryScriptLibrary_CollisionFunctions::GetSimpleCollisionShapeCount(struct FGeometryScriptSimpleCollision& SimpleCollision)
{
	static class UFunction* Func = nullptr;
...
struct FGeometryScriptSimpleCollision UGeometryScriptLibrary_CollisionFunctions::MergeSimpleCollisionShapes(struct FGeometryScriptSimpleCollision& SimpleCollision, struct FGeometryScriptMergeSimpleCollisionOptions& MergeOptions, bool* bHasMerged, class UGeometryScriptDebug* Debug)
{
	static class UFunction* Func = nullptr;
...
void UGeometryScriptLibrary_CollisionFunctions::SetSimpleCollisionOfDynamicMeshComponent(struct FGeometryScriptSimpleCollision& SimpleCollision, class UDynamicMeshComponent* DynamicMeshComponent, const struct FGeometryScriptSetSimpleCollisionOptions& Options, class UGeometryScriptDebug* Debug)
{
	static class UFunction* Func = nullptr;
...
void UGeometryScriptLibrary_CollisionFunctions::SetSimpleCollisionOfStaticMesh(struct FGeometryScriptSimpleCollision& SimpleCollision, class UStaticMesh* StaticMesh, const struct FGeometryScriptSetSimpleCollisionOptions& Options, const struct FGeometryScriptSetStaticMeshCollisionOptions& StaticMeshCollisionOptions, class UGeometryScriptDebug* Debug)
{
	static class UFunction* Func = nullptr;
...
void UGeometryScriptLibrary_CollisionFunctions::SimplifyConvexHulls(struct FGeometryScriptSimpleCollision& SimpleCollision, struct FGeometryScriptConvexHullSimplificationOptions& SimplifyOptions, bool* bHasSimplified, class UGeometryScriptDebug* Debug)
{
	static class UFunction* Func = nullptr;
...
struct FGeometryScriptSimpleCollision UGeometryScriptLibrary_CollisionFunctions::TransformSimpleCollisionShapes(struct FGeometryScriptSimpleCollision& SimpleCollision, const struct FTransform& Transform, struct FGeometryScriptTransformCollisionOptions& TransformOptions, bool* bSuccess, class UGeometryScriptDebug* Debug)
{
	static class UFunction* Func = nullptr;
...
struct FGeometryScriptRenderCaptureTextures UGeometryScriptLibrary_MeshBakeFunctions::BakeTextureFromRenderCaptures(class UDynamicMesh* TargetMesh, const struct FTransform& TargetLocalToWorld, const struct FGeometryScriptBakeTargetMeshOptions& TargetOptions, TArray<class AActor*>& SourceActors, const struct FGeometryScriptBakeRenderCaptureOptions& BakeOptions, class UGeometryScriptDebug* Debug)
{
	static class UFunction* Func = nullptr;
...
class UDynamicMesh* UGeometryScriptLibrary_MeshBoneWeightFunctions::SetAllVertexBoneWeights(class UDynamicMesh* TargetMesh, TArray<struct FGeometryScriptBoneWeight>& BoneWeights, const struct FGeometryScriptBoneWeightProfile& Profile, class UGeometryScriptDebug* Debug)
{
	static class UFunction* Func = nullptr;
...
class UDynamicMesh* UGeometryScriptLibrary_MeshBoneWeightFunctions::SetVertexBoneWeights(class UDynamicMesh* TargetMesh, int32 VertexID, TArray<struct FGeometryScriptBoneWeight>& BoneWeights, bool* bIsValidVertexID, const struct FGeometryScriptBoneWeightProfile& Profile, class UGeometryScriptDebug* Debug)
{
	static class UFunction* Func = nullptr;
...
class UDynamicMesh* UGeometryScriptLibrary_MeshMaterialFunctions::RemapToNewMaterialIDsByMaterial(class UDynamicMesh* TargetMesh, TArray<class UMaterialInterface*>& FromMaterialList, TArray<class UMaterialInterface*>& ToMaterialList, int32 MissingMaterialID, class UGeometryScriptDebug* Debug)
{
	static class UFunction* Func = nullptr;
...
class UDynamicMesh* UGeometryScriptLibrary_MeshPrimitiveFunctions::AppendSimpleCollisionShapes(class UDynamicMesh* TargetMesh, const struct FGeometryScriptPrimitiveOptions& PrimitiveOptions, const struct FTransform& Transform, struct FGeometryScriptSimpleCollision& SimpleCollision, const struct FGeometryScriptSimpleCollisionTriangulationOptions& TriangulationOptions, class UGeometryScriptDebug* Debug)
{
	static class UFunction* Func = nullptr;
...
class UDynamicMesh* UGeometryScriptLibrary_MeshPrimitiveFunctions::AppendSphereCovering(class UDynamicMesh* TargetMesh, const struct FGeometryScriptPrimitiveOptions& PrimitiveOptions, const struct FTransform& Transform, struct FGeometryScriptSphereCovering& SphereCovering, int32 StepsX, int32 StepsY, int32 StepsZ, class UGeometryScriptDebug* Debug)
{
	static class UFunction* Func = nullptr;
...
class UDynamicMesh* UGeometryScriptLibrary_MeshPrimitiveFunctions::AppendTriangulatedPolygon3D(class UDynamicMesh* TargetMesh, const struct FGeometryScriptPrimitiveOptions& PrimitiveOptions, const struct FTransform& Transform, TArray<struct FVector>& PolygonVertices3D, class UGeometryScriptDebug* Debug)
{
	static class UFunction* Func = nullptr;
...
void UGeometryScriptLibrary_MeshSamplingFunctions::ComputeRenderCaptureCamerasForBox(TArray<struct FGeometryScriptRenderCaptureCamera>* Cameras, const struct FBox& Box, struct FGeometryScriptRenderCaptureCamerasForBoxOptions& Options, class UGeometryScriptDebug* Debug)
{
	static class UFunction* Func = nullptr;
...
void UGeometryScriptLibrary_MeshSamplingFunctions::ComputeRenderCapturePointSampling(TArray<struct FTransform>* Samples, TArray<class AActor*>& Actors, TArray<struct FGeometryScriptRenderCaptureCamera>& Cameras, class UGeometryScriptDebug* Debug)
{
	static class UFunction* Func = nullptr;
...
class UDynamicMesh* UGeometryScriptLibrary_MeshSpatial::SelectMeshElementsInBoxWithBVH(class UDynamicMesh* TargetMesh, struct FGeometryScriptDynamicMeshBVH& QueryBVH, const struct FBox& QueryBox, const struct FGeometryScriptSpatialQueryOptions& Options, struct FGeometryScriptMeshSelection* Selection, EGeometryScriptMeshSelectionType SelectionType, int32 MinNumTrianglePoints, class UGeometryScriptDebug* Debug)
{
	static class UFunction* Func = nullptr;
...
void UGeometryScriptLibrary_PointSetSamplingFunctions::DownsamplePoints(TArray<struct FVector>& Points, struct FGeometryScriptPointPriorityOptions& Options, struct FGeometryScriptIndexList* DownsampledIndices, int32 KeepNumPoints, class UGeometryScriptDebug* Debug)
{
	static class UFunction* Func = nullptr;
...
void UGeometryScriptLibrary_PointSetSamplingFunctions::FlattenPoints(TArray<struct FVector>& PointsIn3D, TArray<struct FVector2D>* PointsIn2D, struct FGeometryScriptPointFlatteningOptions& Options)
{
	static class UFunction* Func = nullptr;
...
void UGeometryScriptLibrary_PointSetSamplingFunctions::GetPointsFromIndexList(TArray<struct FVector>& AllPoints, struct FGeometryScriptIndexList& Indices, TArray<struct FVector>* SelectedPoints)
{
	static class UFunction* Func = nullptr;
...
void UGeometryScriptLibrary_PointSetSamplingFunctions::KMeansClusterToArrays(TArray<struct FVector>& Points, struct FGeometryScriptPointClusteringOptions& Options, TArray<struct FGeometryScriptIndexList>* ClusterIDToLists)
{
	static class UFunction* Func = nullptr;
...
void UGeometryScriptLibrary_PointSetSamplingFunctions::KMeansClusterToIDs(TArray<struct FVector>& Points, struct FGeometryScriptPointClusteringOptions& Options, TArray<int32>* PointClusterIndices)
{
	static class UFunction* Func = nullptr;
...
struct FBox UGeometryScriptLibrary_PointSetSamplingFunctions::MakeBoundingBoxFromPoints(TArray<struct FVector>& Points, double ExpandBy)
{
	static class UFunction* Func = nullptr;
...
void UGeometryScriptLibrary_PointSetSamplingFunctions::TransformsToPoints(TArray<struct FTransform>& Transforms, TArray<struct FVector>* Points)
{
	static class UFunction* Func = nullptr;
...
void UGeometryScriptLibrary_PointSetSamplingFunctions::UnflattenPoints(TArray<struct FVector2D>& PointsIn2D, TArray<struct FVector>* PointsIn3D, struct FGeometryScriptPointFlatteningOptions& Options, double Height)
{
	static class UFunction* Func = nullptr;
...
void UGeometryScriptLibrary_SimplePolygonFunctions::ConvertSplineToPolygon(class USplineComponent* Spline, struct FGeometryScriptSimplePolygon* Polygon, const struct FGeometryScriptSplineSamplingOptions& SamplingOptions, EGeometryScriptAxis DropAxis)
{
	static class UFunction* Func = nullptr;
...
bool UGeometryScriptLibrary_PolyPathFunctions::SampleSplineToTransforms(class USplineComponent* Spline, TArray<struct FTransform>* Frames, TArray<double>* FrameTimes, const struct FGeometryScriptSplineSamplingOptions& SamplingOptions, const struct FTransform& RelativeTransform, bool bIncludeScale)
{
	static class UFunction* Func = nullptr;
...
void UGeometryScriptLibrary_SceneUtilityFunctions::DetermineMeshOcclusion(TArray<class UDynamicMesh*>& SourceMeshes, TArray<struct FTransform>& SourceMeshTransforms, TArray<bool>* OutMeshIsHidden, TArray<class UDynamicMesh*>& TransparentMeshes, TArray<struct FTransform>& TransparentMeshTransforms, TArray<bool>* OutTransparentMeshIsHidden, TArray<class UDynamicMesh*>& OccludeMeshes, TArray<struct FTransform>& OccludeMeshTransforms, struct FGeometryScriptDetermineMeshOcclusionOptions& OcclusionOptions, class UGeometryScriptDebug* Debug)
{
	static class UFunction* Func = nullptr;
