...
void UJunoBridgePOISelectorComponent::BeginBridgeSelection(struct FJunoBridgePOISelectorParams& Params_0)
{
...
void UJunoTileSubsystem::OnCellActivate(class UJunoDynamicRuntimeCell* Cell)
{
	static class UFunction* Func = nullptr;
...
void UJunoTileSubsystem::OnCellDeactivate(class UJunoDynamicRuntimeCell* Cell)
{
	static class UFunction* Func = nullptr;
...
void UJunoTileSubsystem::OnCellLoad(class UJunoDynamicRuntimeCell* Cell)
{
	static class UFunction* Func = nullptr;
...
void UJunoTileSubsystem::OnCellUnload(class UJunoDynamicRuntimeCell* Cell)
{
	static class UFunction* Func = nullptr;
...
void UJunoTileSubsystem::OnSpawnPositionSet(struct FJunoPlayerSpawnLocationInfo& Info)
{
	static class UFunction* Func = nullptr;
...
// struct FDataRegistryType                Param_POIDataRegistry                                  (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
bool UJunoCaveGeneratorPlayspaceComponent::GenerateCaveData(struct FJunoCaveGeneratorData& ResourceData, struct FDataRegistryType& Param_POIDataRegistry, struct FRandomStream& RandomStream, struct FJunoCaveSurfaceData& CaveSurfaceData, EJunoBiome Biome, struct FBox& Bounds, TSubclassOf<class AJunoTeleporter>& SurfaceTeleporterClass, TArray<struct FJunoGeneratedCaveShellData>* Shells, TArray<struct FJunoPOIData>* POIs)
{
	...
	Parms.Param_POIDataRegistry = std::move(Param_POIDataRegistry);
...
void UJunoCaveGeneratorPlayspaceComponent::GetMergedCaveDataRegistryData(struct FDataRegistryType& CaveGeneratorDataRegistry, struct FJunoCaveGeneratorData* ResourceData, EJunoGetMergedCaveDataRegistryDataResult* Result)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveGeneratorPlayspaceComponent::GetMergedMultiCaveDataRegistryData(struct FDataRegistryType& ShellRegistry, struct FDataRegistryType& ThemeRegistry, struct FDataRegistryType& TypeRegistry, struct FDataRegistryType& RuleRegistry, struct FJunoCaveGeneratorData* ResourceData, EJunoGetMergedCaveDataRegistryDataResult* Result)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveGeneratorPlayspaceComponent::SortCaveGeneratorRules(TArray<struct FJunoCaveGeneratorRule>& Rules, TArray<struct FJunoCaveGeneratorRule>* SortedRules)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveGeneratorPlayspaceComponent::SortCaveGeneratorShells(TArray<struct FJunoCaveGeneratorShellData>& Shells, TArray<struct FJunoCaveGeneratorShellData>* SortedShells)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveGeneratorPlayspaceComponent::SortCaveGeneratorThemes(TArray<struct FJunoCaveGeneratorThemeEntry>& Themes, TArray<struct FJunoCaveGeneratorThemeEntry>* SortedThemes)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveGeneratorPlayspaceComponent::SortCaveGeneratorTypes(TArray<struct FJunoCaveGeneratorTypeData>& Types, TArray<struct FJunoCaveGeneratorTypeData>* SortedTypes)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveGeneratorPlayspaceComponent::GenerateCave(class AActor* WorldActor, struct FRandomStream& RandomStream, struct FJunoCaveSurfaceData& CaveSurfaceData, EJunoBiome Biome, struct FBox& Bounds, TSubclassOf<class AJunoTeleporter>& SurfaceTeleporterClass, class FName LayerName)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveGeneratorPlayspaceComponent::GenerateCaveWithSlotTags(class AActor* WorldActor, struct FRandomStream& RandomStream, struct FJunoCaveSurfaceData& CaveSurfaceData, EJunoBiome Biome, struct FGameplayTagContainer& SlotTags, struct FBox& Bounds, TSubclassOf<class AJunoTeleporter>& SurfaceTeleporterClass, class FName LayerName)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveGeneratorPlayspaceComponent::SetMergedData(struct FJunoCaveGeneratorData& Data)
{
	static class UFunction* Func = nullptr;
...
void UJunoTerrainGenerationSystem::FixupWorldLandscapeWeightmapLayers(class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
...
void UJunoTerrainGenerationSystem::OnCellActivate(class UJunoDynamicRuntimeCell* Cell)
{
	static class UFunction* Func = nullptr;
...
void UJunoTerrainGenerationSystem::OnCellDeactivate(class UJunoDynamicRuntimeCell* Cell)
{
	static class UFunction* Func = nullptr;
...
void UJunoTerrainGenerationSystem::OnCellLoad(class UJunoDynamicRuntimeCell* Cell)
{
	static class UFunction* Func = nullptr;
...
void UJunoTerrainGenerationSystem::OnCellUnload(class UJunoDynamicRuntimeCell* Cell)
{
	static class UFunction* Func = nullptr;
...
struct FVector UProceduralRouteDefinition::FindLocationClosestToWorldLocation(struct FVector& WorldLocation, float* OutDistanceSqr) const
{
	static class UFunction* Func = nullptr;
...
void AJunoLivingWorldStaticPointProvider::AppendFiltersTags(struct FGameplayTagContainer& Container)
{
	static class UFunction* Func = nullptr;
...
void UJunoWaterSplineInjector::InjectSplineGuideIntoWaterBody(struct FJunoWaterSplineInjectorParams& Params_0)
{
	static class UFunction* Func = nullptr;
...
void AJunoStreamingGameplayVolume::SetBounds(struct FVector& Offset, struct FVector& Extent)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveBlueprintLibrary::CalculateCaveShellDistance(struct FJunoCave& Cave, class FName ShellID_A, class FName ShellID_B, int32* Distance, EJunoCalculateCaveDistanceResult* Result)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveBlueprintLibrary::CreateCaveInstanceData(class AActor* CaveSlotActor, struct FGuid& CaveSlotGuid, TArray<struct FJunoGeneratedCaveShellData>& CaveShellData, EJunoCreateCaveResult* Result, class FName LayerName)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveBlueprintLibrary::CreateCaveInstanceDataForSurfaceData(class AActor* POISlotActor, struct FJunoCaveSurfaceData& SurfaceData, TArray<struct FJunoGeneratedCaveShellData>& CaveShellData, EJunoCreateCaveResult* Result, class FName LayerName)
{
	static class UFunction* Func = nullptr;
...
int32 UJunoCaveBlueprintLibrary::CreateExitsUsedMaskFromArray(TArray<int32>& ExitsUsed)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveBlueprintLibrary::GetBestCaveShellFromArea(class UObject* WorldContextObject, struct FBox& Area, struct FJunoCave* Cave, struct FGuid* CaveGuid, class FName* ShellID, EJunoGetBestCaveResult* Result)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveBlueprintLibrary::GetCaveDataCollectionsFromRegistry(struct FDataRegistryType& DataRegistry, TArray<TSoftObjectPtr<class UJunoCaveDataCollectionBase>>* Array, EJunoGetCaveDataCollectionsFromRegistryResult* Result)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveBlueprintLibrary::GetCaveShellGateActors(class AActor* ActorInShell, TArray<class AActor*>* GateActors)
{
	static class UFunction* Func = nullptr;
...
struct FJunoCaveShellInstanceData UJunoCaveBlueprintLibrary::GetCaveShellInstanceData(class AActor* CaveShellChildActor, class FName ShellID, bool* Success)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveBlueprintLibrary::GetCaveShellInstanceDataFromActor(class AActor* CaveShellChildActor, class FName ShellID, struct FJunoCaveShellInstanceData* Data, EJunoGetCaveShellInstanceDataResult* Result)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveBlueprintLibrary::GetCaveShellInstanceDataFromArea(class UObject* WorldContextObject, struct FBox& Area, class FName ShellID, struct FJunoCaveShellInstanceData* Data, EJunoGetCaveShellInstanceDataResult* Result)
{
	static class UFunction* Func = nullptr;
...
class AJunoCaveShellGameplayVolume* UJunoCaveBlueprintLibrary::GetCaveShellVolumeFromArea(class UObject* WorldContextObject, struct FBox& Area, class FName ShellID)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveBlueprintLibrary::GetCaveSurfaceDataForEntrance(class AActor* Actor, struct FGuid& EntranceGuid, struct FJunoCaveSurfaceData* CaveSurfaceData, int32* CaveIndex, EJunoGetCaveSurfaceDataForEntranceResult* Result, bool bWorldTeleporterTransforms, class FName LayerName)
{
	static class UFunction* Func = nullptr;
...
bool UJunoCaveBlueprintLibrary::NeedsCaveShellInstanceData(class AActor* CaveSlotActor, struct FGuid& CaveSlotGuid)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveBlueprintLibrary::QueryCaveDataStateFromActor(class AActor* CaveSlotActor, struct FGuid& CaveSlotGuid, EJunoQueryCaveDataResult* Result, struct FBox* WorldTileBounds, TArray<struct FJunoCaveTeleporterLink>* Teleporters)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveBlueprintLibrary::QueryCaveDataStateFromSurfaceData(class AActor* POISlotActor, struct FJunoCaveSurfaceData& SurfaceData, EJunoQueryCaveDataResult* Result, struct FBox* WorldTileBounds, TArray<struct FJunoCaveTeleporterLink>* Teleporters)
{
	static class UFunction* Func = nullptr;
...
EJunoQueryCaveDataResult UJunoCaveBlueprintLibrary::QueryCaveShellInstanceDataState(class AActor* CaveSlotActor, struct FGuid& CaveSlotGuid)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveBlueprintLibrary::QueryCaveSurfaceDataState(class AActor* Actor, EJunoQueryCaveSurfaceDataStateResult* Result, class FName LayerName)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveBlueprintLibrary::SetCaveShellGateActors(class AActor* ActorInShell, class FName& ShellID, TArray<class AActor*>& GateActors)
{
	static class UFunction* Func = nullptr;
...
void UJunoCaveBlueprintLibrary::SetCaveSurfaceData(class AActor* Actor, TArray<struct FJunoCaveSurfaceData>& CaveSurfaceData, class FName LayerName)
{
	static class UFunction* Func = nullptr;
...
void UJunoCheatManager_ProceduralWorld::JunoGoPOI(class FName Param_Name)
{
	static class UFunction* Func = nullptr;
...
// (Final, Exec, Native, Private)
// Parameters:
// class FString                           DestFilePath                                           (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void IJunoGenerateTileInterface::GenerateTile(struct FJunoGenerateTileParams& Params_0)
{
	static class UFunction* Func = nullptr;
...
void UJunoWorldWeatherLocationComponent::HandleEnvironmentChanged(class AActor* Actor, struct FJunoBiomeInfoQueryResult& PreviousEnvironmentResult, struct FJunoBiomeInfoQueryResult& NewEnvironmentResult)
{
	static class UFunction* Func = nullptr;
...
void UJunoWorldTileSelectionBase::ChooseDebugTile(class UObject* WorldContextObject, struct FVector& Position, struct FPCGJunoWorldTile* OutSelectedTile)
{
	static class UFunction* Func = nullptr;
...
void UJunoWorldTileSelectionBase::ChooseOutOfBoundsTile(class UObject* WorldContextObject, struct FPCGJunoWorldTile* OutSelectedTile)
{
	static class UFunction* Func = nullptr;
...
bool UJunoWorldTileSelectionBase::ChooseStartTile(class UObject* WorldContextObject, struct FVector* StartTileLocation)
{
	static class UFunction* Func = nullptr;
...
void UJunoWorldTileSelectionBase::ChooseTile(class UObject* WorldContextObject, struct FVector& Position, struct FPCGJunoWorldTile* OutSelectedTile)
{
	static class UFunction* Func = nullptr;
...
struct FVector UJunoWorldTileSelectionBase::GetDebugLevelLocation(class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
...
void UJunoWorldTileSelectionBase::Setup(class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
...
void UJunoWorldTileSelectionBase::SetupForEvents(class UObject* WorldContextObject, struct FVector& PlayerPosition, TArray<class FName>* OutEvents)
{
	static class UFunction* Func = nullptr;
...
bool UJunoWorldTileSelectionBase::UpdateTile(class UObject* WorldContextObject, struct FPCGJunoWorldTile& CurrentTile, struct FPCGJunoWorldTile* OutUpdatedTile)
{
	static class UFunction* Func = nullptr;
...
// struct FIntVector                       CellCoords                                             (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
bool UJunoWorldTileSelectionBase::UpdateTileForEvent(class UObject* WorldContextObject, class FName& EventName, class FName& CellName, struct FIntVector& CellCoords, struct FBox2D& CellBounds, struct FPCGJunoWorldTile* OutSelectedTile)
{
	static class UFunction* Func = nullptr;
...
bool UJunoWorldTileSelectionBase::UseReservedArea(class UObject* WorldContextObject, class FName& AreaName, TMap<class FName, struct FBox2D>& AreaTiles, TArray<struct FPCGJunoWorldTile>* OutNewTiles)
{
	static class UFunction* Func = nullptr;
...
bool UJunoWorldTileSelectionBase::GetEventTileDefinition(class FName& EventName, struct FJunoWorldEventTileDefinition* OutTileEventDefinition) const
{
	static class UFunction* Func = nullptr;
...
bool UJunoWorldTileSelectionBase::ModifyTileInformation(class UObject* WorldContextObject, struct FPCGJunoWorldTile& CurrentTile, struct FPCGJunoWorldTile* OutTile) const
{
	static class UFunction* Func = nullptr;
...
class UPackage* AJunoMinimapGenerator::CreatePackageAndSaveTexture2D(class UTextureRenderTarget2D* RenderTarget, class FString& PackageName)
{
	static class UFunction* Func = nullptr;
...
void UJunoPOIPreselectorComponent::OnWorldTilePersistenceAvailable(class AJunoPersistentPlayspace* PersistentPlayspace, bool bSuccess)
{
	static class UFunction* Func = nullptr;
...
void IJunoCaveGeneratorInterface::GenerateCave(struct FJunoCaveSurfaceData& CaveSurfaceData, EJunoBiome Biome, int32 CaveIndex, struct FBox& Bounds)
{
	static class UFunction* Func = nullptr;
...
bool UJunoPOISelectorComponent::IsPOIPreselectorActorReady(class AActor* Actor)
{
	static class UFunction* Func = nullptr;
...
void UJunoPOISelectorComponent::BeginPOISelection(struct FJunoPOISelectorParams& Params_0)
{
	static class UFunction* Func = nullptr;
...
void UJunoProceduralWorldBlueprintLibrary::CompareTagSets(TSet<class FName>& Source, TSet<class FName>& Target, EJunoCompareTagSetsResult* Result)
{
	static class UFunction* Func = nullptr;
...
struct FJunoRandomTableKeysIterator UJunoProceduralWorldBlueprintLibrary::CreateJunoRandomTableKeysIterator(struct FRandomStream& RandomStream, TArray<class FName>& Keys)
{
	static class UFunction* Func = nullptr;
...
TArray<class FName> UJunoProceduralWorldBlueprintLibrary::DeterministicShuffleKeys(struct FRandomStream& RandomSource, TArray<class FName>& Array)
{
	static class UFunction* Func = nullptr;
...
void UJunoProceduralWorldBlueprintLibrary::FindNextMatchingPOIResource(struct FJunoRandomTableKeysIterator& Iterator, class UDataTable* DataTable, EJunoPOISize SlotPOISize, TArray<class FName>& SlotTags, struct FPCGJunoWorldTilePOI* FoundPOI, EJunoFindNextMatchingPOIResourceResult* Result, bool bRemoveFromIterator)
{
	static class UFunction* Func = nullptr;
...
void UJunoProceduralWorldBlueprintLibrary::FindNextMatchingPOIResourceEx(struct FJunoRandomTableKeysIterator& Iterator, class UDataTable* DataTable, EJunoPOISize Size, EJunoBiome Biome, struct FPCGJunoWorldTilePOI* FoundPOI, EJunoFindNextMatchingPOIResourceResult* Result)
{
	static class UFunction* Func = nullptr;
...
class UJunoWorldRegistryManager* UJunoProceduralWorldBlueprintLibrary::GetJunoWorldRegistry(class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
...
void UJunoProceduralWorldBlueprintLibrary::JunoCreateLevel(struct FJunoCreateLevelParams& Params_0, TSoftObjectPtr<class UWorld>* CreatedLevel, EJunoCreateLevelResult* Result)
{
	static class UFunction* Func = nullptr;
...
void UJunoProceduralWorldBlueprintLibrary::RunParallelCommandlets(class FText& DialogueTitle, TArray<class FString>& Commands, int32 MaxProcesses)
{
	static class UFunction* Func = nullptr;
	...
	Parms.DialogueTitle = DialogueTitle;
...
void UJunoProceduralWorldBlueprintLibrary::SetBoxBrushSize(class AActor* Volume, struct FVector& Size)
{
	static class UFunction* Func = nullptr;
...
void UJunoProceduralWorldBlueprintLibrary::SetGridCellSize(class AActor* WorldContextObject, class FName GridName, float CellSize, float LoadingRange, struct FVector2D& Origin)
{
	static class UFunction* Func = nullptr;
...
struct FBox UJunoProceduralWorldBlueprintLibrary::UnionActorBounds(TArray<class AActor*>& Actors)
{
	static class UFunction* Func = nullptr;
...
bool AJunoWorldTile::ArePositionsInSameWorldTile(class UObject* WorldContextObject, struct FVector& LocationA, struct FVector& LocationB)
{
	static class UFunction* Func = nullptr;
...
void AJunoWorldTile::AddTileInformationTags(struct FGameplayTagContainer& InTags)
{
	static class UFunction* Func = nullptr;
...
void UJunoWorldTileControllerComponent::ClientCheckWorldTileState(TArray<struct FJunoDebugWorldTileState>& WorldTileState)
{
	static class UFunction* Func = nullptr;
...
void UJunoWorldTileSelectionAgatha::GenerateCornersForUI(class UObject* WorldContextObject, TArray<EJunoBiome>* Corners)
{
	static class UFunction* Func = nullptr;
...
void ULandmassPathfinder::ExecutePathfinderSync(struct FVector& A, struct FVector& B, TArray<struct FVector>* Locations, TArray<float>* Costs)
{
	static class UFunction* Func = nullptr;
...
bool ULandmassPathfinder::FindNearestValidLocation(struct FVector& InLocation, struct FVector* OutValidLocation, bool bShouldProject)
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class ALandscapeProxy*                  Param_LandscapeProxy                                   (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
bool ULandmassPathfinder::Initialize(class ALandscapeProxy* Param_LandscapeProxy, class ALandmassProceduralRoute* InRoute, const struct FLandmassPathfinderRules& Rules, const TArray<class ULandmassPathfinder*>& InBackStopPaths, class ALandmassProceduralRoute* InBlockingRoute)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_LandscapeProxy = Param_LandscapeProxy;
...
bool ULandmassPathfinder::IsTargetLocationValid(struct FVector& TargetLocation)
{
	static class UFunction* Func = nullptr;
...
void ULandmassPathfinder::OnStartPathfinder(struct FVector& A, struct FVector& B)
{
	static class UFunction* Func = nullptr;
...
void ULandmassPathfinder::SetDestination(struct FVector& Location)
{
	static class UFunction* Func = nullptr;
...
void ULandmassPathfinder::StartPathfinder(struct FVector& A, struct FVector& B, bool bFindNearestValidLocationForA, bool bFindNearestValidLocationForB)
{
	static class UFunction* Func = nullptr;
...
bool UPathfinderGuideSetsDataAsset::LoadCurveSetAndAddSplineComponentsToActor(class AActor* InActor, int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
void UPathfinderGuideSetsDataAsset::SaveCurveSetFromSplintComponents(const TArray<class USplineComponent*>& SourceComponents, int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
void AJunoLivingWorldStaticPointProviderCluster::AppendGlobalTags(struct FGameplayTagContainer& Container)
{
	static class UFunction* Func = nullptr;
...
void AJunoLivingWorldStaticPointProviderCluster::OnCurrentPlaylistLoaded(class FName PlaylistName, struct FGameplayTagContainer& PlaylistContextTags)
{
	static class UFunction* Func = nullptr;
...
void UJunoPOIBlueprintLibrary::CreateCavePOI(class AActor* CaveSlotActor, struct FGuid& CaveSlotGuid, struct FGuid& CaveShellGuid, struct FJunoPOIData& Data, EGeneratePOIResult* Result)
{
	static class UFunction* Func = nullptr;
...
void UJunoPOIBlueprintLibrary::CreatePOI(class AActor* POISlotActor, struct FGuid& POISlotGuid, struct FJunoPOIData& Data, EGeneratePOIResult* Result)
{
	static class UFunction* Func = nullptr;
...
void UJunoPOIBlueprintLibrary::CreateRarePOIs(class AActor* Actor, struct FRandomStream& RandomStream, struct FDataRegistryType& DataRegistry, TArray<struct FJunoPOIManagerSlot>& PotentialSlots, TArray<struct FJunoPOIManagerSlot>* UsedSlots, EGeneratePOIResult* Result)
{
	static class UFunction* Func = nullptr;
...
void UJunoPOIBlueprintLibrary::GetMatchingPOIsFromDataRegistry(struct FDataRegistryType& DataRegistry, TSet<class FName>& Tags, TSet<EJunoPOISize>& Sizes, TSet<EJunoBiome>& Biomes, TArray<struct FPCGJunoWorldTilePOI>& Array, EJunoGetMatchingPOIsFromDataRegistryResult* Result, EJunoWorldTilePOIType Type)
{
	static class UFunction* Func = nullptr;
...
void UJunoPOIBlueprintLibrary::MarkCavePOISlotUnused(class AActor* CaveSlotActor, struct FGuid& CaveSlotGuid, struct FGuid& CaveShellGuid, EJunoMarkSlotPOIUnusedResult* Result)
{
	static class UFunction* Func = nullptr;
...
void UJunoPOIBlueprintLibrary::MarkPOISlotUnused(class AActor* POISlotActor, struct FGuid& POISlotGuid, EJunoMarkSlotPOIUnusedResult* Result)
{
	static class UFunction* Func = nullptr;
...
void UJunoPOIBlueprintLibrary::QueryCavePOIState(class AActor* CaveSlotActor, struct FGuid& CaveSlotGuid, struct FGuid& CaveShellGuid, EQueryPOIStateResult* Result, struct FBox* WorldTileBounds)
{
	static class UFunction* Func = nullptr;
...
void UJunoPOIBlueprintLibrary::QueryPOIState(class AActor* POISlotActor, struct FGuid& POISlotGuid, EQueryPOIStateResult* Result, struct FJunoPOISlotMetaData* POISlotMetaData, struct FBox* WorldTileBounds)
{
	static class UFunction* Func = nullptr;
...
void UJunoPOIBlueprintLibrary::SetPOISlotMetaDatas(class AActor* POISlotActor, TArray<struct FJunoPOIManagerSlot>& POISlots, struct FJunoPOISlotMetaData& POISlotMetaData, EJunoSetSlotPOIMetaDataResult* Result)
{
	static class UFunction* Func = nullptr;
...
bool AJunoRoadAINavigationCluster::ChangePatrolToFollow(class AAIController* Controller, class AFortAthenaPatrolPath* PatrolPath, class AFortAthenaPatrolPoint* FirstPatrolPoint)
{
	static class UFunction* Func = nullptr;
...
TArray<class AFortAthenaPatrolPath*> AJunoRoadAINavigationCluster::FindConnectedPatrolPaths(class AFortAthenaPatrolPoint* PatrolPoint, class AFortAthenaPatrolPath* PatrolPathToExclude)
{
	static class UFunction* Func = nullptr;
...
void AJunoRoadAINavigationCluster::AppendGlobalTags(struct FGameplayTagContainer& Container)
{
	static class UFunction* Func = nullptr;
...
void AJunoRoadAINavigationCluster::OnCurrentPlaylistLoaded(class FName PlaylistName, struct FGameplayTagContainer& PlaylistContextTags)
{
	static class UFunction* Func = nullptr;
...
void ULandmassCluster::InitializeDentrogram(const TArray<class AActor*>& InActors, TArray<struct FDendrogramLeafAttributes>& InAttributes)
{
	static class UFunction* Func = nullptr;
...
bool ULandmassFunctionLibrary::CreateSplineComponentsFromGuideSetAndAddToActor(class AActor* InActor, struct FPathfinderGuideSet& GuideSet)
{
	static class UFunction* Func = nullptr;
...
struct FVector2D ULandmassFunctionLibrary::GetLandscapeGradientAtLocation(class ALandscapeProxy* LandscapeProxy, struct FVector& Location)
{
	static class UFunction* Func = nullptr;
...
float ULandmassFunctionLibrary::GetLandscapeHeightAtLocation(class ALandscapeProxy* LandscapeProxy, struct FVector& Location, bool* bIsValidLocation)
{
	static class UFunction* Func = nullptr;
...
void ULandmassFunctionLibrary::LevelInstanceSetAndUpdateWorldAsset(class ALevelInstance* LevelInstance, TSoftObjectPtr<class UWorld>& WorldAsset)
{
	static class UFunction* Func = nullptr;
...
struct FVector ULandmassFunctionLibrary::ProjectLocationOnLandscape(class ALandscapeProxy* LandscapeProxy, struct FVector& Location, bool* bIsValidLocation)
{
	static class UFunction* Func = nullptr;
...
void ALandmassProceduralRoute::AddAvoidancePrimitive(struct FRouteAvoidancePrimitive& InPrimitive)
{
	static class UFunction* Func = nullptr;
...
void ALandmassProceduralRoute::BeginGeneratePCG(TArray<struct FLandmassPCGRouteInput>& Inputs)
{
	static class UFunction* Func = nullptr;
...
void ALandmassProceduralRoute::InitLandmassCluster(const TArray<class AActor*>& InActors, TArray<struct FDendrogramLeafAttributes>& InLeafAttributes)
{
	static class UFunction* Func = nullptr;
...
void ALandmassProceduralRoute::InitLandmassClusterLeavesOnly(TArray<struct FDendrogramLeafAttributes>& InLeafAttributes)
{
	static class UFunction* Func = nullptr;
...
void ALandmassProceduralRoute::SetWidthAtPointIndex(int32 Param_Index, float NewWidth)
{
	static class UFunction* Func = nullptr;
...
bool ALandmassProceduralRoute::IsInsideLake(const struct FVector& Location, class AWaterBody* InLake, float Dilation) const
{
	static class UFunction* Func = nullptr;
...
bool ALandmassProceduralRoute::IsInsideOcean(struct FVector& Location) const
{
	static class UFunction* Func = nullptr;
...
bool AProceduralRivers::GetGenerationRules(ELandmassRiverTier InRiverTier, struct FProceduralRiverGenRules* OutRules) const
{
	static class UFunction* Func = nullptr;
...
struct FSegmentInterpResult AProceduralRoads::EvaluateRouteAtLength(class UProceduralRoadDefinition* InRoute, float InLength, bool bTransformToWorld)
{
	static class UFunction* Func = nullptr;
...
bool AProceduralRoads::GetGenerationRules(ELandmassRoadTier InRoadTier, struct FProceduralRoadGenRules* OutRules) const
{
	static class UFunction* Func = nullptr;
...
void UJunoLivingWorldLightStaticPointProvider::AppendFiltersTags(struct FGameplayTagContainer& Container)
{
	static class UFunction* Func = nullptr;
...
class AJunoWorldTile* UJunoWorldRegistryManager::GetTileForLocation(class UObject* WorldContextObject, struct FVector& WorldLocation)
{
	static class UFunction* Func = nullptr;
...
struct FJunoWorldRegistryEntry UJunoWorldRegistryManager::GetClosestEntryUsingTagQuery(EJunoWorldRegistryType EntryType, struct FGameplayTagQuery& TagQuery, struct FVector& QueryLocation)
{
	static class UFunction* Func = nullptr;
...
void UJunoWorldRegistryManager::GetBiomeAtLocation(struct FVector& Location, struct FJunoBiomeInfoQueryResult* OutResult) const
{
	static class UFunction* Func = nullptr;
...
bool UJunoWorldRegistryManager::GetEventTilesAverageLocation(class UObject* WorldContextObject, class FName& EventName, struct FVector* OutLocation) const
{
	static class UFunction* Func = nullptr;
...
void UJunoWorldRegistryManager::GetGlobalPOIs(class UObject* WorldContextObject, TArray<struct FJunoGlobalPOIInfo>* OutGlobalPOIs, class FName EventName, class FName POIName) const
{
	static class UFunction* Func = nullptr;
...
bool UJunoWorldRegistryManager::GetNormalizedTileLocation(class UObject* WorldContextObject, struct FVector& WorldLocation, struct FVector* OutResult) const
{
	static class UFunction* Func = nullptr;
...
class AJunoWorldTile* UJunoWorldRegistryManager::GetTileAtLocation(struct FVector& WorldLocation) const
{
	static class UFunction* Func = nullptr;
...
TSoftObjectPtr<class UTexture2D> UJunoWorldRegistryManager::GetTileMiniMapTexture(class UObject* WorldContextObject, struct FVector& WorldLocation) const
{
	static class UFunction* Func = nullptr;
...
struct FGameplayTagContainer UJunoWorldRegistryManager::GetTileTagsForLocation(struct FVector& WorldLocation) const
{
	static class UFunction* Func = nullptr;
...
void UJunoWorldRegistryManager::GetWaterDirectionInformationAtLocation(struct FVector& Location, bool bIncludeNearMisses, bool* OutInWater, TArray<struct FJunoWaterLocationResult>* OutResult) const
{
	static class UFunction* Func = nullptr;
...
void UJunoWorldRegistryManager::GetWaterInformationInDirection(struct FVector& Location, struct FVector& Direction, struct FJunoWaterLocationResult* OutResult) const
{
	static class UFunction* Func = nullptr;
...
void UJunoWorldRegistryManager::GetWorldAnalyticsInfo(class UObject* WorldContextObject, struct FVector& WorldLocation, struct FJunoWorldAnalyticsInfoResult* WorldAnalyticsInfo) const
{
	static class UFunction* Func = nullptr;
...
void UJunoWorldRegistryManager::GetWorldDebugInfoText(class AFortPlayerPawn* PlayerPawn, struct FJunoDebugWorldInfoResult* WorldDebugInfo) const
{
	static class UFunction* Func = nullptr;
