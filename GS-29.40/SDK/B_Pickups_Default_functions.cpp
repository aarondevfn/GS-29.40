...
void AB_Pickups_Default_C::AddRareFX(int32 CallFunc_GetViewDistanceQuality_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, double CallFunc_GetGameTimeInSeconds_ReturnValue, double CallFunc_Fraction_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, int32 Temp_int_Loop_Counter_Variable, class USceneComponent* CallFunc_K2_GetRootComponent_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, class UNiagaraComponent* CallFunc_SpawnSystemAttached_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Array_Index_Variable, class UMaterialInstanceDynamic* CallFunc_Array_Get_Item, bool CallFunc_EqualEqual_IntInt_ReturnValue, struct FTransform& Temp_struct_Variable, bool CallFunc_EqualEqual_IntInt_ReturnValue_1, class UStaticMeshComponent* CallFunc_AddComponent_ReturnValue, bool CallFunc_LessEqual_IntInt_ReturnValue, bool CallFunc_EqualEqual_IntInt_ReturnValue_2, bool CallFunc_IsValid_ReturnValue, const struct FVector& CallFunc_Conv_LinearColorToVector_ReturnValue, float CallFunc_SetScalarParameterValue_Value_ImplicitCast, float CallFunc_SetScalarParameterValueOnMaterials_ParameterValue_ImplicitCast)
{
	...
	Params::B_Pickups_Default_C_AddRareFX Parms{};
...
void AB_Pickups_Default_C::InitializeSpotlightComponent(int32 Temp_int_Variable, int32 CallFunc_GetConsoleVariableIntValue_ReturnValue, bool K2Node_SwitchInteger_CmpSuccess, bool CallFunc_InEditorOrPIE_ReturnValue, struct FTransform& Temp_struct_Variable, class UGameUserSettings* CallFunc_GetGameUserSettings_ReturnValue, class USpotLightComponent* CallFunc_AddComponent_ReturnValue, int32 CallFunc_GetVisualEffectQuality_ReturnValue, bool CallFunc_IsMobilePlatform_ReturnValue, int32 CallFunc_GetRenderingDetailMode_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_GreaterEqual_IntInt_ReturnValue, bool CallFunc_BooleanAND_ReturnValue)
{
	...
	Params::B_Pickups_Default_C_InitializeSpotlightComponent Parms{};
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// double                                  Param_BG                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void AB_Pickups_Default_C::SetDrawDistances(double Param_BG, double bgdark, double Gun)
{
	static class UFunction* Func = nullptr;
...
void AB_Pickups_Default_C::SetMaxDraw_BG(double Param_BG)
{
	static class UFunction* Func = nullptr;
...
void AB_Pickups_Default_C::SetMaxDraw_BGDark(double Param_BG)
{
	static class UFunction* Func = nullptr;
...
void AB_Pickups_Default_C::SetMaxDraw_Gun(double Param_BG)
{
	static class UFunction* Func = nullptr;
...
void AB_Pickups_Default_C::SetMaxDraw_RareFX(double Param_BG)
{
	static class UFunction* Func = nullptr;
...
void AB_Pickups_Default_C::SetMaxDraw_RareMesh(double Param_BG)
{
	static class UFunction* Func = nullptr;
