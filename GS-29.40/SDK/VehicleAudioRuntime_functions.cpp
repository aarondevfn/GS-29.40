...
// TArray<TScriptInterface<class IFortVehicleAudioControllerInterface>>ControllersToUpdate                                    (Parm, OutParm, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)

void UFortVehicleAudioControllerUpdater::UpdateControllers(float DeltaTime, TArray<TScriptInterface<class IFortVehicleAudioControllerInterface>>* ControllersToUpdate)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortVehicleAudioControllerUpdater", "UpdateControllers");

	Params::FortVehicleAudioControllerUpdater_UpdateControllers Parms{};
	...
	if (ControllersToUpdate != nullptr)
		*ControllersToUpdate = std::move(Parms.ControllersToUpdate);
}
