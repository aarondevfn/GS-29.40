...
void IBuoyancyEventInterface::OnSurfaceTouchBegin(class AWaterBody* WaterBodyActor, class UPrimitiveComponent* WaterComponent, class UPrimitiveComponent* SubmergedComponent, float SubmergedVolume, struct FVector& SubmergedCenterOfMass, struct FVector& SubmergedVelocity)
{
...
void IBuoyancyEventInterface::OnSurfaceTouchEnd(class AWaterBody* WaterBodyActor, class UPrimitiveComponent* WaterComponent, class UPrimitiveComponent* SubmergedComponent, float SubmergedVolume, struct FVector& SubmergedCenterOfMass, struct FVector& SubmergedVelocity)
{
	static class UFunction* Func = nullptr;
...
void IBuoyancyEventInterface::OnSurfaceTouching(class AWaterBody* WaterBodyActor, class UPrimitiveComponent* WaterComponent, class UPrimitiveComponent* SubmergedComponent, float SubmergedVolume, struct FVector& SubmergedCenterOfMass, struct FVector& SubmergedVelocity)
{
	static class UFunction* Func = nullptr;
