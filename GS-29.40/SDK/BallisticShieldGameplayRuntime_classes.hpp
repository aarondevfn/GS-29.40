...
public:
	...
	uint8                                         Pad_8869[0x1];                                     // 0x06F7(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_886A[0xC0];                                    // 0x0710(0x00C0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	struct FScalableFloat                         ChargeRotationRate;                                // 0x03F0(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	TSubclassOf<class UGameplayAbility>           GrantedAbility;                                    // 0x0418(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_886C[0x8];                                     // 0x0420(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
