...
class UJunoWorldDataViewModel* UJunoWorldManagementViewModel::InitWorldData(TSoftObjectPtr<class UDataTable>& InSettingDataTable, TSoftObjectPtr<class UDataTable>& InWorldImageDataTable)
{
	static class UFunction* Func = nullptr;
